...
[PR #44474:](https://github.com/milvus-io/milvus/pull/44474) [](https://github.com/milvus-io/milvus/pull/44474)A lazy-loading optimization that changed search to fetch primary keys on demand instead of loading them all upfront.
