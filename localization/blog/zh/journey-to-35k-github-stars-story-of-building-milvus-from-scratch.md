...
<p>每一颗星都代表着一位开发者花时间浏览了我们的产品，觉得它非常有用，于是将其加入书签，并在很多情况下决定使用它。你们中的一些人走得更远：提交问题、贡献代码、在我们的论坛上回答问题，以及在其他开发人员遇到困难时提供帮助。</p>
...
<p><strong>于是，我们开始构建自己的数据库。</strong>这并不是因为我们认为这很容易--数据库是出了名的难搞，而是因为我们看到了人工智能的发展方向，并知道它需要专门构建的基础架构来实现这一目标。</p>
