...
<p>每一颗星都代表着一位开发者花时间浏览了我们的内容，认为它非常有用，并将其加入书签，在很多情况下，他们还决定使用它。你们中的一些人走得更远：提交问题、贡献代码、在我们的论坛上回答问题，以及在其他开发人员遇到困难时提供帮助。</p>
...
<p><strong>于是，我们开始构建自己的数据库。</strong>这并不是因为我们认为这很容易--数据库是出了名的难搞--而是因为我们看到了人工智能的发展方向，知道它需要专门构建的基础架构才能实现。</p>
...
<p><a href="https://zilliz.com/customers/global-fintech-leader"><strong>一家全球金融技术领先企业</strong></a>是世界上最大的数字支付平台之一，处理着 200 多个国家和 25 种以上货币的数百亿笔交易，选择 Milvus 可使批量摄取速度比竞争对手快 5-10 倍，在 1 小时内完成其他公司需要 8 小时以上的工作。</p>
...
<h2 id="Why-We-Built-Zilliz-Cloud-Enterprise-Grade-Vector-Database-as-a-Service" class="common-anchor-header">我们为什么要构建 Zilliz Cloud？企业级向量数据库即服务<button data-href="#Why-We-Built-Zilliz-Cloud-Enterprise-Grade-Vector-Database-as-a-Service" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus 是开源的，可以免费使用。但在企业级规模上运行好 Milvus 需要深厚的专业知识和大量资源。索引选择、内存管理、扩展策略、安全配置--这些都不是微不足道的决定。许多团队希望拥有 Milvus 的强大功能，但又不希望操作复杂，同时还需要企业支持、SLA 保证等。</p>
...
<p>通过日复一日地改进索引、存储结构、缓存和部署模型，我们希望让每个人都能更方便、更经济地使用人工智能基础设施，并帮助将非结构化数据带入人工智能原生的未来。</p>
...
<p>但我们还没有完成。Milvus 还有许多错误需要修复，性能需要改进，还有我们的社区一直要求的功能。我们的路线图是公开的，我们真诚地希望您能就优先考虑哪些功能提出意见。</p>
...
<li><p><strong>致我们的用户：</strong>感谢你们对我们的信任，让我们承担起你们的生产工作，感谢你们的反馈让我们保持诚实。</p></li>
