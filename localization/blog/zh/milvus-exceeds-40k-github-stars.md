...
<li><p><a href="https://milvus.io/blog/data-in-and-data-out-in-milvus-2-6.md"><strong>数据入库、数据出库</strong></a><strong>"工作流</strong>简化了嵌入式摄取和检索，尤其适用于多模式管道。</p></li>
<li><p>在单个集群中<strong>支持多达 100K 的 Collections</strong>- 向真正的大规模多租户迈出了重要一步。</p></li>
</ul>
...
<h2 id="Beyond-Milvus-Open-Source-Tools-for-AI-Developers" class="common-anchor-header">Milvus之外：面向人工智能开发人员的开源工具<button data-href="#Beyond-Milvus-Open-Source-Tools-for-AI-Developers" class="anchor-icon" translate="no">
    ...
    </button></h2><p>2025 年，我们不仅改进了 Milvus，还构建了能够加强整个人工智能开发者生态系统的工具。我们的目标不是追赶潮流，而是为开发者提供我们一直希望存在的开放、强大、透明的工具。</p>
