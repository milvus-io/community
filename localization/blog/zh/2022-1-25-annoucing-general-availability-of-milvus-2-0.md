...
<li>成本和性能变得更加重要，但目前的解决方案与实际应用案例之间仍存在很大差距。 因此，Milvus 2.0 应运而生。Milvus 是一种有助于大规模处理高维数据的数据库。它专为云计算设计，能够在任何地方运行。如果您一直在关注我们发布的 RC 版本，就会知道我们花了很大精力使 Milvus 更稳定、更易于部署和维护。</li>
</ol>
...
<p>一旦通过冲洗封存了不断增长的数据段，移交任务就会用索引历史数据段替换不断增长的数据段，从而提高搜索性能。</p>
...
<p>我们要感谢<a href="https://zilliz.com/">Zilliz</a>提供的管理工具。我们现在有了<a href="https://milvus.io/docs/v2.0.x/attu.md">Attu</a>，它允许我们通过直观的图形用户界面与 Milvus 进行交互，还有 Milvus<a href="https://milvus.io/docs/v2.0.x/cli_overview.md">_CLI</a>，这是一个管理 Milvus 的命令行工具。</p>
