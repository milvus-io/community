...
<tr><td style="text-align:left"><code translate="no">created_on</code></td><td style="text-align:left">int64</td><td style="text-align:left">从 1970 年 1 月 1 日到创建表格时的毫秒数。</td></tr>
<tr><td style="text-align:left"><code translate="no">date</code></td><td style="text-align:left">int32</td><td style="text-align:left">创建表格的日期。由于历史原因，此处仍保留了该参数，未来版本中将删除该参数。</td></tr>
</tbody>
</table>
