...
<button class="copy-code-btn"></button></code></pre>
<p>以上就是在 Kubernetes 上部署的 Milvus 中修改高级配置的方法。Milvus 的未来版本将把所有配置整合到一个文件中，并支持通过 Helm 图表更新配置。但在此之前，我希望这篇文章能作为一个临时解决方案帮到你。</p>
