...
---
<p>如今，您可以将 PDF 文件上传到任何现代法律硕士学院，并就其提出问题。对于少数文件来说，这样做很好。但大多数 LLM 的上限都是几百页的上下文，因此大量的语料根本无法满足要求。即使符合要求，您也要为处理每个查询的每一页付出代价。就同一个 500 页的文档集提出 100 个问题，你要为 500 页支付 100 倍的费用。这样一来，费用就变得非常昂贵。</p>
...
<p>有问题或想展示自己的成果？<a href="https://milvus.io/slack">Milvus Slack</a>是获得社区和团队帮助的最快途径。如果您希望一对一交流，可以在我们的<a href="https://meetings.hubspot.com/chloe-williams1/milvus-meeting">办公时间</a>预约时间。</p>
