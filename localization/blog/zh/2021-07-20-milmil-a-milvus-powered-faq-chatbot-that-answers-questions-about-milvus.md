...
---
<custom-h1>MilMil：由 Milvus 支持的常见问题聊天机器人，回答有关 Milvus 的问题</custom-h1><p>最近，开源社区创建了 MilMil--一个由 Milvus 用户创建、为 Milvus 用户服务的 Milvus 常见问题解答聊天机器人。MilMil 可全天候访问 Milvus<a href="https://milvus.io/">.io</a>，回答有关世界上最先进的开源向量数据库 Milvus 的常见问题。</p>
...
<h2 id="Ask-MilMil-about-Milvus" class="common-anchor-header">向 MilMil 了解 Milvus<button data-href="#Ask-MilMil-about-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>要与 MilMil 聊天，请浏览<a href="https://milvus.io/">Milvus.io</a>上的任何页面，然后点击右下角的小鸟图标。在文本输入框中键入您的问题，然后点击发送。MilMil 会在几毫秒内回复您！此外，左上角的下拉列表可用于切换 Milvus 不同版本的技术文档。</p>
<p>
