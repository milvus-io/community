...
<p>LLMs 的操作符大致相同。他们所谓的 "幻觉 "或 "跃迁"--类比、联想和推断--产生于相同的生成过程，这一过程使模型能够建立联系、扩展知识，并在明确的训练之外浮现想法。并非每次飞跃都能成功，但一旦成功，结果就会令人信服。</p>
