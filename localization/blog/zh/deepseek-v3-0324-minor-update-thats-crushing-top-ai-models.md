...
<p>我们看到的不仅仅是渐进式的改进，而是一种根本性的转变，它使 DeepSeek v3-0324 成为语言模型中的佼佼者。而且它是开源的。</p>
...
<h3 id="The-Secret-Sauce-Architectural-Innovation" class="common-anchor-header">秘诀：架构创新架构创新</h3><p>在引擎盖下，DeepSeek v3-0324保留了<a href="https://arxiv.org/abs/2502.07864">多头潜在注意力（MLA） </a>架构--一种利用潜在向量压缩键值（KV）缓存的高效机制，以减少推理过程中的内存使用和计算开销。此外，它还用专家混合层<a href="https://zilliz.com/learn/what-is-mixture-of-experts">（MoE</a>）取代了传统的<a href="https://zilliz.com/glossary/feedforward-neural-networks-(fnn)">前馈网络（FFN）</a>，通过动态激活每个标记的最佳专家来优化计算效率。</p>
