...
<p><a href="https://github.com/czhen-zilliz">陈震</a>撰稿，<a href="https://github.com/LocoRichard">王立臣誊写</a>。</p>
...
<p><code translate="no">attu IP</code> 是 Attu 运行环境的 IP 地址，<code translate="no">milvus server IP</code> 是 Milvus 运行环境的 IP 地址。</p>
...
<p><strong>概览</strong>页面显示已加载的 Collections。而<strong>Collection</strong>页面则列出所有 Collection，并显示它们是否已加载或已释放。</p>
<p>
