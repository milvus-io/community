...
<p><br/></p>
<h3 id="Index-algorithm-optimizations" class="common-anchor-header">索引算法优化</h3><p>Milvus 建立在多个广泛采用的索引库之上，包括 Faiss、NMSLIB 和 Annoy。Milvus 远不止是这些索引库的基本包装器。以下是对底层库的一些主要改进：</p>
<ul>
