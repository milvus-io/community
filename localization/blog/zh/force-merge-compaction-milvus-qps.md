...
title: Force Merge Compaction 如何让 Milvus 搜索 QPS 几乎翻倍
author: Jack Li
date: 2026-07-1
...
desc: >-
  Force Merge 会将 Milvus 的小型 sealed segments 合并为数量更少、规模更大的 segments。在 100 万条向量且使用
  HNSW 索引的情况下，搜索 QPS 从约 3,000 提升到约 5,600–6,000。
