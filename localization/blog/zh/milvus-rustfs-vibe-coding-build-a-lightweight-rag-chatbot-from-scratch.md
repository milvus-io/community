...
<p>对于存储层，我选择了<a href="https://rustfs.com/">RustFS</a>，这是一个用 Rust 编写的开源 S3 兼容对象存储系统。它可以通过二进制、Docker 或 Helm 图表进行部署。虽然它仍处于 alpha 阶段，不建议用于生产工作负载，但对于此次构建来说，它已经足够稳定。</p>
...
<p>Milvus 可以与任何兼容 S3 的对象存储协同工作，不过 MinIO 是标准设置中的默认后端。由于 MinIO 不再接受社区贡献，我们将在本示例中用 RustFS 取而代之。</p>
...
collection.flush()
<button class="copy-code-btn"></button></code></pre>
<p>插入完成后，你可以在 Attu 的<ip>:8000 中验证集合--你应该看到 docs_collection 列在 Collections 下。</p>
<p>
...
<p>本次构建的所有代码都在<a href="https://github.com/majinghe/chatbot"></a> github<a href="https://github.com/majinghe/chatbot">.com/majinghe/chatbot</a>。如果你想亲自尝试一下<a href="http://milvus.io">Milvus</a>，<a href="https://milvus.io/docs/quickstart.md">快速入门</a>是个不错的开始。如果你想和我们讨论你正在构建的东西，或者遇到一些意想不到的事情，请到<a href="https://milvus.io/slack">Milvus Slack</a> 来找我们。如果您想进行专门的交流，也可以<a href="https://meetings.hubspot.com/chloe-williams1/milvus-meeting">在办公时间预约时间</a>。</p>
