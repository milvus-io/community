...
<p>基于深度学习的模型的错误率比传统模型低一个数量级，因此作为音频信号处理领域的核心技术，其发展势头越来越猛。</p>
...
<h3 id="Step-1-Insert-data" class="common-anchor-header">步骤 1：插入数据</h3><p>以下是使用预训练的 PANNs-inference 模型生成音频嵌入并将其插入 Milvus 的示例代码，Milvus 会为每个向量嵌入分配一个唯一的 ID。</p>
