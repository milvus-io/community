...
<ul>
<li><p><strong>多租户 SaaS 平台：</strong>入驻的租户数以百计，但每天只有 10-15% 的租户处于活跃状态。其余的租户处于闲置状态，但仍占用资源。</p></li>
...
<p>各行各业的情况都一样：<strong>只有不到 10% 的数据会被频繁查询，但却往往消耗了 80% 的存储空间和内存。</strong>每个人都知道这种不平衡的存在，但直到最近，还没有一种简洁的架构方法来解决这个问题。</p>
...
<ul>
<li><p><strong>特点：</strong>所有数据的访问频率相似，没有明显的冷热之分。</p></li>
