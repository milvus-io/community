...
meta_title: >
  ...
  Data Loading
desc: 了解 Milvus 中的分层存储如何实现冷热数据的按需加载，从而实现高达 80% 的成本降低和更快的大规模加载时间。
origin: >-
...
<p>在 Milvus 2.5 中，加载 Collections 需要<strong>25 分钟</strong>。有了 Milvus 2.6+ 中的分层存储，同样的工作负载只需<strong>45 秒</strong>就能完成，这意味着负载效率有了质的飞跃。</p>
...
<table>
<thead>
<tr><th style="text-align:center"><strong>搜索请求类型</strong></th><th style="text-align:center"><strong>Milvus 2.5 P99 延迟</strong></th><th style="text-align:center"><strong>Milvus 2.6+ P99 延迟</strong></th><th style="text-align:center"><strong>变化</strong></th></tr>
</thead>
<tbody>
<tr><td style="text-align:center">热数据搜索</td><td style="text-align:center">15 毫秒</td><td style="text-align:center">16 毫秒</td><td style="text-align:center">+6.7%</td></tr>
<tr><td style="text-align:center">热数据搜索</td><td style="text-align:center">15 毫秒</td><td style="text-align:center">28 毫秒</td><td style="text-align:center">+86%</td></tr>
<tr><td style="text-align:center">冷数据搜索（首次访问）</td><td style="text-align:center">15 毫秒</td><td style="text-align:center">120 毫秒</td><td style="text-align:center">+700%</td></tr>
<tr><td style="text-align:center">冷数据搜索（缓存）</td><td style="text-align:center">15 毫秒</td><td style="text-align:center">18 毫秒</td><td style="text-align:center">+20%</td></tr>
</tbody>
</table>
<blockquote>
<p><em>这里的 "查询 "指的是向量搜索请求，而不是 Milvus<code translate="no">query()</code> API。</em></p>
</blockquote>
...
<li><p><strong>访问模式：</strong>不到 20% 的租户产生了 80% 以上的向量查询。</p></li>
...
<p>这种方法允许系统在不按比例增加本地资源的情况下扩展到更大的数据集，同时保持热查询性能基本不变。冷数据在需要时仍可访问，并具有可预测和有限制的延迟，从而使权衡变得清晰可控。随着向量搜索深入到成本敏感、多租户和长期运行的生产环境中，分层存储为大规模高效操作提供了切实可行的基础。</p>
