...
第 2 步：克隆项目</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Implement-the-Pipeline" class="common-anchor-header">第 3 步：实施管道</h3><p><strong>整合 Milvus 向量数据库</strong></p>
...
<h2 id="Conclusion" class="common-anchor-header">结论<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>构建传统的 RAG 管道通常需要编写数百甚至数千行代码。UltraRAG v2 采用了截然不同的方法。凭借基于 MCP 的模块化设计、声明式 YAML 配置和轻量级协调模型，只需几十行代码就能构建相同的端到端管道。此外，YAML 用于描述工作流的步骤，你不必真正编写代码。这使得将企业级 RAG 引入实际应用变得更加容易。</p>
