...
<h2 id="Conclusion" class="common-anchor-header">结论<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>构建传统的 RAG 管道通常需要编写数百甚至数千行代码。UltraRAG v2 采用了截然不同的方法。凭借基于 MCP 的模块化设计、声明式 YAML 配置和轻量级协调模型，只需几十行代码就能构建相同的端到端管道。此外，YAML 用于描述工作流的步骤。您实际上不需要编写真正的代码。这使得将企业级 RAG 融入实际应用变得更加容易。</p>
...
<p><strong>准备好简化您的 RAG 开发了吗？</strong>使用 Milvus 试用 UltraRAG v2。探索示例管道，亲自运行它，只需几行配置就能构建完整的 RAG 工作流程。</p>
