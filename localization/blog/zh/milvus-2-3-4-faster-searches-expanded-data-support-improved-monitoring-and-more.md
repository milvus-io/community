...
<p>此外，我们的数据格式转换工具 BulkWriter 现在已将 Parquet 用作其默认输出数据格式，确保为开发人员提供更直观的体验。</p>
...
<h2 id="Other-enhancements" class="common-anchor-header">其他增强功能<button data-href="#Other-enhancements" class="anchor-icon" translate="no">
    ...
    </button></h2><p>除上述功能外，Milvus 2.3.4 还包括各种改进和错误修复。其中包括降低数据检索和变长数据处理过程中的内存使用率、改进错误消息传递、加快加载速度以及改进查询分片平衡。这些 Collections 增强功能有助于实现更流畅、更高效的整体用户体验。</p>
