...
<li><strong>诊断疾病</strong>：在临床上，医生可以比较患者和健康人群的 DNA 序列，找出导致疾病的变异基因。可以通过适当的算法提取特征并对这些数据进行编码。Milvus 能够返回向量之间的距离，这些距离可以与疾病数据相关联。除了辅助疾病诊断外，该应用还有助于启发<a href="https://www.frontiersin.org/articles/10.3389/fgene.2021.680117/full">靶向治疗</a>的研究。</li>
</ul>
