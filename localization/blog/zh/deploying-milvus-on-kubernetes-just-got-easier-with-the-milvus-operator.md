...
<h2 id="Getting-Started-with-Milvus-Operator" class="common-anchor-header">开始使用 Milvus 操作符<button data-href="#Getting-Started-with-Milvus-Operator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>本攻略将向你展示如何使用操作符部署 Milvus。我们将在本指南中使用这些版本。</p>
<ul>
...
<p>采用基于操作符的管理确实需要一些前期努力，包括改变工作流程和团队流程。但对于大规模运营或计划大规模运营的企业来说，长期收益是非常可观的：可靠性更高、操作开销更低、部署周期更快更一致。</p>
