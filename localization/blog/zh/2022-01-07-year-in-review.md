...
<h2 id="Community-Governance-and-Advocacy" class="common-anchor-header">社区管理和宣传<button data-href="#Community-Governance-and-Advocacy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="About-the-author" class="common-anchor-header">关于作者<button data-href="#About-the-author" class="anchor-icon" translate="no">
    ...
    </button></h2><p>栾晓帆，Zilliz合伙人兼工程总监，LF人工智能与数据基金会技术顾问委员会成员。曾先后就职于甲骨文美国总部和软件定义存储创业公司Hedvig。他加入阿里巴巴云数据库团队，负责 NoSQL 数据库 HBase 和 Lindorm 的开发。栾先生拥有康奈尔大学电子计算机工程硕士学位。</p>
