...
<h3 id="Step-1-Start-Milvus" class="common-anchor-header">步骤 1.启动 Milvus</h3><h4 id="1-Unzip-the-package" class="common-anchor-header">1.解压压缩包</h4><p>解压压缩包，你会发现一个<code translate="no">milvus</code> 目录，其中包含所有需要的文件。</p>
