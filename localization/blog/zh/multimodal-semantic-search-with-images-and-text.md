...
<p>我们管道中的第一个 "魔法 "是嵌入模型的选择。我们使用的是最近开发的一种名为<a href="https://huggingface.co/BAAI/bge-visualized">Visualized BGE</a>的多模态模型，该模型能够将文本和图像联合或单独嵌入到同一个空间中，其中相近的点在语义上具有相似性。最近还开发了其他此类模型，例如<a href="https://github.com/google-deepmind/magiclens">MagicLens</a>。</p>
<p>
  <span class="img-wrapper">
...
<p>我们嵌入了 900 张没有相应文本的产品图片，并使用<a href="https://milvus.io/docs">Milvus</a> 将嵌入内容存储在向量数据库中。</p>
...
<p>请注意，用户查询的文本说的是 "这个"，而不是 "豹皮"。我们的 Embeddings 模型必须能够将 "this "与它所指的内容联系起来，鉴于之前的迭代模型无法处理这种开放式指令，这是一项了不起的成就。<a href="https://arxiv.org/abs/2403.19651">MagicLens</a>的<a href="https://arxiv.org/abs/2403.19651">论文</a>给出了更多的例子。</p>
<p>
  <span class="img-wrapper">
