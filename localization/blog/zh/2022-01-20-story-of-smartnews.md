...
<p>对于一个处理信息流的产品来说，如何找到一个灵活的数据处理器，将其无缝集成到系统架构中，以重复处理相同的新闻或广告，是开发人员的当务之急。</p>
...
<p>2021年6月，舒畅和算法团队的同事们将Milvus应用到更多业务场景中，尝试数据聚合和在线数据/索引实时更新。</p>
...
<p>7 月下旬，SmartNews 的工程师 Yusup 提出了使用<a href="https://milvus.io/docs/v2.0.x/collection_alias.md#Collection-Alias">Collections 别名</a>实现热重载的想法。</p>
