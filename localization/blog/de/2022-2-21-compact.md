...
<p>Mit der <a href="https://milvus.io/blog/2022-1-25-annoucing-general-availability-of-milvus-2-0.md">offiziellen Veröffentlichung</a> von Milvus 2.0 GA wird eine Liste neuer Funktionen unterstützt. Darunter ist die Verdichtung eine der neuen Funktionen, die Ihnen helfen kann, Speicherplatz zu sparen.</p>
...
<h2 id="What-is-compaction" class="common-anchor-header">Was ist Verdichtung?<button data-href="#What-is-compaction" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Bevor wir uns in die Details der Implementierung der Verdichtung in Milvus 2.0 vertiefen, ist es wichtig, herauszufinden, was Verdichtung in Milvus ist.</p>
...
<p>Wenn Sie jedoch die automatische Verdichtung aktivieren möchten, müssen bestimmte Auslösebedingungen erfüllt sein, damit das System Ihre Segmente oder Binslogs verdichtet.</p>
...
<h2 id="Whats-next" class="common-anchor-header">Wie geht es nun weiter?<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wie geht es nach dem Erlernen der Grundlagen der Verdichtung in Milvus weiter? Derzeit sind nicht alle Parameter zur Konfiguration der Verdichtung in der Datei <code translate="no">milvus.yaml</code> enthalten, und die Strategien zur Planerstellung sind relativ einfach. Kommen Sie und tragen Sie zu Milvus, <a href="https://github.com/milvus-io">dem Open-Source-Projekt</a>, bei, wenn Sie interessiert sind!</p>
