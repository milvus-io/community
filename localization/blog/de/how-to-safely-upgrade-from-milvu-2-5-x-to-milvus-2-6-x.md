...
<li><p><a href="https://milvus.io/docs/tiered-storage-overview.md#Tiered-Storage-Overview"><strong>Tiered Storage</strong></a> <strong>für Hot-Cold Data Management:</strong> Trennt heiße und kalte Daten über SSD- und Objektspeicher; unterstützt träges und teilweises Laden; macht das vollständige lokale Laden von Sammlungen überflüssig; reduziert die Ressourcennutzung um bis zu 50 % und beschleunigt die Ladezeiten für große Datensätze.</p></li>
...
<h2 id="How-to-Upgrade-to-Milvus-26-with-Milvus-Operator" class="common-anchor-header">Upgrade auf Milvus 2.6 mit Milvus Operator<button data-href="#How-to-Upgrade-to-Milvus-26-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/zilliztech/milvus-operator">Milvus Operator</a> ist ein Open-Source-Kubernetes-Operator, der eine skalierbare, hochverfügbare Methode zur Bereitstellung, Verwaltung und Aktualisierung des gesamten Milvus-Service-Stacks auf einem Kubernetes-Zielcluster bietet. Der vom Operator verwaltete Milvus-Service-Stack umfasst:</p>
<ul>
...
<li><p>Für den Einsatz in Produktionsclustern wird empfohlen, den kommenden Woodpecker-Cluster-Modus zu verwenden, sobald er verfügbar ist.</p></li>
</ul>
