...
<ul>
<li><a href="https://github.com/NousResearch/hermes-agent">Hermes Agent auf GitHub</a> - Installationsskript, Provider-Einrichtung und die oben verwendete Kanalkonfiguration.</li>
...
<ul>
<li>Treten Sie dem <a href="https://discord.gg/milvus">Milvus Discord</a> bei und stellen Sie Fragen zu hybrider Suche, Tiered Storage oder Skill-Routing-Mustern - andere Entwickler bauen ähnliche Stacks.</li>
...
<h3 id="How-much-does-a-self-hosted-Milvus-+-Hermes-setup-cost-per-month" class="common-anchor-header">Wie viel kostet ein selbstgehostetes Milvus + Hermes Setup pro Monat?</h3><p>Ein Einzelknoten Milvus 2.6 Standalone auf einem 2-Core / 4 GB VPS mit gestaffeltem Speicher kostet etwa $5/Monat. OpenAI text-embedding-3-small kostet $0.02 pro 1M Token - ein paar Cent pro Monat für eine persönliche Wissensbasis. LLM-Inferenz dominiert die Gesamtkosten und skaliert mit der Nutzung, nicht mit dem Retrieval-Stack.</p>
