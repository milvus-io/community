...
<p>Es ist wirklich so einfach wie das - 3 Zeilen Code. Bei einer Bibliothek wie FAISS oder ScaNN gibt es leider keine einfache Möglichkeit, dies zu tun, ohne den gesamten Index an bestimmten Kontrollpunkten manuell neu zu erstellen. Selbst wenn dies möglich wäre, fehlt es den Vektorsuchbibliotheken immer noch an Skalierbarkeit und Mehrmandantenfähigkeit, zwei der wichtigsten Eigenschaften von Vektordatenbanken.</p>
...
<li><a href="https://zilliz.com/learn/approximate-nearest-neighbor-oh-yeah-ANNOY">Ungefähre Nächste Nachbarn Oh Yeah (ANNOY)</a></li>
