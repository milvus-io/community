...
<li><strong>Detailtreue in Randbereichen.</strong> Accessoires, Muster und textlastige Layouts können an Schärfe verlieren. Abhilfe: Fügen Sie der Generierungsaufforderung explizite Einschränkungen hinzu ("Kleidung passt natürlich auf den Körper, keine freiliegenden Etiketten, keine zusätzlichen Elemente, Produktdetails sind scharf"). Wenn die Qualität bei einem bestimmten Produkt immer noch zu wünschen übrig lässt, wechseln Sie für die endgültige Erstellung zu Nano Banana Pro.</li>
</ul>
