...
<p>Claude scheint sich auf einen hybriden Aufbau zu stützen: <strong>eine persistente Langzeitspeicherschicht und Tools für den Abruf auf Abruf.</strong> Anstatt die gesamte Konversation in jede Anfrage zu packen, greift Claude nur dann selektiv auf vergangenen Kontext zurück, wenn es ihn für relevant hält. Auf diese Weise kann das Modell die Genauigkeit hoch halten, ohne jedes Mal die Token zu verbrauchen.</p>
...
<li><p>Die Fehlersuche wird schwieriger, weil das Verhalten des Modells von unsichtbaren Werkzeugauslösern abhängt, nicht nur von der Eingabeaufforderung.</p></li>
</ul>
...
<p>Teams verlassen sich in der Regel auf eine Mischung aus Heuristiken:</p>
<ul>
<li><p><strong>Zeitbasiert</strong>: neuere Aktionen sind wichtiger als ältere</p></li>
<li><p><strong>Häufigkeitsbasiert</strong>: Dateien oder Aktionen, auf die wiederholt zugegriffen wird, sind wichtiger</p></li>
...
<h2 id="Conclusion" class="common-anchor-header">Fazit<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Cowork gibt uns einen Einblick in eine neue Klasse von Agenten - persistent, zustandsorientiert und in der Lage, Kontext über lange Zeiträume zu übertragen. Aber es macht auch etwas anderes deutlich: Das Langzeitgedächtnis ist nur die Hälfte des Bildes. Um produktionsreife Agenten zu bauen, die sowohl autonom als auch zuverlässig sind, brauchen wir immer noch eine strukturierte Abfrage großer, sich entwickelnder Wissensdatenbanken.</p>
