...
<h3 id="Modernizing-the-Dataset" class="common-anchor-header">Modernisierung des Datensatzes</h3><p>Wir haben die für das vectorDB-Benchmarking verwendeten Datensätze komplett überarbeitet. Anstelle von veralteten Testsätzen wie SIFT und GloVe verwendet VDBBench Vektoren, die aus hochmodernen Einbettungsmodellen generiert wurden, welche die heutigen KI-Anwendungen antreiben.</p>
