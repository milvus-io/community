...
<h3 id="Verifying-the-Backup" class="common-anchor-header">Überprüfung des Backups</h3><p>Nachdem die Sicherung abgeschlossen war, überprüften wir, ob sie vollständig und brauchbar war. Wir überprüften vor allem, ob die Anzahl der Kollektionen und Segmente in der Sicherung mit denen im Quellcluster übereinstimmte.</p>
...
<li><p><strong>Mehr Overhead bei der Zusammenführung:</strong> Mehr Segmente bedeuteten auch mehr Arbeit bei der Zusammenführung der Ergebnisse.</p></li>
</ul>
...
<li><p>eine <strong>Migrationsvergleichsansicht</strong>, damit Benutzer die Segmentverteilung zwischen dem alten und dem neuen Cluster nach einem Upgrade vergleichen können</p></li>
</ul>
...
<li><p><strong>Unterstützung der AbfrageplananalyseAnalog</strong>zu MySQL <code translate="no">EXPLAIN</code> würde Milvus von einem Tool profitieren, das zeigt, wie eine Abfrage ausgeführt wird, und hilft, Leistungsprobleme zu finden.</p></li>
</ol>
...
<p>Daher ist es am sichersten, bei der versionsübergreifenden Migration die Standardeinstellungen für die Wiederherstellung beizubehalten, es sei denn, Sie haben einen besonderen Grund, etwas anderes zu tun. Außerdem sollte die Überwachung über CPU und Speicher hinausgehen; Sie brauchen einen Einblick in das zugrunde liegende Datenlayout, insbesondere in die Segmentverteilung und die Balance, um Probleme früher zu erkennen.</p>
