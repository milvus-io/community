...
<ul>
<li><p>Schreibprozess: Die vom Deep-Learning-Modell erzeugten Element-Merkmalsvektoren (im Folgenden als Element-Vektoren bezeichnet) werden normalisiert und in MySQL geschrieben. MySQL liest dann die verarbeiteten Item-Merkmalsvektoren mithilfe des Datensynchronisierungstools (ETL) und importiert sie in die Vektordatenbank Milvus.</p></li>
...
<p><strong>Prozess der Implementierung:</strong></p>
<ol>
