...
<p>Die Entwurfsphilosophie hier ist die Trennung von Belangen - diese Klasse konzentriert sich ausschließlich auf Datenoperationen und überlässt die Intelligenz der SmartAssistant-Klasse. Dadurch wird der Code besser wartbar und testbar.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Upload-File-to-Collection" class="common-anchor-header"><strong>Datei in Sammlung hochladen</strong></h4><p>Ruft <code translate="no">read_and_chunk_file</code> auf, um vom Benutzer hochgeladene Dateien zu chunkieren und Vektoren zu erzeugen, die in der angegebenen Sammlung gespeichert werden.</p>
...
<p>Die Designphilosophie besteht darin, eine natürlichsprachliche Schnittstelle zu schaffen, die sich anfühlt, als würde man mit einem sachkundigen Assistenten sprechen und nicht eine Datenbank durch Sprachbefehle bedienen.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Kimi K2 nutzt die entsprechenden Werkzeuge, um diese Frage korrekt zu beantworten und zeigt damit, dass es sowohl administrative als auch inhaltliche Vorgänge versteht.</p>
<p>
  <span class="img-wrapper">
