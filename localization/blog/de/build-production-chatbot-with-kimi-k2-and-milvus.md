...
desc: >-
  Erfahren Sie, wie Kimi K2 und Milvus einen produktiven KI-Agenten für
  automatische Dateiverarbeitung, semantische Suche und intelligente Fragen und
  Antworten in realen Aufgaben erstellen.
origin: 'https://milvus.io/blog/build-production-chatbot-with-kimi-k2-and-milvus.md'
---
<p>Der<a href="https://moonshotai.github.io/Kimi-K2/">Kimi K2</a> hat in letzter Zeit Wellen geschlagen - und das aus gutem Grund. Die Mitbegründer von Hugging Face und andere Branchenführer haben es als ein Open-Source-Modell gelobt, das in vielen Bereichen mit geschlossenen Spitzenmodellen wie GPT-4 und Claude mithalten kann.</p>
<p>
...
<p><strong>Zwei bahnbrechende Vorteile zeichnen Kimi K2 aus:</strong></p>
<ul>
<li><p><strong>Leistung auf dem neuesten Stand der Technik</strong>: K2 erzielt Spitzenergebnisse bei wichtigen Benchmarks, wie z. B. AIME2025, und übertrifft Modelle wie Grok-4 in den meisten Dimensionen.</p></li>
<li><p><strong>Robuste Agentenfähigkeiten</strong>: K2 ruft nicht nur Tools auf, sondern weiß auch, wann sie zu verwenden sind, wie man mitten in einer Aufgabe zwischen ihnen umschaltet und wann man sie nicht mehr benötigt. Das eröffnet ernsthafte Anwendungsfälle in der Praxis.</p></li>
</ul>
<p>Benutzertests haben gezeigt, dass die Codierfähigkeiten von Kimi K2 bereits mit denen von Claude 4 vergleichbar sind - und das bei etwa 20 % der Kosten. Noch wichtiger ist, dass es die <strong>autonome Planung von Aufgaben und den Einsatz von Werkzeugen</strong> unterstützt. Sie definieren die verfügbaren Tools, und K2 entscheidet, wann und wie sie eingesetzt werden - eine Feinabstimmung oder Orchestrierungsebene ist nicht erforderlich.</p>
<p>
  <span class="img-wrapper">
...
<h2 id="What-We’ll-Build" class="common-anchor-header">Was wir bauen werden<button data-href="#What-We’ll-Build" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wir bauen einen intelligenten Chatbot, indem wir die Argumentationsfähigkeiten von Kimi K2 mit der Leistung der Vektordatenbank von Milvus kombinieren. Das System bewältigt drei zentrale Arbeitsabläufe, die Ingenieure tatsächlich benötigen:</p>
<ol>
<li><p><strong>Automatische Dateiverarbeitung und Chunking</strong> - Laden Sie Dokumente in verschiedenen Formaten hoch, und lassen Sie das System diese auf intelligente Weise in durchsuchbare Chunks zerlegen</p></li>
<li><p><strong>Semantische Suche</strong> - Finden Sie relevante Informationen anhand von Abfragen in natürlicher Sprache, nicht anhand von Schlüsselwörtern</p></li>
<li><p><strong>Intelligente Entscheidungsfindung</strong> - Der Assistent versteht den Kontext und wählt automatisch die richtigen Werkzeuge für jede Aufgabe aus</p></li>
</ol>
<p>Das gesamte System ist auf nur zwei Hauptklassen aufgebaut, wodurch es einfach zu verstehen, zu ändern und zu erweitern ist:</p>
<ul>
<li><p><strong>VectorDatabase-Klasse</strong>: Dies ist Ihr Arbeitspferd für die Datenverarbeitung. Sie behandelt alles, was mit der Milvus-Vektordatenbank zu tun hat - vom Verbinden und Erstellen von Sammlungen bis hin zum Chunking von Dateien und der Durchführung von Ähnlichkeitssuchen.</p></li>
<li><p><strong>SmartAssistant-Klasse</strong>: Betrachten Sie diese Klasse als das Gehirn des Systems. Sie versteht, was die Benutzer wollen, und legt fest, welche Werkzeuge zur Erledigung der Aufgabe eingesetzt werden sollen.</p></li>
</ul>
<p>In der Praxis sieht das so aus: Benutzer chatten mit dem SmartAssistant in natürlicher Sprache. Der Assistent nutzt die logischen Fähigkeiten von Kimi K2, um Anfragen aufzuschlüsseln, und orchestriert dann 7 spezialisierte Werkzeugfunktionen, um mit der Milvus-Vektordatenbank zu interagieren. Es ist, als hätte man einen intelligenten Koordinator, der genau weiß, welche Datenbankoperationen auf der Grundlage Ihrer Anfrage ausgeführt werden müssen.</p>
<p>
  <span class="img-wrapper">
...
<h2 id="Prerequisites-and-Setup" class="common-anchor-header">Voraussetzungen und Einrichtung<button data-href="#Prerequisites-and-Setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Bevor Sie in den Code eintauchen, sollten Sie sicherstellen, dass Sie die folgenden Voraussetzungen erfüllen:</p>
<p><strong>Systemvoraussetzungen:</strong></p>
<ul>
<li><p>Python 3.8 oder höher</p></li>
<li><p>Milvus-Server (wir verwenden die lokale Instanz an Port 19530)</p></li>
<li><p>Mindestens 4 GB RAM für die Verarbeitung von Dokumenten</p></li>
</ul>
...
<p><strong>Starten Sie Milvus lokal:</strong></p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Import-Libraries-and-Basic-Configuration" class="common-anchor-header">Bibliotheken importieren und Grundkonfiguration<button data-href="#Import-Libraries-and-Basic-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Hier ist pymilvus die Bibliothek für Milvus-Vektordatenbankoperationen, und openai wird verwendet, um Kimi und OpenAI APIs aufzurufen (der Vorteil der API-Kompatibilität von Kimi K2 mit OpenAI und Anthropic ist hier offensichtlich).</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Data-Processing-VectorDatabase-Class" class="common-anchor-header">Datenverarbeitung: VectorDatabase Klasse<button data-href="#Data-Processing-VectorDatabase-Class" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Dies ist der Datenverarbeitungskern des gesamten Systems, der für alle Interaktionen mit der Vektordatenbank verantwortlich ist. Sie kann in zwei Hauptmodule unterteilt werden: <strong>Milvus-Vektordatenbankoperationen und Dateiverarbeitungssystem.</strong></p>
<p>Die Design-Philosophie hier ist die Trennung von Belangen - diese Klasse konzentriert sich ausschließlich auf Datenoperationen und überlässt die Intelligenz der SmartAssistant-Klasse. Dadurch wird der Code besser wartbar und testbar.</p>
<h3 id="Milvus-Vector-Database-Operations" class="common-anchor-header">Milvus-Vektordatenbank-Operationen</h3><h4 id="Initialization-Method" class="common-anchor-header"><strong>Initialisierungsmethode</strong></h4><p>Erstellt einen OpenAI-Client für die Textvektorisierung, wobei das Modell text-embedding-3-small mit einer Vektordimension von 1536 verwendet wird.</p>
<p>Initialisiert auch den Milvus-Client als None und stellt bei Bedarf die Verbindung her.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Text-Vectorization" class="common-anchor-header"><strong>Text-Vektorisierung</strong></h4><p>Ruft die Einbettungs-API von OpenAI auf, um Text zu vektorisieren, und gibt ein 1536-dimensionales Vektor-Array zurück.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Database-Connection" class="common-anchor-header"><strong>Datenbank-Verbindung</strong></h4><p>Erstellt eine MilvusClient-Verbindung zur lokalen Datenbank auf Port 19530 und gibt ein einheitliches Ergebnis-Wörterbuchformat zurück.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Create-Collection" class="common-anchor-header"><strong>Sammlung erstellen</strong></h4><ul>
<li><p><strong>Duplikatsprüfung</strong>: Vermeidet die Erstellung von Sammlungen mit demselben Namen</p></li>
<li><p><strong>Definieren Sie die Struktur</strong>: Drei Felder: id (Primärschlüssel), Text (Text), Vektor (Vektor)</p></li>
<li><p><strong>Index erstellen</strong>: Verwendet <code translate="no">IVF_FLAT</code> Algorithmus und Cosinus-Ähnlichkeit zur Verbesserung der Sucheffizienz</p></li>
<li><p><strong>Automatische ID</strong>: Das System generiert automatisch eindeutige Bezeichner</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Add-Documents-to-Collection" class="common-anchor-header"><strong>Dokumente zur Sammlung hinzufügen</strong></h4><p>Erzeugt Vektordarstellungen für alle Dokumente, fügt sie in das von Milvus benötigte Wörterbuchformat zusammen, führt dann eine Batch-Dateneinfügung durch und gibt schließlich die Einfügezahl und Statusinformationen zurück.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Search-Similar-Documents" class="common-anchor-header"><strong>Ähnliche Dokumente suchen</strong></h4><p>Konvertiert Benutzerfragen in 1536-dimensionale Vektoren, verwendet Cosinus zur Berechnung der semantischen Ähnlichkeit und gibt die relevantesten Dokumente in absteigender Reihenfolge der Ähnlichkeit zurück.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Query-Collections" class="common-anchor-header"><strong>Abfrage von Sammlungen</strong></h4><p>Ermittelt Sammlungsname, Dokumentenzahl und Beschreibungsinformationen.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="32-File-Processing-System" class="common-anchor-header"><strong>3.2 Dateiverarbeitungssystem</strong></h3><h4 id="Intelligent-Text-Chunking" class="common-anchor-header"><strong>Intelligentes Text Chunking</strong></h4><p><strong>Chunking-Strategie:</strong></p>
<ul>
<li><p><strong>Absatzpriorität</strong>: Erste Aufteilung durch doppelten Zeilenumbruch, um die Absatzintegrität zu wahren</p></li>
<li><p><strong>Verarbeitung langer Absätze</strong>: Übermäßig lange Absätze werden durch Punkte, Fragezeichen und Ausrufezeichen getrennt.</p></li>
<li><p><strong>Größenkontrolle</strong>: Sicherstellen, dass jeder Abschnitt nicht zu groß wird, mit einer maximalen Abschnittgröße von 500 Zeichen und einer Überlappung von 50 Zeichen, um den Verlust wichtiger Informationen an den Abschnittsgrenzen zu vermeiden</p></li>
<li><p><strong>Semantische Bewahrung</strong>: Vermeiden Sie die Unterbrechung von Sätzen in der Mitte</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="File-Reading-and-Chunking" class="common-anchor-header"><strong>Lesen und Chunking von Dateien</strong></h4><p>Unterstützt Uploads von Benutzerdateien (txt, md, py und andere Formate), probiert automatisch verschiedene Kodierungsformate aus und gibt detaillierte Fehlerrückmeldungen.</p>
<p><strong>Metadatenerweiterung</strong>: source_file zeichnet die Quelle des Dokuments auf, chunk_index zeichnet den Chunk-Sequenzindex auf, total_chunks zeichnet die Gesamtzahl der Chunks auf, was die Integritätsverfolgung erleichtert.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Upload-File-to-Collection" class="common-anchor-header"><strong>Datei in Sammlung hochladen</strong></h4><p>Ruft <code translate="no">read_and_chunk_file</code> auf, um vom Benutzer hochgeladene Dateien zu chunken und Vektoren zu erzeugen, die in der angegebenen Sammlung gespeichert werden.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Intelligent-Decision-Making-SmartAssistant-Class" class="common-anchor-header">Intelligente Entscheidungsfindung: SmartAssistant-Klasse<button data-href="#Intelligent-Decision-Making-SmartAssistant-Class" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Dies ist das Gehirn des Systems, auch das intelligente Entscheidungszentrum genannt. Hier kommen die autonomen Denkfähigkeiten von Kimi K2 voll zur Geltung - es führt nicht nur vordefinierte Arbeitsabläufe aus, sondern versteht tatsächlich die Absicht des Benutzers und trifft intelligente Entscheidungen darüber, welche Werkzeuge wann eingesetzt werden sollen.</p>
<p>Die Design-Philosophie besteht darin, eine natürlichsprachliche Schnittstelle zu schaffen, die das Gefühl vermittelt, mit einem sachkundigen Assistenten zu sprechen und nicht eine Datenbank durch Sprachbefehle zu bedienen.</p>
<h3 id="Initialization-and-Tool-Definition" class="common-anchor-header"><strong>Initialisierung und Werkzeugdefinition</strong></h3><p>Die Struktur der Werkzeugdefinition folgt dem Funktionsaufrufformat von OpenAI, das Kimi K2 von Haus aus unterstützt. Das macht die Integration nahtlos und ermöglicht eine komplexe Tool-Orchestrierung ohne eigene Parsing-Logik.</p>
<p>Grundlegende Werkzeuge (4):</p>
<p><code translate="no">connect_database</code> - Verwaltung von Datenbankverbindungen<code translate="no">create_collection</code> - Erstellung von Sammlungen<code translate="no">add_documents</code> - Hinzufügen von Batch-Dokumenten<code translate="no">list_all_collections</code> - Verwaltung von Sammlungen</p>
<p>Suchwerkzeuge (1):</p>
<p><code translate="no">search_documents</code> - Suche in einer bestimmten Sammlung</p>
<p>Datei-Tools (2):</p>
<p><code translate="no">read_and_chunk_file</code> - Dateivorschau und Chunking<code translate="no">upload_file_to_collection</code> - Datei-Upload-Verarbeitung</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="42-Tool-Mapping-and-Execution" class="common-anchor-header"><strong>4.2 Tool-Zuordnung und -Ausführung</strong></h3><p>Alle Tools werden einheitlich über _execute_tool ausgeführt.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="43-Core-Conversation-Engine" class="common-anchor-header"><strong>4.3 Kern der Konversationsmaschine</strong></h3><p>Hier passiert die Magie. Die Methode ruft Kimis neuestes Modell auf:<a href="https://moonshotai.github.io/Kimi-K2/"> kimi-k2-0711-preview</a>, um die Absicht des Benutzers zu analysieren, die benötigten Werkzeuge automatisch auszuwählen und auszuführen, dann die Ergebnisse an Kimi zurückzugeben und schließlich die endgültigen Antworten auf der Grundlage der Werkzeugergebnisse zu generieren.</p>
<p>Besonders leistungsfähig ist dabei die Konversationsschleife - Kimi K2 kann mehrere Tool-Aufrufe miteinander verknüpfen, aus Zwischenergebnissen lernen und seine Strategie auf der Grundlage der gewonnenen Erkenntnisse anpassen. Dies ermöglicht komplexe Arbeitsabläufe, die in herkömmlichen Systemen mehrere manuelle Schritte erfordern würden.</p>
<p><strong>Parameter-Konfiguration:</strong></p>
<ul>
<li><p><code translate="no">temperature=0.3</code>: Niedrigere Temperatur gewährleistet stabilen Werkzeugaufruf</p></li>
<li><p><code translate="no">tool_choice=&quot;auto&quot;</code>: Lässt Kimi selbständig entscheiden, ob Werkzeuge verwendet werden sollen</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Main-Program-and-Usage-Demonstration" class="common-anchor-header">Hauptprogramm und Verwendungsdemonstration<button data-href="#Main-Program-and-Usage-Demonstration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Dieses Hauptprogramm richtet die interaktive Umgebung ein. Für den produktiven Einsatz sollten Sie die fest kodierten API-Schlüssel durch Umgebungsvariablen ersetzen und eine angemessene Protokollierung und Überwachung hinzufügen.</p>
<p>Holen Sie sich <code translate="no">KIMI_API_KEY</code> und <code translate="no">OPENAI_API_KEY</code> von der offiziellen Website, um mit der Nutzung zu beginnen.</p>
...
<span class="hljs-keyword">if</span> __name__ == <span class="hljs-string">&quot;__main__&quot;</span>:
    main()
<button class="copy-code-btn"></button></code></pre>
<h2 id="Usage-Examples" class="common-anchor-header">Beispiele für die Verwendung<button data-href="#Usage-Examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Diese Beispiele veranschaulichen die Fähigkeiten des Systems in realistischen Szenarien, die Ingenieure in Produktionsumgebungen antreffen würden.</p>
<h3 id="Upload-file-example" class="common-anchor-header">Beispiel für den Upload einer Datei</h3><p>Dieses Beispiel zeigt, wie das System einen komplexen Arbeitsablauf selbstständig abwickelt. Beachten Sie, wie Kimi K2 die Anfrage des Benutzers aufschlüsselt und die notwendigen Schritte in der richtigen Reihenfolge ausführt.</p>
<pre><code translate="no">User Input: Upload ./The Adventures of Sherlock Holmes.txt to the database
<button class="copy-code-btn"></button></code></pre>
<p>Bemerkenswert ist, dass Kimi K2 den Befehl analysiert und weiß, dass zuerst eine Verbindung zur Datenbank hergestellt werden muss (Funktion connect_database) und dann die Datei in die Sammlung hochgeladen werden muss (Funktion upload_file_to_collection).</p>
<p>Wenn ein Fehler auftritt, kann Kimi K2 diesen anhand der Fehlermeldung sofort beheben, da es weiß, dass es zunächst die Sammlung erstellen (create_collection) und dann die Datei in die Sammlung hochladen muss (upload_file_to_collection). Diese autonome Fehlerbehebung ist ein entscheidender Vorteil gegenüber herkömmlichen skriptbasierten Ansätzen.</p>
<p>
  <span class="img-wrapper">
...
<p>Das System behandelt automatisch:</p>
<ol>
<li><p>Datenbankverbindung</p></li>
<li><p>Erstellung der Sammlung (falls erforderlich)</p></li>
<li><p>Lesen von Dateien und Chunking</p></li>
<li><p>Erzeugung von Vektoren</p></li>
<li><p>Einfügen von Daten</p></li>
<li><p>Statusmeldung</p></li>
</ol>
<h3 id="Question-answer-example" class="common-anchor-header">Frage-Antwort-Beispiel</h3><p>Dieser Abschnitt demonstriert die Intelligenz des Systems bei der Entscheidung, wann es Werkzeuge einsetzt und wann es sich auf vorhandenes Wissen verlässt.</p>
<pre><code translate="no">User Input: List five advantages of the Milvus vector database
<button class="copy-code-btn"></button></code></pre>
<p>Auf dem Bild ist zu sehen, dass Kimi K2 die Frage des Benutzers direkt beantwortet, ohne irgendwelche Funktionen aufzurufen. Dies zeigt die Effizienz des Systems - es führt keine unnötigen Datenbankoperationen für Fragen durch, die es anhand seiner Trainingsdaten beantworten kann.</p>
<p>
  <span class="img-wrapper">
...
<button class="copy-code-btn"></button></code></pre>
<p>Bei dieser Anfrage erkennt Kimi korrekt, dass es den Inhalt des hochgeladenen Dokuments durchsuchen muss. Das System:</p>
<ol>
<li><p>erkennt, dass dafür dokumentenspezifische Informationen erforderlich sind</p></li>
<li><p>Ruft die Funktion search_documents auf</p></li>
<li><p>Analysiert den abgerufenen Inhalt</p></li>
<li><p>liefert eine umfassende Antwort auf der Grundlage des tatsächlich hochgeladenen Inhalts</p></li>
</ol>
<p>
  <span class="img-wrapper">
...
<h3 id="Database-Management-Example" class="common-anchor-header">Beispiel für Datenbankmanagement</h3><p>Administrative Aufgaben werden ebenso reibungslos abgewickelt wie die Abfrage von Inhalten.</p>
<pre><code translate="no"><span class="hljs-built_in">list</span> <span class="hljs-built_in">all</span> the collections
<button class="copy-code-btn"></button></code></pre>
<p>Kimi K2 nutzt die entsprechenden Werkzeuge, um diese Frage korrekt zu beantworten, und zeigt damit, dass es sowohl administrative als auch inhaltliche Vorgänge beherrscht.</p>
<p>
  <span class="img-wrapper">
...
<p>Das System liefert umfassende Informationen, darunter:</p>
<ul>
<li><p>Namen der Sammlungen</p></li>
<li><p>Anzahl der Dokumente</p></li>
<li><p>Beschreibungen</p></li>
<li><p>Allgemeine Datenbankstatistiken</p></li>
</ul>
<h2 id="The-Dawn-of-Production-AI-Agents" class="common-anchor-header">Die Anfänge der KI-Agenten für die Produktion<button data-href="#The-Dawn-of-Production-AI-Agents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
