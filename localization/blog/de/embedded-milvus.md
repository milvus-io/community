...
<p>Wenn Sie ein alter Milvus-Benutzer sind, der PyMilvus bereits installiert hat und nun embedded Milvus installieren möchte, können Sie <code translate="no">$ python3 -m pip install --no-deps milvus</code> ausführen.</p>
...
<p>Wenn Sie embedded Milvus zum ersten Mal ausführen, müssen Sie Milvus zunächst importieren und embedded Milvus einrichten.</p>
