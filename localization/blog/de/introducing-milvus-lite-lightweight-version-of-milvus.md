...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Um den Standalone-Server im Debug-Modus zu starten, führen Sie den folgenden Befehl aus:</li>
</ul>
