...
<p><code translate="no">milvus.proto</code>, <code translate="no">common.proto</code> und <code translate="no">schema.proto</code> bilden zusammen die API von Milvus und stellen alle Operationen dar, die über RPC aufgerufen werden können.</p>
