...
<li>Arithmetische Berechnungen können auch über eingebettete Vektoren hinweg durchgeführt werden. Abbildung 2 zeigt ein Beispiel für ein cross-modales semantisches Approximationsmatching - die in der Abbildung gezeigten Bilder sind das Ergebnis des Abgleichs von Worteinbettungen mit Bildeinbettungen.</li>
</ul>
<p>
...
<p>Filip Haltmayer, ein Dateningenieur bei Zilliz, schloss sein Studium an der University of California, Santa Cruz mit einem BS in Informatik ab. Nachdem er zu Zilliz gekommen ist, verbringt Filip die meiste Zeit damit, an Cloud-Implementierungen, Kundeninteraktionen, technischen Vorträgen und der Entwicklung von KI-Anwendungen zu arbeiten.</p>
