...
9
<button class="copy-code-btn"></button></code></pre>
<p>Starten Sie nach Abschluss der Installation Milvus und vergewissern Sie sich, dass es ordnungsgemäß gestartet wurde. Starten Sie schließlich den Mishards-Dienst auf <strong>einem der</strong> Knoten im Cluster. Das folgende Bild zeigt einen erfolgreichen Start von Mishards. Weitere Informationen finden Sie in der <a href="https://github.com/milvus-io/bootcamp/tree/new-bootcamp/deployments/juicefs">GitHub-Anleitung</a>.</p>
<p>
