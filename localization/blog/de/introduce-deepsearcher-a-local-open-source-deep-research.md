...
desc: >-
  ...
  und verwendete nur Open-Source-Modelle und -Tools wie Milvus und LangChain.
cover: >-
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Ausgabegeschwindigkeit - DeepSeek R1</span> </span></p>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>DeepSearcher-Architektur</span> </span></p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Erneut sorgen wir dafür, dass der LLM eine strukturierte Ausgabe liefert, diesmal als in Python interpretierbare Daten.</p>
