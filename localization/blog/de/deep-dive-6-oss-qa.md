...
<h4 id="QA-testings" class="common-anchor-header">QA-Prüfungen</h4><p>Milvus führt verschiedene Arten von QA-Tests entsprechend den Milvus-Funktionen und den Bedürfnissen der Benutzer in der Reihenfolge der Priorität durch, wie in der folgenden Abbildung dargestellt.</p>
<p>
...
<p>Mit dem SDK-Testframework können einige wichtige Initialisierungsprozesse in eine einzige Funktion verpackt werden. Auf diese Weise lassen sich große Teile des mühsamen Codes eliminieren.</p>
...
<p><a href="https://docs.github.com/en/actions">GitHub Action</a> wird ebenfalls zur Verbesserung der QA-Effizienz eingesetzt, und zwar aufgrund seiner folgenden Merkmale:</p>
<ul>
