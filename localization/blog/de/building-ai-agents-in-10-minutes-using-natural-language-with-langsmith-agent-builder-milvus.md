...
<ul>
<li><strong>Eingabeaufforderung:</strong> Der Prompt ist das Gehirn des Agenten und definiert seine Ziele, Einschränkungen und Entscheidungslogik. LangSmith Agent Builder verwendet Meta-Prompting, um diesen automatisch zu erstellen: Sie beschreiben, was Sie wollen, das Programm stellt klärende Fragen, und Ihre Antworten werden zu einem detaillierten, produktionsreifen Systemprompt zusammengefasst. Anstatt die Logik von Hand zu schreiben, drücken Sie einfach Ihre Absicht aus.</li>
