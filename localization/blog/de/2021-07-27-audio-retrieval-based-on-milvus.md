...
<p>In diesem Artikel werden <a href="https://github.com/qiuqiangkong/audioset_tagging_cnn">groß angelegte, vortrainierte neuronale Audionetzwerke für die Audiomustererkennung (PANNs)</a> verwendet, um Merkmalsvektoren mit einer durchschnittlichen Genauigkeit (mAP) von 0,439 zu extrahieren (Hershey et al., 2017).</p>
