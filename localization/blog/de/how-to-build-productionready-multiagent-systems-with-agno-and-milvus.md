...
<p>Wir haben uns in früheren Beiträgen mit der Speicherverwaltung von Agenten und dem Reranking beschäftigt. Jetzt wollen wir die größere Herausforderung angehen: Agenten zu entwickeln, die auch in der Produktion funktionieren.</p>
<p>Die Realität sieht so aus: Produktionsumgebungen sind chaotisch. Ein einzelner Agent reicht selten aus, weshalb Multiagentensysteme allgegenwärtig sind. Die heute erhältlichen Frameworks lassen sich jedoch in zwei Lager einteilen: leichtgewichtige, die sich gut demonstrieren lassen, aber unter echter Last zusammenbrechen, oder leistungsstarke, die ewig brauchen, um zu lernen und zu entwickeln.</p>
