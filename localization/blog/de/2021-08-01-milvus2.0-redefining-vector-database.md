...
<li>"Fail often" bezieht sich auf die Einführung von Chaostests, bei denen durch Fehlerinjektion in einer Testumgebung Situationen wie Hardwareausfälle und Abhängigkeitsfehler simuliert werden, um die Fehlerentdeckung zu beschleunigen.</li>
</ul>
...
<li>Milvus Insight ist die grafische Benutzeroberfläche von Milvus, die praktische Funktionen wie Cluster-Statusmanagement, Meta-Management und Datenabfrage bietet. Der Quellcode von Milvus Insight wird als unabhängiges Projekt ebenfalls als Open Source zur Verfügung gestellt. Wir sind auf der Suche nach weiteren Mitwirkenden, die sich diesem Vorhaben anschließen.</li>
