...
<h3 id="Garment-detection" class="common-anchor-header">Erkennung von Kleidungsstücken</h3><p>Im Modul für die Erkennung von Kleidungsstücken wird <a href="https://pytorch.org/hub/ultralytics_yolov5/">YOLOv5</a>, ein einstufiges, ankerbasiertes Zielerkennungsmodell, als Objekterkennungsmodell verwendet, da es klein ist und in Echtzeit funktioniert. Es bietet vier Modellgrößen (YOLOv5s/m/l/x), und jede spezifische Größe hat Vor- und Nachteile. Die größeren Modelle sind leistungsfähiger (höhere Genauigkeit), benötigen aber viel mehr Rechenleistung und laufen langsamer. Da es sich in diesem Fall um relativ große und leicht zu erkennende Objekte handelt, ist das kleinste Modell, YOLOv5s, ausreichend.</p>
