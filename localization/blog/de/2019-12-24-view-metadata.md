...
<p>Wir haben einige Informationen über Metadaten in <a href="https://medium.com/@milvusio/managing-data-in-massive-scale-vector-search-engine-db2e8941ce2f">Managing Data in Massive-Scale Vector Search Engine</a> vorgestellt. Dieser Artikel zeigt hauptsächlich, wie man die Metadaten von Milvus anzeigen kann.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Nun haben Sie bereits die Befehlszeile des SQLite-Clients eingegeben. Verwenden Sie einfach einige Befehle, um zu sehen, was in den Metadaten steht.</p>
