...
<h2 id="Summary" class="common-anchor-header">Zusammenfassung<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In diesem Beitrag haben wir gesehen, wie es möglich ist, Open-Source-Modelle aus dem Model Hub von HuggingFace zu exportieren und sie direkt in anderen Sprachen als Python zu verwenden. Es sind jedoch einige Einschränkungen zu beachten:</p>
