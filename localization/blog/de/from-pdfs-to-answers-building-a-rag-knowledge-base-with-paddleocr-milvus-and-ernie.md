...
<p>In vector_store.py verwendet die Methode insert_documents eine Batch-Einbettung. Dies reduziert die Anzahl der Netzwerkanfragen und macht den Prozess effizienter.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-6-Add-Multimodal-QA-for-Charts-and-Diagrams" class="common-anchor-header">Schritt 6: Hinzufügen von multimodalen Fragen und Antworten für Diagramme und Grafiken</h3><p>Forschungsarbeiten enthalten oft wichtige Grafiken und Diagramme, die Informationen enthalten, die im Text nicht enthalten sind. Eine reine Text-RAG-Pipeline würde diese Signale völlig übersehen.  Deshalb haben wir eine einfache bildbasierte Frage- und Antwortfunktion mit drei Teilen hinzugefügt:</p>
