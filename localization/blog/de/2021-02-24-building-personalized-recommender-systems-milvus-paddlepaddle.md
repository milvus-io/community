...
<p>Für das Benutzermerkmal wird die Benutzer-ID auf eine Vektordarstellung mit einer Größe von 256 Dimensionen abgebildet, in die vollständig verbundene Schicht eingegeben und eine ähnliche Verarbeitung für die anderen drei Attribute durchgeführt. Anschließend werden die Merkmalsrepräsentationen der vier Attribute vollständig verknüpft und separat hinzugefügt.</p>
...
<h2 id="System-Overview" class="common-anchor-header">System-Übersicht<button data-href="#System-Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In Kombination mit dem Fusionsempfehlungsmodell von PaddlePaddle wird der vom Modell generierte Filmmerkmalsvektor in der Milvus-Vektorähnlichkeitssuchmaschine gespeichert, und das Benutzermerkmal wird als zu durchsuchender Zielvektor verwendet. Die Ähnlichkeitssuche wird in Milvus durchgeführt, um das Abfrageergebnis als empfohlene Filme für den Benutzer zu erhalten.</p>
<p>
...
<li>Je nach Alter/Geschlecht/Beruf des Nutzers, die in den Parametern angegeben sind, wird er in einen Nutzer-Merkmalsvektor umgewandelt, milvus.search_vectors wird für die Ähnlichkeitssuche verwendet, und das Ergebnis mit der höchsten Ähnlichkeit zwischen dem Nutzer und dem Film wird zurückgegeben.</li>
</ul>
