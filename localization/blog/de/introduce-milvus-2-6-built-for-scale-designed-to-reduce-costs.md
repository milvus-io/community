...
<button class="copy-code-btn"></button></code></pre>
<p>In unseren Leistungstests mit mehr als 100 Mio. Datensätzen reduzierte JSON Path Index die Filterlatenz von <strong>140 ms</strong> (P99: 480 ms) auf nur <strong>1,5 ms</strong> (P99: 10 ms) - eine Latenzreduzierung von 99 %, die solche Suchen in der Produktion praktikabel macht.</p>
