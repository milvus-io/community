...
---
<p>Haben Sie sich jemals gewünscht, Sie könnten Ihrem KI-Assistenten einfach sagen <em>: "Zeige mir alle Sammlungen in meiner Vektordatenbank"</em> oder <em>"Finde Dokumente, die diesem Text ähnlich sind"</em> und es würde tatsächlich funktionieren?</p>
...
<h2 id="Wrapping-Up" class="common-anchor-header">Zusammenfassen<button data-href="#Wrapping-Up" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Und das war's - Sie haben soeben gelernt, wie man Milvus in eine natürlichsprachliche Vektordatenbank verwandelt, <em>mit der</em> Sie buchstäblich <em>sprechen</em> können. Sie müssen sich nicht mehr durch SDK-Dokumente wühlen oder Boilerplate schreiben, nur um eine Sammlung zu erstellen oder eine Suche durchzuführen.</p>
