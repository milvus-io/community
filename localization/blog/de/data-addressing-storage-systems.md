...
<p>In diesem Artikel wird unter einem <em>Zugriff</em> jede Operation mit realen Kosten auf Systemebene verstanden: ein Festplattenlesevorgang, ein Netzwerkaufruf oder eine Objektspeicher-API-Anforderung. CPU-Berechnungen auf Nanosekundenebene zählen nicht. Worauf es ankommt, ist die Verringerung der Anzahl der E/A-Vorgänge - oder die Umwandlung teurer zufälliger E/A in billigere sequenzielle Lesevorgänge.</p>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Die HDFS-Datenorganisation zeigt die logische Ansicht einer 300 MB großen Datei, die als drei Blöcke, verteilt auf DataNodes mit Replikation, auf den physischen Speicher abgebildet wird</span> </span></p>
...
<li><strong>Nur lesen, was benötigt wird</strong> - Die Spaltenbeschneidung von Parquet liest nur die id-Spalte aus der Small-Field-Datei und nur die <a href="https://milvus.io/docs/index-vector-fields.md">Vektorspalte</a> aus der Large-Field-Datei. Es wird nur auf passende Zeilengruppen zugegriffen.</li>
</ol>
