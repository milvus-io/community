...
desc: >-
  ...
  Änderungsdatenerfassung, ScaNN-Index und Bereichssuche. Darüber hinaus bietet
  sie eine verbesserte Abfrageleistung, eine robustere Lastverteilung und
...
<h2 id="CDC-support-for-higher-system-availability" class="common-anchor-header">CDC-Unterstützung für höhere Systemverfügbarkeit<button data-href="#CDC-support-for-higher-system-availability" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Change Data Capture (CDC) ist eine häufig verwendete Funktion in Datenbanksystemen, die Datenänderungen erfasst und an ein bestimmtes Ziel repliziert. Mit der CDC-Funktion ermöglicht Milvus 2.3 den Anwendern die Synchronisierung von Daten über verschiedene Rechenzentren hinweg, die Sicherung inkrementeller Daten und die nahtlose Migration von Daten, wodurch die Verfügbarkeit des Systems erhöht wird.</p>
...
<h3 id="Enhanced-message-queues-based-on-NATS" class="common-anchor-header">Verbesserte Nachrichten-Warteschlangen auf der Grundlage von NATS</h3><p>Wir haben Milvus auf einer logbasierten Architektur aufgebaut und in früheren Versionen Pulsar und Kafka als zentrale Log-Broker verwendet. Diese Kombination stand jedoch vor drei großen Herausforderungen:</p>
<ul>
...
<li>Pulsar und Kafka sind eng mit dem Java-Ökosystem verbunden, sodass ihre Go-SDKs von der Community nur selten gewartet und aktualisiert werden.</li>
</ul>
