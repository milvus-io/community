...
<p>Die Stärke der IVF liegt in ihrem zweistufigen Filterungsprozess. Es kann zunächst einen grobkörnigen Filter auf der Ebene der Zentroide (Cluster) durchführen, um die Kandidatengruppe schnell einzugrenzen, und dann feinkörnige Abstandsberechnungen innerhalb der ausgewählten Cluster durchführen. Dadurch bleibt die Leistung stabil und vorhersehbar, selbst wenn ein großer Teil der Daten herausgefiltert wird.</p>
