...
<h2 id="How-to-Enable-Phrase-Match-in-Milvus" class="common-anchor-header">So aktivieren Sie Phrase Match in Milvus<button data-href="#How-to-Enable-Phrase-Match-in-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Phrase Match funktioniert mit Feldern des Typs <strong><code translate="no">VARCHAR</code></strong>ist der String-Typ in Milvus. Um sie zu verwenden, müssen Sie Ihr Sammlungsschema so konfigurieren, dass Milvus eine Textanalyse durchführt und Positionsinformationen für das Feld speichert. Dies geschieht durch die Aktivierung von zwei Parametern: <code translate="no">enable_analyzer</code> und <code translate="no">enable_match</code>.</p>
