...
<p>Dank der Mixture-of-Experts (MoE)-Architektur ist nur eine Teilmenge der Parameter während der Inferenz aktiv. Dadurch sind beide Modelle im Verhältnis zu ihrer Größe leicht auszuführen:</p>
<ul>
...
<p>Am interessantesten ist jedoch das Timing. Der Teaser von OpenAI auf X - mit einer "5" in dem Wort "LIVESTREAM" - wirkt wie eine Falle. GPT-oss ist vielleicht nicht der Hauptakt, aber es könnte eine Vorschau auf das sein, was in GPT-5 kommt. Gleiche Zutaten, anderer Maßstab. Warten wir ab.</p>
<p>
  <span class="img-wrapper">
