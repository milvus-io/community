...
<p>Nettoyer<strong>régulièrement les fichiers de cache</strong> - Vérifier régulièrement le dépôt privé (en utilisant des scripts par exemple), et nettoyer les fichiers de cache qui n'ont pas été modifiés depuis un certain temps ou qui n'ont pas été beaucoup téléchargés.</p>
