...
<p>Une autre caractéristique de l'API de type ORM est qu'après abstraction, toutes les opérations peuvent être effectuées directement sur les objets, y compris la collection, la partition et l'index.</p>
