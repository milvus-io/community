...
<p>Lorsqu'un segment se vide sur le disque, ou lorsque Milvus demande un compactage global car le compactage n'a pas été exécuté depuis longtemps, la condition suivante doit être remplie pour déclencher le compactage automatique :</p>
<ul>
...
<h2 id="About-the-author" class="common-anchor-header">A propos de l'auteur<button data-href="#About-the-author" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Bingyi Sun, ingénieur logiciel principal du projet Milvus, a obtenu sa maîtrise en ingénierie logicielle à l'université Jiao Tong de Shanghai. Il est principalement responsable du développement des composants liés au stockage dans Milvus 2.0. Son domaine d'intérêt est la base de données et les systèmes distribués. C'est un grand amateur de projets open source et un fin gourmet qui aime jouer aux jeux vidéo et lire pendant son temps libre.</p>
