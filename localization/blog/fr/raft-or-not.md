...
<p>Notez que cet article se concentre principalement sur la synchronisation des données/logs incrémentaux. Par conséquent, lorsque l'on parle de réplication des données/logs, on se réfère uniquement à la réplication des données incrémentales, et non des données historiques.</p>
