...
<h4 id="Code-implementation-details" class="common-anchor-header">Détails de la mise en œuvre du code</h4><p>Le code source de DiskANN est en libre accès sur https://github.com/microsoft/DiskANN.</p>
...
<li>générer_pq_pivots : Échantillonne le point central de l'ensemble d'entraînement PQ en utilisant le taux d'échantillonnage de p = 1500000/n uniformément pour entraîner PQ globalement.</li>
