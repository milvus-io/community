...
<li>Ou la valeur absolue de la différence d'utilisation de la RAM de deux nœuds de requête est supérieure à <code translate="no">queryCoord.memoryUsageMaxDifferencePercentage</code> (par défaut : 30).</li>
</ol>
...
<h2 id="Whats-next" class="common-anchor-header">Quelles sont les prochaines étapes ?<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dans la série de blogs sur les nouvelles fonctionnalités de la version 2.0, nous expliquerons la conception des nouvelles fonctionnalités. Plus d'informations dans cette série de blogs !</p>
<ul>
