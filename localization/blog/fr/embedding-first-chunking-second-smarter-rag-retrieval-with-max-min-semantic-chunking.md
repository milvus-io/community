...
<p>Le problème est que les stratégies de découpage traditionnelles découpent généralement le texte sans aucune compréhension sémantique. Le découpage à longueur fixe est basé sur le nombre de jetons, et le découpage récursif utilise une structure de surface, mais tous deux ignorent encore le sens réel du texte. En conséquence, les idées connexes sont souvent séparées, les lignes sans rapport sont regroupées et le contexte important est fragmenté.</p>
