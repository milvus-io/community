...
<h2 id="Milvus-architecture-recap" class="common-anchor-header">Récapitulation de l'architecture Milvus<button data-href="#Milvus-architecture-recap" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
