...
<li><p><strong>Extension Chrome</strong>: Recherche sémantique de code en ligne tout en naviguant dans les dépôts GitHub - pas besoin de changer d'onglet.</p></li>
...
<li><p>Accédez instantanément aux résultats en cliquant sur le bouton "naviguer".</p></li>
</ul>
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/mcp_code_context_processed_3908097481.gif" alt="" class="doc-image" id="" />
...
<li><p><strong>Des visualiseurs d'architecture</strong> qui construisent des diagrammes à partir de relations sémantiques entre les codes</p></li>
