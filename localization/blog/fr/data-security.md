...
<li><a href="#How-does-the-Milvus-vector-database-ensure-data-security">Comment la base de données vectorielles Milvus assure-t-elle la sécurité des données ?</a><ul>
...
<h4 id="How-to-manage-user-authentication-in-the-Milvus-vector-database" class="common-anchor-header">Comment gérer l'authentification des utilisateurs dans la base de données vectorielle Milvus ?</h4><p>Pour activer l'authentification, vous devez d'abord définir <code translate="no">common.security.authorizationEnabled</code> sur <code translate="no">true</code> lors de la configuration de Milvus dans le fichier <code translate="no">milvus.yaml</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Consultez la <a href="https://milvus.io/docs/v2.1.x/authenticate.md">documentation Milvus</a> pour en savoir plus sur l'authentification des utilisateurs.</p>
