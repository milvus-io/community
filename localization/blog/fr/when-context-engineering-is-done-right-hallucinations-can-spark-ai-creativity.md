...
<h3 id="Cloud-Native-Elasticity" class="common-anchor-header">Élasticité native dans le nuage</h3><p>Les deux systèmes sont conçus en mode cloud-native, le stockage et l'informatique évoluant de manière indépendante. Cela signifie que lorsque les charges de travail passent de gigaoctets à pétaoctets, vous pouvez équilibrer les ressources entre le service en temps réel et la formation hors ligne, plutôt que de surprovisionner l'un ou de sous-estimer l'autre.</p>
