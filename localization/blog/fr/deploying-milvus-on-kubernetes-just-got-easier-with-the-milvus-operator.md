...
<li><p>b. Il est utile d'avoir à la fois <code translate="no">querynode-0</code> et <code translate="no">querynode-1</code> lors des mises à jour. Au final, un seul d'entre eux sera actif.</p></li>
</ul>
