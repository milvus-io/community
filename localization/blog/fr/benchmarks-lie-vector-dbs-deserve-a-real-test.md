...
<h3 id="Filtering" class="common-anchor-header">Filtrage</h3><p>La recherche vectorielle en production se fait rarement de manière isolée. Les applications réelles combinent la similarité vectorielle avec le filtrage des métadonnées ("trouver des chaussures qui ressemblent à cette photo mais qui coûtent moins de 100 dollars"). Cette recherche vectorielle filtrée crée des défis uniques :</p>
<ul>
