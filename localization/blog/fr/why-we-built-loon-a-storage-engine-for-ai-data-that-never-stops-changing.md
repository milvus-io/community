...
title: >-
  Pourquoi nous avons créé Loon : un moteur de stockage pour des données d’IA
  qui ne cessent jamais d’évoluer.
author: Ted Xu
date: 2026-6-10
...
meta_keywords: >-
  Loon storage engine, Milvus 3.0, vector storage, AI datasets, Zilliz Vector
  Lakebase
meta_title: |
  AI Datasets Are Never Done. So We Re-Built Our Storage Engine for Milvus
desc: >-
  Loon alimente Milvus 3.0 avec un stockage vectoriel versionné pour les jeux de
  données d’IA évolutifs, des backfills efficaces, la recherche hybride et des
  workflows natifs du lac de données.
origin: >-
...
<table>
<thead>
<tr><th>Dataset shape</th><th>Approximate row size</th><th>Dominant field</th></tr>
</thead>
<tbody>
<tr><td>TPC-H lineitem</td><td>~150 bytes uncompressed</td><td>scalar and short strings</td></tr>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_3_5364dac84d.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_4_c52692571d.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
<p>If the team adds one or two vector-like columns every month, such as <code translate="no">embedding_v2</code>, <code translate="no">sparse_vector</code>, or rerank features, schema evolution becomes a recurring data engineering job measured in hundreds of gigabytes or terabytes.</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_5_7ec257e0e0.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_6_1058be8f2f.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_7_203b6b9dbf.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_8_a2e50d05ad.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_9_490b33529c.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_10_a11d6e20dc.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_12_d5d751e0db.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_13_382d619116.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="https://assets.zilliz.com/why_we_built_loon_a_storage_engine_for_ai_data_that_never_stops_changing_md_14_74b7f2af8a.png" alt="" class="doc-image" id="" />
    <span></span>
  </span>
</p>
