...
<li><strong>Sauvegarde des données (Beta)</strong>: Milvus v2.2 fournit <a href="https://github.com/zilliztech/milvus-backup">un tout nouvel outil</a> pour sauvegarder et restaurer correctement vos données Milvus, que ce soit via une ligne de commande ou un serveur API.</li>
</ul>
