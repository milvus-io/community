...
<p><br/></p>
<h3 id="Xiaomi’s-content-recommendation-system" class="common-anchor-header">Système de recommandation de contenu de Xiaomi</h3><p>Le système de recommandation d'actualités de Xiaomi basé sur le navigateur repose sur trois éléments clés : la vectorisation, le mappage d'ID et le service de voisinage le plus proche (ANN).</p>
...
<li><a href="https://zilliz.com/blog/Vector-Similarity-Search-Hides-in-Plain-View">La recherche de similarité vectorielle se cache en toute discrétion</a></li>
