...
<p>Comme pour le chemin d'écriture, les diagrammes de flux sont également introduits dans le chemin de lecture. Milvus met en œuvre l'architecture Lambda unifiée, qui intègre le traitement des données incrémentielles et historiques. Par conséquent, les nœuds de requête doivent également obtenir des données en continu en temps réel. De même, les diagrammes de flux dans le chemin de lecture filtrent et différencient les données provenant de différentes collections.</p>
