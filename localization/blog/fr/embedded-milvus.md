...
desc: >-
  Une version de Milvus conviviale de Python qui rend l'installation plus
  flexible.
...
<li><p>Vous souhaitez utiliser rapidement Milvus sans démarrer un processus Milvus distinct et d'autres composants nécessaires tels que etcd, MinIO, Pulsar, etc.</p></li>
</ul>
