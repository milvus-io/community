...
Étape 2 : Cloner le projet</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
...
<p>Remarque : Milvus est ajouté comme l'un des types de base de données vectorielles pris en charge dans le module d'extraction.</p>
