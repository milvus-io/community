...
title: >-
  Au-delà de =~ : comment Milvus 3.0 transforme les regex en filtre de base de
  données natif
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  Milvus 3.0 déplace les expressions régulières du post-traitement côté
  application vers le chemin de requête de la base de données, où elles peuvent
  être combinées avec la recherche vectorielle, la recherche en texte intégral,
  les filtres scalaires et l’exécution indexée.
