...
<p>La deuxième tâche était plus difficile : implémenter la détection de collision polygone-boule à l'intérieur d'un hexagone en rotation, avec une vitesse de rotation, une élasticité et un nombre de billes ajustables. GPT-5 a généré la première version en environ treize secondes. Le code comprenait toutes les fonctionnalités attendues, mais il comportait des bogues et ne s'exécutait pas.</p>
<p>
  <span class="img-wrapper">
...
<p>Certains amis ont plaisanté sur la création de "mémoriaux en ligne" pour GPT-4o, affirmant que la personnalité de leur ancien compagnon de conversation avait disparu à jamais. Le changement ne me dérange pas - GPT-5 est peut-être moins chaleureux et bavard, mais son style direct et sans fioritures est rafraîchissant.</p>
