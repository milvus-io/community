...
<h3 id="1-Context-Clash" class="common-anchor-header">1. Le choc des contextes</h3><p>Le conflit de contexte se produit lorsque les informations accumulées au cours de plusieurs tours deviennent intérieurement contradictoires.</p>
...
<li><p><strong>Étiquetage de la pertinence au niveau des jetons (masque binaire) :</strong> En parallèle, le modèle attribue une étiquette binaire à chaque mot, indiquant s'il est pertinent (<code translate="no">1</code>) ou non pertinent (<code translate="no">0</code>) pour la requête.</p></li>
</ol>
