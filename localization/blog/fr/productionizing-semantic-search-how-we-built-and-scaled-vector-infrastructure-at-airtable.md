...
<li>de fournir ces lignes en tant que contexte à un LLM.</li>
</ul>
...
<li>Le nœud coordinateur orchestre toute l'activité du cluster et l'affectation des unités de stockage.</li>
