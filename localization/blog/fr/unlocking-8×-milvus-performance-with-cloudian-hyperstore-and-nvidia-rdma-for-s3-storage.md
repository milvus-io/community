...
<p>Cette technologie élimine les étapes intermédiaires grâce à une voie directe qui réduit la latence, diminue considérablement les besoins de traitement du processeur et réduit de manière significative la consommation d'énergie. Il en résulte des systèmes de stockage capables de fournir des données à la vitesse requise par les GPU modernes pour les applications d'IA exigeantes.</p>
