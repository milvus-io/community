...
<h2 id="Conclusion" class="common-anchor-header">Conclusion<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ce qui a commencé comme une curiosité sur le backend de stockage de Milvus s'est transformé en un chatbot RAG fonctionnel - et le chemin de l'un à l'autre a été plus court que prévu. Voici ce que couvre la construction, de bout en bout :</p>
<ul>
...
<p>Quelques-uns des enseignements que j'ai tirés de ce processus :</p>
<ul>
