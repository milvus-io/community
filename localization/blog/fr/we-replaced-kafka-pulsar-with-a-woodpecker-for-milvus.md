...
<h3 id="Operational-Complexity" class="common-anchor-header">Complexité opérationnelle</h3><p>Les dépendances externes comme Kafka ou Pulsar nécessitent des machines dédiées avec plusieurs nœuds et une gestion minutieuse des ressources. Cela crée plusieurs défis :</p>
<ul>
...
<li><p>Pas de dépendance à l'égard des disques locaux pour les opérations de base</p></li>
</ul>
<p>
  <span class="img-wrapper">
