...
<p>Milvus prendra bientôt en charge les ID de vecteurs sous forme de chaînes, et les ID entiers n'auront plus à être mis en correspondance avec le nom correspondant au format chaîne. Cela rend la couche de mise en cache Redis inutile et l'architecture du système moins encombrante.</p>
...
<p>Pour maintenir la cohérence des données, Mishards ne prend en charge qu'un seul nœud d'écriture. Cependant, une version distribuée de Milvus prenant en charge plusieurs nœuds d'écriture sera disponible dans les mois à venir.</p>
<p><br/></p>
