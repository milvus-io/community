...
title: >-
  Snapshots Milvus : vues de collections à un instant donné sans copier les
  données
author: Leo Liu
date: 2026-7-30
...
desc: >-
  Les instantanés Milvus figent une collection en enregistrant des références de
  fichiers au lieu de copier les données — points de récupération peu coûteux,
  restauration sans reconstruction d’index et entrées stables pour Spark.
