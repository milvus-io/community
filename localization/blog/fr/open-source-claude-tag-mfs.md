...
title: 'Open Tag : un tag Claude open source pour Claude Code et Codex'
author: Cheney Zhang
...
desc: >-
  Un Claude Tag open source et natif Slack pour Claude Code et Codex, conçu sur
  MFS : une interface unique, consultable et explorable, pour votre code, votre
  documentation, vos tickets et vos bases de données.
