...
<li><strong>Application de règles</strong> - le système filtre les enregistrements correspondants et ajuste leurs scores en utilisant le poids configuré et l'option <code translate="no">random_score</code>.</li>
