...
<li><p><strong>تجميع الجمل-</strong> يتم تجميع درجات الرموز الرمزية على مستوى الجملة، عادةً عن طريق حساب المتوسط، للحصول على درجة الصلة لكل جملة.</p></li>
...
<li><p>يحافظ على 0.6 مليار معلمة - قوية بما فيه الكفاية دون أن تكون ثقيلة من الناحية الحسابية</p></li>
...
<p>اتضح أن تضمين التعليل كان ذا قيمة مدهشة:</p>
<ul>
...
<p>نموذجنا:</p>
<ul>
<li><p>يعطي بشكل صحيح الجملة 1 أعلى درجة (0.915)</p></li>
...
<li><p>قدم<strong>مشروع بروفانس المفتوح المصدر</strong> كوداً متيناً ومصمماً بشكل جيد - خطوط أنابيب التدريب، ومعالجة البيانات، ورؤوس النماذج - تحت رخصة متساهلة. لقد أعطانا نقطة انطلاق قوية للتجريب.</p></li>
</ul>
...
<p>نحن ممتنون لفريقي Provence وOpen Provence لنشر عملهما بشكل علني. لقد سرّعت مساهماتهم بشكل كبير من تطورنا وجعلت هذا المشروع ممكنًا.</p>
