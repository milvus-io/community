...
tags: >-
  ...
  Vector Management
desc: إدخال ميزات وتحسينات جديدة على الإصدارين 2.2.10 و2.2.11 من Milvus
recommend: true
...
<h2 id="Milvus-2211" class="common-anchor-header">ملفوس 2.2.11<button data-href="#Milvus-2211" class="anchor-icon" translate="no">
    ...
    </button></h2><p>قام Milvus 2.2.11 بحل العديد من المشكلات لتحسين استقرار النظام. كما قام أيضًا بتحسين أدائه في المراقبة والتسجيل وتحديد المعدل واعتراض الطلبات عبر المجموعات. انظر أدناه للاطلاع على أبرز ميزات هذا التحديث.</p>
<ul>
