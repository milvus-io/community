...
title: 'ميلفوس + RustFS+ ترميز فيبي: بناء روبوت محادثة RAG خفيف الوزن من الصفر'
author: Jinghe Ma
date: 2026-3-10
...
<p>بالنسبة لطبقة التخزين، اخترتُ <a href="https://rustfs.com/">RustFS،</a> وهو نظام تخزين كائنات متوافق مع S3 مفتوح المصدر ومكتوب بلغة Rust. يمكن نشره عبر مخطط ثنائي أو Docker أو Helm. على الرغم من أنه لا يزال في مرحلة ألفا ولا يوصى به لأعباء عمل الإنتاج، إلا أنه كان مستقرًا بما يكفي لهذا البناء.</p>
...
<li><strong>من الممتع العمل مع</strong><strong><a href="https://rustfs.com/">RustFS</a></strong> <strong>كواجهة خلفية لتخزين الكائنات.</strong> استغرق إسقاطه في MinIO جهدًا أقل مما كان متوقعًا.</li>
