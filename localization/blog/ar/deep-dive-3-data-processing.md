...
<blockquote>
<p>يمكن تحديد عدد الأجزاء في المجموعة عند إنشاء المجموعة. يتوافق كل جزء مع <a href="https://milvus.io/docs/v2.0.x/glossary.md#VChannel">قناة افتراضية (قناة افتراضية)</a>. لذلك، يمكن أن تحتوي المجموعة على عدة قنوات افتراضية. يعين Milvus لكل قناة افتراضية في وسيط السجل <a href="https://milvus.io/docs/v2.0.x/glossary.md#PChannel">قناة فعلية (pchannel)</a>.</p>
</blockquote>
<p>
