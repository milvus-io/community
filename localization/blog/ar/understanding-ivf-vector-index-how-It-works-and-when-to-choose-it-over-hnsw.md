...
<ul>
<li><p><strong>SQ8 (التكميم الكمّي):</strong> تعمل هذه الطريقة على تكميم كل بُعد من أبعاد المتجه إلى 8 بتات. بالنسبة لمتجه قياسي <code translate="no">float32</code> ، يشغل كل بُعد عادةً 4 بايت. باستخدام SQ8، يتم اختزاله إلى 1 بايت فقط - مما يحقق نسبة ضغط 4:1 مع الحفاظ على هندسة المتجه سليمة إلى حد كبير.</p></li>
...
<ul>
<li><p><strong>قائمة nlist أكبر</strong>: ينشئ مجموعات أكثر دقة، ما يعني أن كل مجموعة تحتوي على عدد أقل من المتجهات. هذا يقلل من عدد المتجهات التي يتم مسحها ضوئيًا أثناء البحث وينتج عنه بشكل عام استعلامات أسرع. لكن بناء الفهرس يستغرق وقتًا أطول، ويستهلك جدول النواة المركزية ذاكرة أكبر.</p></li>
...
<ul>
<li><p><strong>nprobe أكبر</strong>: يغطي عددًا أكبر من المجموعات، مما يؤدي إلى استرجاع أعلى ولكن أيضًا إلى زمن انتقال أعلى. يزداد التأخير بشكل عام بشكل خطي مع عدد المجموعات التي يتم البحث فيها.</p></li>
...
<tr><td><strong>سرعة إنشاء الفهرس</strong></td><td>سريع (يتطلب التجميع فقط)</td><td>بطيء (يحتاج إلى إنشاء رسم بياني متعدد الطبقات)</td></tr>
...
<li><p><strong>استرجاع براءات الاختراع:</strong> بالنظر إلى وصف موجز، يمكن للنظام تحديد موقع براءات الاختراع الأكثر ارتباطًا من الناحية الدلالية من قاعدة بيانات ضخمة - أكثر كفاءة بكثير من البحث التقليدي بالكلمات الرئيسية.</p></li>
