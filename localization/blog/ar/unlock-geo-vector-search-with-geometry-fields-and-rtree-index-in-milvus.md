...
title: >-
  التقاء المكاني بالدلالي: فتح البحث عن المتجهات الجغرافية مع الحقول الهندسية
  وفهرس RTREE في ميلفوس
author: Cai Zhang
...
---
<p>مع ازدياد ذكاء الأنظمة الحديثة، أصبحت بيانات الموقع الجغرافي ضرورية لتطبيقات مثل التوصيات التي تعتمد على الذكاء الاصطناعي والإرسال الذكي والقيادة الذاتية.</p>
<p>على سبيل المثال، عندما تطلب الطعام على منصات مثل DoorDash أو Uber Eats، يأخذ النظام في الاعتبار أكثر بكثير من المسافة بينك وبين المطعم. فهو يأخذ في الحسبان أيضاً تقييمات المطاعم ومواقع السعاة وظروف حركة المرور وحتى التضمينات التي تفضلها شخصياً. في القيادة الذاتية، يجب أن تقوم المركبات في القيادة الذاتية بتخطيط المسار، واكتشاف العوائق، والفهم الدلالي على مستوى المشهد، وغالباً ما يتم ذلك في غضون بضعة أجزاء من الثانية.</p>
<p>يعتمد كل ذلك على القدرة على فهرسة البيانات الجغرافية المكانية واسترجاعها بكفاءة.</p>
<p>تقليدياً، كانت البيانات الجغرافية وبيانات المتجهات تعيش في نظامين منفصلين:</p>
<ul>
<li><p>تخزّن الأنظمة الجغرافية المكانية الإحداثيات والعلاقات المكانية (خطوط الطول والعرض والمناطق المضلعة وغيرها).</p></li>
<li><p>بينما تتعامل قواعد البيانات المتجهة مع التضمينات الدلالية والبحث عن التشابه الناتج عن نماذج الذكاء الاصطناعي.</p></li>
</ul>
<p>يعقّد هذا الفصل البنية ويبطئ الاستعلامات ويجعل من الصعب على التطبيقات إجراء الاستدلال المكاني والدلالي في نفس الوقت.</p>
<p>يعالج<a href="https://milvus.io/docs/release_notes.md#v264">الإصدار Milvus 2.6</a> هذه المشكلة من خلال تقديم <a href="https://milvus.io/docs/geometry-field.md">حقل الهندسة،</a> الذي يسمح بدمج البحث عن التشابه المتجهي مباشرةً مع القيود المكانية. يتيح ذلك حالات استخدام مثل:</p>
<ul>
...
<h2 id="What-Is-a-Geometry-Field" class="common-anchor-header">ما هو الحقل الهندسي؟<button data-href="#What-Is-a-Geometry-Field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>في قلب هذه العملية توجد <strong>RTREE (الشجرة المستطيلة)</strong>، وهي بنية فهرسة مكانية مصممة للبيانات الهندسية متعددة الأبعاد. تعمل RTREE على تسريع الاستعلامات المكانية من خلال تنظيم الكائنات الهندسية بشكل هرمي.</p>
<p><strong>المرحلة 1: بناء الفهرس</strong></p>
<p><strong>1. إنشاء العقد الورقية:</strong> لكل كائن هندسي، قم بحساب <strong>الحد الأدنى للمستطيل المحدود (MBR)</strong>- أصغر مستطيل يحتوي على الكائن بالكامل - وخزنه كعقدة ورقية.</p>
...
<p><strong>3. جمع الفروع المرشحة:</strong> انزل إلى الفروع المتقاطعة واجمع العقد الورقية المرشحة.</p>
...
<tr><td style="text-align:center"><strong>st_within(A، B)</strong></td><td style="text-align:center">تُرجع TRUE إذا كان الشكل الهندسي A يحتوي بالكامل على الشكل الهندسي B. هذا هو عكس st_contains(A, B).</td></tr>
...
<p><strong>2. الترتيب حسب الدلالات باستخدام البحث المتجه:</strong> من المرشحين المتبقين، يختار فهرس المتجهات النتائج الأكثر تشابهًا من بين أعلى N بناءً على تشابه التضمين.</p>
<p>
  <span class="img-wrapper">
...
<h2 id="Real-World-Applications-of-Geo-Vector-Retrieval" class="common-anchor-header">تطبيقات العالم الواقعي لاسترجاع المتجهات الجغرافية<button data-href="#Real-World-Applications-of-Geo-Vector-Retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="2-Autonomous-Driving-More-Intelligent-Decisions" class="common-anchor-header">2. القيادة الذاتية: قرارات أكثر ذكاءً</h3><p>في القيادة الذاتية، تُعدّ الفهرسة الجغرافية المكانية أمراً أساسياً في القيادة الذاتية الإدراك وتحديد المواقع واتخاذ القرارات. يجب على المركبات مواءمة نفسها باستمرار مع الخرائط عالية الوضوح واكتشاف العوائق وتخطيط المسارات الآمنة - كل ذلك في غضون بضعة أجزاء من الثانية.</p>
<p>باستخدام Milvus، يمكن لنوع الهندسة وفهرس RTREE تخزين البنى المكانية الغنية والاستعلام عنها مثل:</p>
<ul>
<li><p><strong>حدود الطرق</strong> (سلسلة خطية)</p></li>
<li><p><strong>مناطق تنظيم حركة المرور</strong> (مضلع)</p></li>
<li><p><strong>العوائق المكتشفة</strong> (نقطة)</p></li>
</ul>
<p>يمكن فهرسة هذه الهياكل بكفاءة، مما يسمح للبيانات الجغرافية المكانية بالمشاركة مباشرةً في حلقة قرار الذكاء الاصطناعي. على سبيل المثال، يمكن للمركبة ذاتية القيادة أن تحدد بسرعة ما إذا كانت إحداثياتها الحالية تقع ضمن حارة معينة أو تتقاطع مع منطقة محظورة، وذلك ببساطة من خلال مسند مكاني من RTREE.</p>
...
<h2 id="Conclusion" class="common-anchor-header">الخلاصة<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>إن تحديد الموقع الجغرافي هو أكثر من مجرد خطوط الطول والعرض، فهو مصدر قيّم للمعلومات الدلالية التي تخبرنا أين تحدث الأشياء، وكيف ترتبط بمحيطها، وما هو السياق الذي تنتمي إليه.</p>
<p>في قاعدة بيانات الجيل التالي من قاعدة بيانات Zilliz، تجتمع البيانات المتجهة والمعلومات الجغرافية المكانية تدريجياً كأساس موحد. يتيح ذلك:</p>
<ul>
<li><p>الاسترجاع المشترك عبر المتجهات والبيانات الجغرافية المكانية والوقت</p></li>
<li><p>أنظمة التوصية الواعية مكانياً</p></li>
<li><p>البحث المتعدد الوسائط والمستند إلى الموقع (LBS)</p></li>
</ul>
<p>لن يقتصر الذكاء الاصطناعي في المستقبل على فهم <em>معنى</em> المحتوى فحسب، بل سيشمل أيضاً مكان تطبيقه ومتى يكون أكثر أهمية.</p>
<p>لمزيد من المعلومات حول حقل الهندسة وفهرس RTREE، راجع الوثائق أدناه:</p>
<ul>
<li><p><a href="https://milvus.io/docs/geometry-field.md">الحقل الهندسي | وثائق ملفوس</a></p></li>
<li><p><a href="https://milvus.io/docs/rtree.md">RTREE | توثيق ملفوس</a></p></li>
</ul>
...
<li><p><a href="https://milvus.io/blog/how-to-filter-efficiently-without-killing-recall.md">بحث المتجهات في العالم الحقيقي: كيفية التصفية بكفاءة دون قتل التذكر</a></p></li>
</ul>
