...
---
<p>عمل نموذج RAG الخاص بك بشكل رائع. ثم انتقل إلى الإنتاج، وازدادت حركة المرور، والآن ارتفعت فاتورة قاعدة بياناتك المتجهة من 500 دولار إلى 5000 دولار شهريًا. هل يبدو ذلك مألوفاً؟</p>
...
<h2 id="Why-Memory-Is-So-Expensive-for-Vector-Search" class="common-anchor-header">لماذا الذاكرة باهظة الثمن للبحث في المتجهات<button data-href="#Why-Memory-Is-So-Expensive-for-Vector-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>HNSW</strong>: يخزن بنية رسم بياني إضافية، لذا فإن استخدام الذاكرة عادةً ما يكون <strong>1.5 ضعف إلى 2.5 ضعف</strong> حجم البيانات الخام، أو حوالي <strong>450 إلى 600 جيجابايت</strong></li>
<li><strong>IVF_SQ8</strong>: يضغط قيم float32 إلى uint8، مما يعطي <strong>ضغطًا بمعدل 4 أ</strong>ضعاف، لذا يمكن أن ينخفض استخدام الذاكرة إلى حوالي <strong>75 إلى 100 جيجابايت</strong></li>
...
<tr><td>خريطة مم</td><td>تخزين الكائنات → قرص محلي (100٪) → ذاكرة (حسب الطلب)</td><td>منخفضة (10-30%)</td><td>عالية (100%)</td><td>منخفضة ومستقرة</td></tr>
...
<h3 id="MMap-vs-Tiered-Storage-Which-One-Should-You-Use" class="common-anchor-header">MMap مقابل التخزين المتدرج: أيهما يجب أن تستخدم؟</h3><table>
<thead>
...
<h3 id="Compaction-Reclaim-Storage-from-Deleted-Data" class="common-anchor-header">الضغط: استعادة التخزين من البيانات المحذوفة</h3><p>الضغط هو عملية الخلفية في ميلفوس للتنظيف. فهو يدمج المقاطع الصغيرة، ويزيل البيانات المحذوفة فعليًا، ويعيد كتابة الملفات المضغوطة. ستحتاج إلى هذا إذا</p>
<ul>
...
<li>التوصيات في الوقت الفعلي - استرداد فقط من سلوك المستخدم الأخير</li>
</ul>
...
<li><strong>قم بتقييم أبعاد التضمين</strong> - اختبر ما إذا كان النموذج الأصغر يلبي احتياجاتك من الدقة. يتطلب هذا إعادة التضمين ولكن التوفير مركب.</li>
