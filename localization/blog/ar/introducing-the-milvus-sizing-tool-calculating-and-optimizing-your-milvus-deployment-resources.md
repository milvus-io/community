...
desc: >-
  قم بتعظيم أداء Milvus الخاص بك مع أداة التحجيم سهلة الاستخدام! تعرّف على كيفية
  تهيئة عملية النشر للاستخدام الأمثل للموارد وتوفير التكاليف.
...
<li><p>أدخل المعلمات الرئيسية الخاصة بك:</p>
<ul>
...
<li><p><strong>الأفضل ل</strong>: التطبيقات المتوازنة التي يمكن فيها مقايضة بعض الاسترجاع بأداء أفضل</p></li>
...
<li><p><strong>استخدام الموارد</strong>: يقلل من استهلاك القرص، والحساب، والذاكرة بنسبة 70-75% مقارنةً ب IVF_FLAT</p></li>
<li><p><strong>الأفضل ل</strong>: البيئات المحدودة الموارد حيث يمكن أن تتأثر الدقة قليلاً</p></li>
<li><p><strong>ملاحظة فنية</strong>: يقوم بضغط قيم الفاصلة العائمة 32 بت إلى قيم صحيحة 8 بت</p></li>
</ul>
...
<p>للاطلاع على خيارات التحجيم التفصيلية للمؤسسات، قم بزيارة<a href="https://docs.zilliz.com/docs/select-zilliz-cloud-service-plans"> وثائق خطط خدمة Zilliz Cloud</a>.</p>
...
<p>نعمل باستمرار على تحسين أدواتنا ووثائقنا بناءً على ملاحظات المستخدمين. إذا كانت لديك أسئلة أو كنت بحاجة إلى مزيد من المساعدة في تحديد حجم نشر Milvus الخاص بك، تواصل مع مجتمعنا على<a href="https://github.com/milvus-io/milvus/discussions"> GitHub</a> أو<a href="https://discord.com/invite/8uyFbECzPX"> Discord</a>.</p>
