...
<custom-h1>كيفية إدارة بيانات السلسلة في Milvus 2.1؟</custom-h1><p>نحن نعلم الآن أن نوع بيانات السلسلة مفيد للغاية، ولكن متى نحتاج بالضبط إلى استخدام نوع البيانات هذا في بناء تطبيقاتنا الخاصة؟ في ما يلي، سترى بعض الأمثلة البرمجية للسيناريوهات التي قد تتضمن بيانات السلسلة، والتي ستمنحك فهمًا أفضل لكيفية إدارة بيانات VARCHAR في Milvus 2.1.</p>
<h2 id="Create-a-collection" class="common-anchor-header">إنشاء مجموعة<button data-href="#Create-a-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>دعنا نتبع المثال السابق. أنت ما زلت تعمل على نظام التوصية بالكتب وتريد إنشاء مجموعة كتب مع حقل مفتاح أساسي يسمى <code translate="no">book_name</code> ، حيث ستقوم بإدراج بيانات السلسلة. في هذه الحالة، يمكنك تعيين نوع البيانات على <code translate="no">DataType.VARCHAR</code>عند تعيين مخطط الحقل، كما هو موضح في المثال أدناه.</p>
...
<h2 id="Build-an-Index" class="common-anchor-header">إنشاء فهرس<button data-href="#Build-an-Index" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يدعم ميلفوس 2.1 إنشاء فهارس عددية، مما يسرع بشكل كبير من تصفية حقول السلسلة. على عكس بناء فهرس متجه، لا يتعين عليك إعداد معلمات قبل بناء فهرس قياسي. لا يدعم Milvus مؤقتًا سوى فهرس شجرة القاموس (MARISA-trie)، لذا فإن نوع فهرس الحقل من نوع VARCHAR هو MARISA-trie افتراضيًا.</p>
