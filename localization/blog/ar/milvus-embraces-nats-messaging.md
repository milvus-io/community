...
<h2 id="Enabling-NATS" class="common-anchor-header">تمكين NATS<button data-href="#Enabling-NATS" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يوفر Milvus 2.3 خيار تحكم جديد، <code translate="no">mq.type</code> ، والذي يسمح للمستخدمين بتحديد نوع MQ الذي يريدون استخدامه. لتمكين NATS، قم بتعيين <code translate="no">mq.type=natsmq</code>. إذا رأيت سجلات مشابهة لتلك الموجودة أدناه بعد بدء تشغيل مثيلات Milvus، فهذا يعني أنك قد قمت بتمكين NATS كقائمة انتظار للرسائل بنجاح.</p>
...
<li><p>أما بالنسبة لحزم البيانات الأكبر (&gt; 64 كيلو بايت)، يتفوق NATS على RocksMQ، حيث يقدم أوقات استجابة أسرع بكثير.</p></li>
</ul></li>
</ul>
<table>
<thead>
