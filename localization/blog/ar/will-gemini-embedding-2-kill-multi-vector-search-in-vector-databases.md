...
<tr><td>تريد بساطة خط الأنابيب <em>واسترجاع</em> دقيق التفاصيل</td><td>كلاهما - متجه Gemini الموحد + أعمدة متناثرة أو أعمدة سمات إضافية في نفس المجموعة</td><td>يتعامل Gemini مع العمود متعدد الوسائط؛ بينما يتعامل Milvus مع طبقة الاسترجاع الهجينة حوله</td></tr>
</tbody>
</table>
...
<button class="copy-code-btn"></button></code></pre>
<p>بالنسبة لتضمينات الصور والصوت، استخدم تضمين_الصورة() وتضمين_الصوت() بنفس الطريقة - حيث تهبط المتجهات في نفس المجموعة ونفس مساحة المتجهات، مما يتيح البحث الحقيقي عبر الوسائط.</p>
