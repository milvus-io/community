...
title: >-
  ما بعد =~: كيف يحوّل Milvus 3.0 التعبيرات النمطية إلى مرشح أصلي في قاعدة
  البيانات
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  ينقل Milvus 3.0 التعبيرات النمطية من المعالجة اللاحقة على جانب التطبيق إلى
  مسار الاستعلام داخل قاعدة البيانات، حيث يمكن دمجها مع البحث المتجهي، والبحث
  النصي الكامل، والمرشحات القياسية، والتنفيذ المفهرس.
