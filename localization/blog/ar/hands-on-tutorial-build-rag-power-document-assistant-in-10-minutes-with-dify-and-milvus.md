...
<p>بعد ذلك، انتقل إلى "موفر النموذج"، ومرر المؤشر على OpenAI، ثم انقر على "إعداد". سترى بعد ذلك شاشة منبثقة حيث سيُطلب منك إدخال مفتاح OpenAI API الخاص بك. بمجرد الانتهاء من ذلك، سنكون جاهزين لاستخدام النماذج من OpenAI كنموذج التضمين و LLM.</p>
<p>
  <span class="img-wrapper">
...
<li>تهيئة التوسع المناسب لملفوس (خاصة لمجموعات المستندات الأكبر حجماً)</li>
<li>تنفيذ المراقبة لمثيلات ديفاي وميلفوس الخاصة بك</li>
