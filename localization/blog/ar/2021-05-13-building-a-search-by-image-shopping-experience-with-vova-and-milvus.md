...
<p>VOVA هي منصة ناشئة للتجارة الإلكترونية تركز على القدرة على تحمل التكاليف وتقديم تجربة تسوق إيجابية لمستخدميها، مع قوائم تغطي ملايين المنتجات وتدعم 20 لغة و35 عملة رئيسية. ولتعزيز تجربة التسوق لمستخدميها، استخدمت الشركة شركة Milvus لإنشاء وظيفة البحث عن الصور في منصة التجارة الإلكترونية الخاصة بها. يستكشف المقال كيف نجحت VOVA في بناء محرك بحث عن الصور باستخدام Milvus.</p>
<p><br/></p>
...
<p>المخرجات المتوقعة من YOLO P عبارة عن موتر ثنائي الأبعاد، يكون شكله [دفعة،7 × 7 × 7 × 30]. باستخدام التقطيع، P[:,0:0:7×7×7×20] هو احتمال الفئة، P[:,7×7×7×20:7×7×(20+2)] هو الثقة، و P[:,7×7×(20+2)]:] هو النتيجة المتوقعة للمربع المحدود.</p>
...
<h3 id="VOVAs-shop-by-image-tool" class="common-anchor-header">أداة تسوق VOVA حسب الصورة</h3><p>تُظهر لقطات الشاشة أدناه أداة VOVA للبحث عن طريق التسوق بالصور على تطبيق الشركة على نظام أندرويد.</p>
<p>
