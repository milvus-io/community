...
<li>القيمة الافتراضية هي <code translate="no">None</code> ، لذلك لا معنى لها إذا قمت بتحديد القيمة الافتراضية على أنها <code translate="no">None</code>. وستؤدي القيمة الافتراضية <code translate="no">None</code> إلى إظهار <code translate="no">click.prompt</code> باستمرار إذا كنت تريد ترك قيمة فارغة للقفز فوقها.</li>
</ul>
...
<h3 id="Install-locally-for-test" class="common-anchor-header">تثبيت محلي للاختبار</h3><p>قبل أن تقوم بنشر الحزمة على PYPI، قد ترغب في تثبيتها محلياً لإجراء بعض الاختبارات.</p>
...
<li><p>سيتم إنشاء ملفين تحت الدليل <code translate="no">dist/</code>:</p></li>
</ol>
