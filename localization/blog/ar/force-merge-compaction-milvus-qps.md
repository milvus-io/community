...
title: كيف ضاعفت عملية الضغط بفرض الدمج تقريبًا معدل QPS للبحث في Milvus
author: Jack Li
date: 2026-07-1
...
desc: >-
  تُدمج ميزة Force Merge المقاطع الصغيرة المُغلقة في Milvus في عدد أقل من
  المقاطع الأكبر حجمًا. على مليون متجه مع فهرس HNSW، ارتفع معدل استعلامات البحث
  في الثانية (QPS) من نحو 3,000 إلى نحو 5,600–6,000.
