...
title: كيف ضاعفت عملية الدمج القسري للضغط تقريبًا معدل استعلامات البحث في Milvus
author: Jack Li
date: 2026-07-1
...
desc: >-
  تُوحّد ميزة Force Merge المقاطع المختومة الصغيرة في Milvus في عدد أقل من
  المقاطع الأكبر حجمًا. على 1M متجه مع فهرس HNSW، ارتفع معدل QPS للبحث من ~3,000
  إلى ~5,600–6,000.
