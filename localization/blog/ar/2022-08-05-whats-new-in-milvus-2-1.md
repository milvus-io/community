...
<custom-h1>الأداء - تعزيز أكثر من 3.2 أضعاف</custom-h1><h2 id="5ms-level-latency" class="common-anchor-header">زمن انتقال على مستوى 5 مللي ثانية<button data-href="#5ms-level-latency" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<custom-h1>جرّب البحث المتجه خارج الصندوق الآن</custom-h1><p>علاوة على ذلك، يحتوي Milvus 2.1 أيضًا على بعض التحسينات الرائعة في الاستقرار وقابلية التوسع، ونحن نتطلع إلى استخدامك وتعليقاتك.</p>
