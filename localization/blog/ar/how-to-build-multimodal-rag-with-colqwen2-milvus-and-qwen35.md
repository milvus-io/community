...
---
<p>في الوقت الحاضر، يمكنك تحميل ملف PDF إلى أي برنامج حديث من برامج LLM وطرح أسئلة حوله. بالنسبة لحفنة من المستندات، يعمل ذلك بشكل جيد. لكن معظم برامج LLMs تصل إلى بضع مئات من الصفحات، لذا فإن مجموعة كبيرة من المستندات لن تتسع ببساطة. حتى عندما يكون مناسبًا، فأنت تدفع مقابل معالجة كل صفحة في كل استعلام. اطرح مائة سؤال حول نفس مجموعة المستندات المكونة من 500 صفحة، وستدفع مقابل 500 صفحة مائة مرة. يصبح ذلك مكلفًا بسرعة.</p>
...
<p>في النهاية، سيكون لديك نظام عمل يأخذ ملف PDF وسؤالًا، ويجد الصفحات الأكثر صلة بالموضوع، ويعيد إجابة تستند إلى ما يراه النموذج.</p>
...
<tr><td>نموذج التضمين</td><td><a href="https://huggingface.co/vidore/colqwen2-v1.0-merged">colqwen2-v1.0</a></td><td>نموذج لغة الرؤية؛ يقوم بتشفير كل صفحة إلى حوالي 755 متجه رقعة 128 مليمترًا</td></tr>
...
<p>على المقايضات:</p>
<ul>
<li><strong>يتناسب التخزين مع عدد الصفحات.</strong> كل صفحة تنتج حوالي 755 ناقلًا، لذا فإن مجموعة من 1000 صفحة تعني حوالي 755000 صف في ملفوس. يعمل الفهرس المسطح المستخدم هنا للعروض التوضيحية ولكنك ستحتاج إلى IVF أو HNSW للمجموعات الأكبر.</li>
...
<p>هل لديك أسئلة، أو تريد التباهي بما قمت ببنائه؟ <a href="https://milvus.io/slack">ميلفوس سلاك</a> هو أسرع طريقة للحصول على المساعدة من المجتمع والفريق. إذا كنت تفضل إجراء محادثة فردية، يمكنك حجز وقت في <a href="https://meetings.hubspot.com/chloe-williams1/milvus-meeting">ساعات العمل</a> لدينا.</p>
