...
<p>Milvus هي قاعدة بيانات متجهة مفتوحة المصدر تتسم بالمرونة العالية والموثوقية والسرعة الفائقة. وهي تدعم إضافة المتجهات وحذفها وتحديثها والبحث عنها في الوقت الفعلي تقريباً. يحتوي Milvus على مجموعة شاملة من واجهات برمجة التطبيقات البديهية، ودعم العديد من مكتبات الفهرس المعتمدة على نطاق واسع (مثل Faiss وNMSLIB وAnnoy)، مما يبسط عملية اختيار الفهرس لسيناريو معين. يتميز برنامج Milvus بسهولة استخدامه، وقد تم استخدامه في مئات المنظمات والمؤسسات في جميع أنحاء العالم، بما في ذلك البحث عن الصور والصوت والفيديو، والتوصيات، وروبوت الدردشة، والبحث عن الأدوية الجديدة، وما إلى ذلك.</p>
