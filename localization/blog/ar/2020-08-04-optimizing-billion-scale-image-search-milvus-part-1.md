...
<h3 id="Binary-images" class="common-anchor-header">الصور الثنائية</h3><p>تكون وحدات البكسل في الصورة الثنائية إما سوداء أو بيضاء، لذا يمكن تمثيل كل بكسل بـ 0 أو 1. على سبيل المثال، تمثيل المصفوفة لصورة ثنائية 4*4 هو</p>
