...
<p>دعوني أرشدكم خلال رحلتنا وأشرح لكم سبب قيامنا بهذا التغيير، الذي قد يبدو للوهلة الأولى غير بديهي.</p>
...
<h2 id="Introducing-Woodpecker---A-Cloud-Native-High-Performance-WAL-Engine" class="common-anchor-header">تقديم نقار الخشب - محرك سحابي أصلي عالي الأداء وعالي الأداء<button data-href="#Introducing-Woodpecker---A-Cloud-Native-High-Performance-WAL-Engine" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<table>
<thead>
<tr><th><strong>النظام</strong></th><th><strong>كافكا</strong></th><th><strong>بولسار</strong></th><th><strong>WP MinIO</strong></th><th><strong>WP المحلي</strong></th><th><strong>WP S3</strong></th></tr>
</thead>
<tbody>
...
<li><p><strong>واجهة التخزين الخلفية</strong> - تدعم خدمات تخزين قابلة للتطوير ومنخفضة التكلفة مثل S3 وGCS وأنظمة الملفات مثل EFS</p></li>
