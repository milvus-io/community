...
title: >-
  لماذا بنينا Loon: محرك تخزين لبيانات الذكاء الاصطناعي التي لا تتوقف عن
  التغيّر.
author: Ted Xu
date: 2026-6-10
...
desc: >-
  يعزز Loon قدرات Milvus 3.0 بتخزين متجهات مُدار بالإصدارات لمجموعات بيانات
  الذكاء الاصطناعي المتطورة، وعمليات الملء الخلفي الفعّالة، والبحث الهجين، وسير
  العمل الأصلية لبحيرات البيانات.
origin: >-
