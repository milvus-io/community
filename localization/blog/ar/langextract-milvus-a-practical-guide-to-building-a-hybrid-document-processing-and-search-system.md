...
<h3 id="Processing-and-Vectorizing-Results" class="common-anchor-header"><strong>معالجة النتائج وتحويلها إلى ناقلات</strong></h3><p>نحتاج الآن إلى معالجة نتائج الاستخراج وإنشاء تضمينات متجهة لكل مستند. كما سنقوم أيضًا بتسوية السمات المستخرجة في حقول منفصلة لجعلها قابلة للبحث بسهولة في ملفوس.</p>
