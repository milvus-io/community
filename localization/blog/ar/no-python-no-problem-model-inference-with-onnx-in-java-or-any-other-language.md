...
<h2 id="What-is-ONNX-Open-Neural-Network-Exchange" class="common-anchor-header">ما هو ONNX (تبادل الشبكة العصبية المفتوحة)؟<button data-href="#What-is-ONNX-Open-Neural-Network-Exchange" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/onnx/onnx">ONNX</a> (التبادل المفتوح للشبكات العصبية) هو نظام بيئي لا يعتمد على منصة محددة من الأدوات اللازمة لإجراء استدلال نموذج الشبكة العصبية. وقد تم تطويره في البداية من قبل فريق PyTorch في Meta (ثم فيسبوك)، مع مساهمات أخرى من مايكروسوفت وIBM وهواوي وإنتل وAMD وArm وكوالكوم. وهو حاليًا مشروع مفتوح المصدر مملوك لمؤسسة لينكس للذكاء الاصطناعي والبيانات. ONNX هي الطريقة الفعلية لتوزيع نماذج الشبكات العصبية التي لا تعتمد على المنصات.</p>
<p>
  <span class="img-wrapper">
...
<p>نطلب من المكتبة تصدير <code translate="no">sentence-transformers/all-MiniLM-L6-v2</code> من مركز نموذج HuggingFace على شكل ONNX، مع تحديد المهمة على أنها تضمين نصي وتمكين تكميم النموذج. سيؤدي استدعاء <code translate="no">onnx_model()</code> إلى تنزيل النموذج من محور النموذج إذا لم يكن موجودًا بالفعل محليًا، وتحويل الطبقات الثلاث إلى ONNX، ودمج الرسوم البيانية الحسابية الخاصة بهم.</p>
...
<h2 id="Summary" class="common-anchor-header">الخلاصة<button data-href="#Summary" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
