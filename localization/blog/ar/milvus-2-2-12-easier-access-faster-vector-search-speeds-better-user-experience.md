...
<p>يسعدنا أن نعلن عن الإصدار الأخير من Milvus 2.2.12. يتضمن هذا التحديث العديد من الميزات الجديدة، مثل دعم واجهة برمجة تطبيقات RESTful، ووظيفة <code translate="no">json_contains</code> ، واسترجاع المتجهات أثناء عمليات البحث في الشبكة الوطنية استجابةً لتعليقات المستخدمين. كما قمنا أيضًا بتبسيط تجربة المستخدم وتحسين سرعات البحث عن المتجهات وحل العديد من المشكلات. دعونا نتعمق في ما يمكن أن نتوقعه من Milvus 2.2.12.</p>
