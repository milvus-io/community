...
<li><p>الربط في مراحل مختلفة من تنفيذ الوكيل</p></li>
</ul>
...
<h2 id="Built-in-Tools-Overview" class="common-anchor-header">نظرة عامة على الأدوات المدمجة<button data-href="#Built-in-Tools-Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يتضمن Deep Agents العديد من الأدوات المدمجة، التي يتم توفيرها من خلال البرمجيات الوسيطة. وهي تنقسم إلى ثلاث مجموعات رئيسية:</p>
