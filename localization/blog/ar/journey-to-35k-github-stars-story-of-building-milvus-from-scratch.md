...
<p><strong>ها هي المشكلة التي نعمل على حلها: لا يحتاج كل بحث متجه إلى زمن انتقال بالمللي ثانية.</strong> فالعديد من الشركات لديها مجموعات بيانات ضخمة يتم الاستعلام عنها من حين لآخر، بما في ذلك تحليل المستندات التاريخية، وحسابات التشابه على دفعات، وتحليل الاتجاهات طويلة الأجل. بالنسبة لحالات الاستخدام هذه، تكون قاعدة بيانات المتجهات التقليدية في الوقت الفعلي مبالغاً فيها ومكلفة.</p>
