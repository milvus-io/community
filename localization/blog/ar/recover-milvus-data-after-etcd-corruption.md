...
title: كيفية استعادة بيانات Milvus بعد تلف etcd دون وجود نسخة احتياطية
author: Jack Li
date: 2026-7-22
cover: >-
...
desc: >-
  تلف etcd، لا توجد نسخة احتياطية، وبيانات المصدر مفقودة؟ إليك كيف أنقذنا مجموعة
  Milvus من سجلات MinIO الثنائية باستخدام bulkInsert، وكيفية التحقق من المقاطع
  قبل الاستيراد.
