---
id: raft-or-not.md
title: طوافة أم لا؟ الحل الأمثل لاتساق البيانات في قواعد البيانات السحابية الأصلية
author: Xiaofan Luan
...
<p>ومع ذلك، فإن تصميم Milvus لم يعتمد استراتيجية التابع. بمعنى آخر، لا يستفسر Milvus عن فهرس الالتزام في كل مرة يتلقى فيها طلب استعلام. بدلاً من ذلك، تتبنى Milvus آلية مثل العلامة المائية في <a href="https://flink.apache.org/">Flink،</a> والتي تخطر عقدة الاستعلام بموقع فهرس الالتزام في فترة منتظمة. والسبب في مثل هذه الآلية هو أن مستخدمي Milvus عادةً لا يطلبون بشكل كبير اتساق البيانات، ويمكنهم قبول حل وسط في رؤية البيانات من أجل أداء أفضل للنظام.</p>
