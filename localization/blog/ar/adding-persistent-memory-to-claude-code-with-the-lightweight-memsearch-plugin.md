...
desc: >-
  امنح كلود كود ذاكرة طويلة المدى مع ميمسارش ccplugin. تخزين Markdown خفيف الوزن
...
<p>فلماذا إذن بناء مكون إضافي مخصص أصلاً؟ لأن وكلاء الترميز يصطدمون بنقطتي ألم من المؤكد أنك واجهتهما بنفسك:</p>
<ul>
...
<table>
<thead>
<tr><th>الطبقة</th><th>التكنولوجيا</th></tr>
</thead>
<tbody>
...
<p>إنه ملف واحد لكل يوم. يحتوي كل ملف على ملخصات جلسة ذلك اليوم بنص عادي يمكن قراءته بشكل كامل. إليك لقطة شاشة لملفات الذاكرة اليومية من مشروع memsearch نفسه:</p>
<p>
  <span class="img-wrapper">
...
<p>ينشئها ccplugin من خلال خط أنابيب في الخلفية يعمل بشكل غير متزامن ولا يكلف شيئًا تقريبًا. في كل مرة تقوم فيها بإيقاف استجابة Claude، يتم تشغيل خطاف <code translate="no">Stop</code>: يقوم بتحليل نص المحادثة، ويستدعي كلود هايكو (<code translate="no">claude -p --model haiku</code>) لإنشاء ملخص، ويلحقه بملف Markdown لليوم الحالي. إن مكالمات واجهة برمجة تطبيقات Haiku رخيصة للغاية، تكاد لا تذكر لكل استدعاء.</p>
