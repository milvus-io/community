...
<ul>
<li><p><strong>الاسترجاع ليس تلقائيًا.</strong> يختار النموذج متى يستدعيها. إذا كان يعتقد أن لديه بالفعل سياقًا كافيًا، فلن يزعج نفسه.</p></li>
<li><p><strong>تتضمن القطع المسترجعة</strong> <em>كلاً من</em> <strong>رسائل المستخدم والمساعد.</strong> هذا مفيد - فهو يحافظ على فارق بسيط أكثر من ملخصات المستخدم فقط.</p></li>
...
<p>يظهر الاختلاف الأكبر عن Claude في كيفية تعامل ChatGPT مع المحادثات "الحديثة وليس الحالية". سيتصل كلود بأداة بحث لاسترداد السياق السابق إذا كان يعتقد أنه ذو صلة. لا يقوم ChatGPT بذلك.</p>
...
<li><p><strong>لا</strong> يقوم <strong>بحساب التضمين ولا ترتيب التشابه، ولا يقوم باستدعاء الاسترجاع</strong>. إنه في الأساس سياق تم مضغه مسبقًا، وليس بحثًا ديناميكيًا.</p></li>
</ul>
...
<li><p><strong>قائم على النوع</strong>: بعض الأشياء أكثر أهمية بطبيعتها (على سبيل المثال، ملفات تكوين المشروع مقابل ملفات ذاكرة التخزين المؤقت)</p></li>
</ul>
...
<p>ومع استمرار نضج الوكلاء طويل الأمد، من المرجح أن تتقارب بنيتهم مع هذا التصميم الهجين. يعد Cowork إشارة قوية إلى أين تتجه الأمور - ليس نحو عالم بدون RAG، ولكن نحو وكلاء مع مكدسات ذاكرة أكثر ثراءً مدعومة بقواعد بيانات متجهة تحتها.</p>
