...
<h2 id="Fusion-Recommendation-Model" class="common-anchor-header">نموذج توصية الاندماج<button data-href="#Fusion-Recommendation-Model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>استخدمنا في نظام التوصية المخصص للأفلام نموذج التوصية الاندماجية [3] الذي طبقه PaddlePaddle. تم إنشاء هذا النموذج من ممارسته الصناعية.</p>
...
<li>وفقًا لعمر المستخدم/جنس المستخدم/المهنة المحددة من قبل المعلمات، يتم تحويلها إلى متجه ميزات المستخدم، ويتم استخدام milvus.search_vectors لاسترجاع التشابه، ويتم إرجاع النتيجة ذات التشابه الأعلى بين المستخدم والفيلم.</li>
</ul>
