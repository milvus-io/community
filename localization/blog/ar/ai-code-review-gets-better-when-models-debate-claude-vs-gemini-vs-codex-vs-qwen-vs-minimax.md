...
---
<p>لقد استخدمت مؤخرًا نماذج الذكاء الاصطناعي لمراجعة طلب سحب، وكانت النتائج متناقضة: أشار كلود إلى وجود سباق بيانات، بينما قال جيميني إن الكود نظيف. أثار هذا الأمر فضولي لمعرفة كيف ستتصرف نماذج الذكاء الاصطناعي الأخرى، لذا قمتُ بتشغيل أحدث النماذج الرئيسية من Claude وGemini وCodx وQwen وMiniMax من خلال معيار منظم لمراجعة الشيفرة. والنتائج؟ اكتشف النموذج الأفضل أداءً 53% فقط من الأخطاء المعروفة.</p>
<p>ومع ذلك، لم ينتهِ فضولي عند هذا الحد: ماذا لو عملت نماذج الذكاء الاصطناعي هذه معًا؟ لقد جربت أن أجعلهم يتناقشون مع بعضهم البعض، وبعد خمس جولات من المناظرات العدائية، قفزت نسبة اكتشاف الأخطاء إلى 80%. أما أصعب الأخطاء التي تتطلب فهماً على مستوى النظام، فقد وصلت نسبة اكتشافها في وضع المناظرة إلى 100%.</p>
...
<h2 id="Benchmarking-Claude-Gemini-Codex-Qwen-and-MiniMax-for-code-review" class="common-anchor-header">قياس أداء كلود وجيميني وكودكس وكيوين وميني ماكس لمراجعة التعليمات البرمجية<button data-href="#Benchmarking-Claude-Gemini-Codex-Qwen-and-MiniMax-for-code-review" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p><strong>R1:</strong> يقوم Magpie بسحب السياق المحيط (الملفات ذات الصلة / مواقع الاستدعاء / الكود ذي الصلة) <em>قبل</em> مراجعة النموذج. هذا يحاكي سير العمل حيث تقوم بإعداد السياق مقدمًا بدلًا من أن تطلب من النموذج تخمين ما يحتاجه.</p></li>
</ul>
...
<p>أربع نتائج</p>
<p><strong>1. يهيمن كلود على المراجعة الأولية.</strong> فقد حصل على 53% في الاكتشاف الإجمالي و5/5 في أخطاء L3، دون أي مساعدة في السياق. إذا كنت تستخدم نموذجًا واحدًا ولا تريد قضاء الوقت في إعداد السياق، فإن Claude هو الخيار الأفضل.</p>
...
<p><a href="https://github.com/milvus-io/milvus/pull/44474"><strong>PR #44474:</strong></a> تحسين التحميل البطيء الذي غيّر البحث لجلب المفاتيح الأساسية عند الطلب بدلاً من تحميلها كلها مقدمًا.</p>
...
<h2 id="Which-Combination-of-Models-Can-Find-the-Most-Bugs" class="common-anchor-header">أي مجموعة من النماذج يمكنها العثور على أكبر عدد من الأخطاء؟<button data-href="#Which-Combination-of-Models-Can-Find-the-Most-Bugs" class="anchor-icon" translate="no">
    ...
    </button></h2><p>حدثت القفزة من 53% إلى 80% لأن النماذج الخمسة غطت النقاط العمياء لبعضها البعض. ولكن لا يمكن للجميع تحمل تكلفة إعداد وتشغيل خمسة نماذج خلال خمس جولات من المناقشة لكل مراجعة برمجية.</p>
...
<p>ما يهم إذن ليس فقط عدد الأخطاء التي يعثر عليها كل نموذج، بل الأخطاء <em>التي</em> يفوتها. من بين الأخطاء الثمانية التي فاتت كلاود 8 أخطاء، اكتشف الجوزاء 3 أخطاء: حالة سباق التزامن، ومشكلة توافق واجهة برمجة تطبيقات التخزين السحابي، وفقدان التحقق من الأذونات. وبالانتقال إلى الاتجاه الآخر، فاتت Gemini معظم أخطاء هياكل البيانات والأخطاء المنطقية العميقة، بينما اكتشف Claude جميع هذه الأخطاء تقريبًا. نقاط ضعفهما بالكاد تتداخل، وهو ما يجعلهما ثنائيًا قويًا.</p>
<table>
<thead>
...
<p>أغفل كل نموذج أربعة أخطاء. أحدها يتعلق بأولوية قواعد ANTLR النحوية. كان أحدها عدم تطابق دلالات قفل القراءة/الكتابة عبر الدوال. تطلب أحدها فهم الاختلافات في منطق العمل بين أنواع الضغط. وواحد كان خطأ مقارنة صامتًا حيث استخدم متغير واحد ميغابايت وآخر بايت.</p>
...
<p>لقياس ذلك، أضفت جولة تقييم الأقران بعد المناظرة. افتتح كل نموذج جلسة جديدة وقام بدور الحكم المجهول، حيث قام كل نموذج بتقييم تقييمات النماذج الأخرى. تم تعيين النماذج الخمسة بشكل عشوائي إلى المراجع أ/ب/ج/د/هـ/هـ، لذا لم يعرف أي قاضٍ أي نموذج أنتج أي مراجعة. قام كل محكم بتسجيل النقاط على أربعة أبعاد، تم تقييمها من 1 إلى 10: الدقة والقدرة على العمل والعمق والوضوح.</p>
<table>
<thead>
...
<p><strong>حجم العينة صغير.</strong> لا يوجد سوى 15 من العلاقات العامة، وكلها من نفس مشروع Go/C+++G (Milvus). لا يمكن تعميم هذه النتائج على جميع اللغات أو قواعد الشفرات. تعامل معها على أنها اتجاهية وليست نهائية.</p>
...
<li><p><a href="https://milvus.io/blog/adding-persistent-memory-to-claude-code-with-the-lightweight-memsearch-plugin.md">إضافة ذاكرة ثابتة إلى شيفرة كلود مع ملحق memsearch خفيف الوزن</a></p></li>
