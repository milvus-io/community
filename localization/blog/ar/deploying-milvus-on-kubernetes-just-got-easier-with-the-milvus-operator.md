...
<p>يقوم المشغّل بتغليف معرفة إدارة Milvus في التعليمات البرمجية الخاصة به. وهذا يعني أنه يمكن للفرق إدارة المجموعات بفعالية دون أن يصبحوا خبراء في كل مكون. تظل الواجهة التشغيلية متسقة مع توسع بنيتك التحتية.</p>
...
<p>بشكل افتراضي، تكون خدمة Milvus التي ينشرها المشغل من النوع <code translate="no">ClusterIP</code> ، مما يعني أنه لا يمكن الوصول إليها إلا داخل الكتلة. لفضحها خارجيًا، يجب عليك تحديد طريقة وصول خارجية. يختار هذا الدليل أبسط طريقة: استخدام منفذ NodePort.</p>
