...
<li><strong>"ضمن 3 كم" يحتاج إلى تصفية مكانية.</strong> يجب أن تقتصر النتائج على "في نطاق 3 كم من المستخدم"، أو في بعض الأحيان "داخل مضلع توصيل معين أو حدود إدارية محددة".</li>
</ul>
<p>في البنية التقليدية، كانت تلبية كلا الحاجتين تعني عادةً تشغيل نظامين جنبًا إلى جنب:</p>
<ul>
<li><strong>PostGIS / Elasticsearch</strong> لتحديد المواقع الجغرافية وحسابات المسافة والتصفية المكانية.</li>
...
<h2 id="Getting-Started-GEOMETRY-with-the-Python-SDK" class="common-anchor-header">الشروع في العمل: GEOMETRY مع مجموعة أدوات تطوير البرمجيات Python SDK<button data-href="#Getting-Started-GEOMETRY-with-the-Python-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Run-a-Hybrid-Spatial-Vector-Query-Example" class="common-anchor-header">تشغيل استعلام مكاني-متجه هجين (مثال)</h3><p><strong>السيناريو:</strong> ابحث عن أفضل 3 نقاط مهمة الأكثر تشابهًا في الفضاء المتجه وتقع في نطاق 2 كيلومتر من نقطة معينة، مثل موقع المستخدم.</p>
