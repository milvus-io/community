...
<li><p><strong>استرجاع الرموز:</strong> يحقق <em>Qwen3-Embedding</em> نتائج من الدرجة الأولى (81.0+) على <em>كود MTEB-Code،</em> وهو مُحسَّن للاستعلامات المتعلقة بالبرمجة.</p></li>
</ul>
<p>إذا كانت حالة الاستخدام الخاصة بك تندرج ضمن أحد هذه المجالات، يمكن للنماذج المحسّنة للمجال تحسين دقة الاسترجاع بشكل كبير. لكن بالنسبة للتطبيقات الأوسع نطاقًا، التزم بنماذج الأغراض العامة ما لم تُظهر اختباراتك خلاف ذلك.</p>
...
<ol>
<li><p><strong>التدريب المسبق</strong> على البيانات الضخمة غير الموسومة باستخدام <em>RetroMAE</em> (أداة تشفير مقنعة + أداة فك تشفير إعادة البناء) لبناء فهم دلالي عام.</p></li>
<li><p><strong>الضبط العام</strong> باستخدام التعلّم التبايني على 100 مليون زوج من النصوص، مما يعزز أداء الاسترجاع.</p></li>
<li><p><strong>الضبط الدقيق للمهام</strong> باستخدام ضبط التعليمات وأخذ عينات سلبية معقدة لتحسين السيناريو الخاص بالسيناريو.</p></li>
</ol>
