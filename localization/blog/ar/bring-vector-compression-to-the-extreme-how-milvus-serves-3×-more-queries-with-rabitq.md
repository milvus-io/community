...
<p>الإجابة هي <strong>نعم،</strong> وفي هذه المدونة، سنوضح لك كيف أن تطبيق تقنية جديدة تسمى <a href="https://dl.acm.org/doi/pdf/10.1145/3654970"><strong>RaBitQ</strong></a> تمكّن شركة Milvus من خدمة حركة مرور أكثر بمقدار 3 أضعاف بتكلفة ذاكرة أقل مع الحفاظ على دقة مماثلة. سنشارك أيضًا الدروس العملية المستفادة من دمج تقنية RaBitQ في Milvus مفتوحة المصدر وخدمة Milvus المدارة بالكامل على <a href="https://zilliz.com/cloud">Zilliz Cloud</a>.</p>
<p>
...
<p>فيما يلي بعض التفاصيل منخفضة المستوى حول مقابض التكوين لـ IVF و RaBitQ وعملية التنقية:</p>
<ul>
