...
<p><em>الشكل: ضغط المتجه من خلال إيجاد أقرب تقريب له على المكعب الزائد، بحيث يمكن تمثيل كل بُعد بت واحد فقط. (مصدر الصورة:</em> <a href="https://dev.to/gaoj0017/quantization-in-the-counterintuitive-high-dimensional-space-4feg"><em>التكميم الكمي في الفضاء عالي الأبعاد المضاد</em></a><em>)</em></p>
...
<p>استخدمنا اختبار أداء البحث من vdb-bench، مع مجموعة بيانات مكونة من مليون متجه، كل منها ذو 768 بُعدًا. بما أن حجم المقطع الافتراضي في Milvus هو 1 جيجابايت، وبما أن حجم المقطع الافتراضي في Milvus هو 1 جيجابايت، ومجموعة البيانات الأولية (768 بُعدًا × 1 مليون متجه × 4 بايت لكل عوامة) يبلغ إجماليها 3 جيجابايت تقريبًا، فقد تضمن القياس عدة مقاطع لكل قاعدة بيانات.</p>
<p>
  <span class="img-wrapper">
...
<p>نحن ملتزمون بجلب المزيد من الابتكارات من هذا القبيل إلى كلٍ من Milvus مفتوح المصدر وخدمته المدارة بالكامل على Zilliz Cloud، مما يجعل البحث المتجه أكثر كفاءة ومتاحة للجميع.</p>
