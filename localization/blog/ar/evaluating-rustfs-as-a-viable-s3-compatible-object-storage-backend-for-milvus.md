...
<p>على هذه الخلفية، تستكشف هذه المقالة <a href="https://github.com/rustfs/rustfs">نظام RustFS</a> كبديل محتمل. RustFS هو نظام تخزين كائنات متوافق مع S3 قائم على Rust ومتوافق مع S3 ويركز على سلامة الذاكرة وتصميم الأنظمة الحديثة. لا يزال تجريبيًا، وهذه المناقشة ليست توصية إنتاج.</p>
<h2 id="The-Milvus-Architecture-and-Where-the-Object-Storage-Component-Sits" class="common-anchor-header">بنية ميلفوس ومكان وجود مكوّن تخزين الكائنات<button data-href="#The-Milvus-Architecture-and-Where-the-Object-Storage-Component-Sits" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
