...
<p>يستخدم PinSage الرسوم البيانية ثنائية الأجزاء للوحات الدبابيس لتوليد تضمينات عالية الجودة من الدبابيس التي تُستخدم للتوصية بمحتوى متشابه بصرياً للمستخدمين. على عكس خوارزميات GCN التقليدية، التي تقوم بإجراء التلافيف على مصفوفات السمات والرسم البياني الكامل، يقوم PinSage بأخذ عينات من العقد/الدبابيس القريبة ويقوم بإجراء تلافيف محلية أكثر كفاءة من خلال البناء الديناميكي للرسوم البيانية الحسابية.</p>
...
<h3 id="Milvus-An-open-source-vector-database-built-for-AI-and-similarity-search" class="common-anchor-header">ميلفوس: قاعدة بيانات متجهة مفتوحة المصدر مصممة للذكاء الاصطناعي والبحث عن التشابه</h3><p>
...
<h3 id="Step-4-Conduct-vector-similarity-search" class="common-anchor-header">الخطوة 4: إجراء بحث التشابه المتجهي</h3><p>احصل على التضمينات المقابلة في Milvus بناءً على معرّفات الأفلام، ثم استخدم Milvus لإجراء بحث التشابه مع هذه التضمينات. بعد ذلك، حدد معلومات الفيلم المقابلة في قاعدة بيانات MySQL.</p>
