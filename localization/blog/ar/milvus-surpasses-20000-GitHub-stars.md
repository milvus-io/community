...
<h2 id="Six-LLM-projects-that-utilize-Milvus" class="common-anchor-header">ستة مشاريع LLM التي تستخدم ميلفوس<button data-href="#Six-LLM-projects-that-utilize-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="PaperGPT" class="common-anchor-header">PaperGPT</h3><p><a href="http://papergpt.bio">PaperGPT</a> عبارة عن أداة بحث عن الأوراق الطبية الحيوية مدعومة بقاعدة بيانات LLM وقاعدة بيانات المتجهات. وهي تستفيد من قاعدة بيانات PubMed وتقنيات مثل SentenceTransformers و Zilliz Cloud للبحث الفعال.</p>
...
<h3 id="Searchanythingio" class="common-anchor-header">Search.anything.io</h3><p>يعمل تطبيق<a href="http://search.anything.io">Search Anything</a> على الاستفادة من LLMs وMilvus لتوفير تجربة بحث أفضل. فهو يأخذ وصفاً نصياً من المستخدم ويعثر على الصور المقابلة على الويب.</p>
...
<h3 id="Haystack" class="common-anchor-header">هايستاك</h3><p><a href="https://github.com/deepset-ai/haystack">Haystack</a> هو إطار عمل شامل في البرمجة اللغوية العصبية لبناء تطبيقات البرمجة اللغوية العصبية المدعوم من LLMs، ونماذج المحولات، والبحث المتجه، وتقنيات أخرى لمهام مثل الإجابة عن الأسئلة، والبحث الدلالي عن المستندات، وبناء عملية صنع القرار المعقدة.</p>
<h3 id="GPTCache" class="common-anchor-header">ذاكرة تخزين GPTCache</h3><p>يمكن أن تكون مكالمات واجهة برمجة تطبيقات LLM مكلفة وبطيئة. يمكن أن تعالج <a href="https://github.com/zilliztech/gptcache">GPTCache</a> كلتا المشكلتين من خلال توفير ذاكرة تخزين مؤقت دلالي لاستعلامات LLM.</p>
