...
<p>يفصل هذا المنشور ما تقوم به المهارات بشكل جيد، وأين لا يزال MCP مهمًا، وكيف يتناسب كلاهما مع بنية الوكيل المتطورة في أنثروبيك. ثم سنستعرض كيفية بناء مهاراتك الخاصة التي تتكامل بشكل نظيف مع ميلفوس.</p>
...
<li><p>التوصيل ببيئات التطوير (الملفات المحلية، IDEs، التحكم في الإصدار)</p></li>
...
<p>توفر MCP الإمكانيات، بينما تحدد المهارات العملية. يشكلان معًا ثنائيًا متكاملًا.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>ملاحظة:</strong> بعد اكتمال التكوين، يمكنك استخدام المهارات على الفور للاستعلام عن قاعدة كود ميلفوس.</p>
