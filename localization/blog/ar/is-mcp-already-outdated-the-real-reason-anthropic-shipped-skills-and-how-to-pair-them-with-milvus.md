...
<p>تكمن المشكلة في بنية موجه النظام. إنها حقنة ثابتة لمرة واحدة تتنافس على مساحة في نافذة سياق النموذج، إلى جانب تاريخ المحادثة والمستندات وأي مدخلات أخرى. ومع امتلاء نافذة السياق، يصبح انتباه النموذج إلى موجه النظام مخففًا بشكل متزايد، مما يؤدي إلى فقدان الاتساق مع مرور الوقت.</p>
...
<p>عندما يبدأ Claude مهمة، يقوم أولاً بإجراء مسح خفيف الوزن لجميع المهارات المتاحة من خلال قراءة البيانات الوصفية YAML الخاصة بها فقط (بضع عشرات من الرموز المميزة). توفر هذه البيانات الوصفية معلومات كافية فقط لكلود لتحديد ما إذا كانت المهارة ذات صلة بالمهمة الحالية. إذا كان الأمر كذلك، يتوسع كلود في مجموعة كاملة من التعليمات (عادةً أقل من 5 آلاف رمز)، ولا يتم تحميل موارد أو نصوص إضافية إلا إذا لزم الأمر.</p>
...
<h2 id="How-Skills-Compares-to-Prompts-Projects-MCP-and-Subagents" class="common-anchor-header">كيف تقارن المهارات بالموجهات، والمشاريع، وبرنامج إدارة النماذج، والوكلاء الفرعيين<button data-href="#How-Skills-Compares-to-Prompts-Projects-MCP-and-Subagents" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكن أن يبدو مشهد أدوات النماذج اليوم مزدحمًا. حتى داخل النظام البيئي للوكلاء في كلود وحده، هناك العديد من المكونات المتميزة: المهارات، والمطالبات، والمشاريع، والمشاريع، والوكلاء الفرعيين، و MCP.</p>
...
<h3 id="1-Skills" class="common-anchor-header">1. المهارات</h3><p>المهارات هي مجلدات تحتوي على تعليمات ونصوص وموارد. يكتشفها كلود ويقوم بتحميلها ديناميكيًا باستخدام الكشف التدريجي: البيانات الوصفية أولًا، ثم التعليمات الكاملة، وأخيرًا أي ملفات مطلوبة.</p>
