...
title: 'لقطات Milvus: عروض للمجموعات في نقطة زمنية محددة دون نسخ البيانات'
author: Leo Liu
date: 2026-7-30
...
desc: >-
  تُجمّد لقطات Milvus مجموعةً عبر تسجيل مراجع الملفات بدلًا من نسخ البيانات —
  نقاط استرداد منخفضة التكلفة، واستعادة دون إعادة بناء الفهرس، ومدخلات مستقرة لـ
  Spark.
