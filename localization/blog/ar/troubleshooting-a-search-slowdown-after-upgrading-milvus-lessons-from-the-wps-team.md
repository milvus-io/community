...
<h2 id="Upgrading-With-Helm-Chart" class="common-anchor-header">الترقية باستخدام مخطط هيلم<button data-href="#Upgrading-With-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h2><p>إن الانتقال إلى ثلاثة إصدارات رئيسية (2.2 → 2.5) مع عشرات الملايين من المتجهات جعل الترقية الموضعية محفوفة بالمخاطر. قمنا ببناء مجموعة جديدة بدلاً من ذلك وقمنا بترحيل البيانات إليها. وبقيت المجموعة القديمة متصلة بالإنترنت من أجل التراجع.</p>
...
<li><p><strong>عدد عُقد الاستعلام:</strong> أبقيناها عند <strong>16،</strong> كما في المجموعة القديمة</p></li>
...
<li><p><strong>حافظ على تشغيل كلا المجموعتين أثناء التحويل.</strong> قم بتحويل حركة المرور تدريجيًا ولا تقم بإيقاف تشغيل المجموعة القديمة إلا بعد التحقق الكامل.</p></li>
</ul>
...
<table>
<thead>
<tr><th>المكوّن</th><th>استخدام وحدة المعالجة المركزية (النوى)</th><th>التحليل</th></tr>
</thead>
<tbody>
...
<p>بدت المجموعة الجديدة مختلفة تمامًا. كانت تحتوي على 21 مقطعًا (60% أكثر)، مع تفاوت في حجم المقطع: بعضها كان يحتوي على حوالي 685 ألف صف، والبعض الآخر بالكاد 350 ألفًا. كانت الاستعادة قد بعثرت البيانات بشكل غير متساوٍ.</p>
...
<p>ولكن في استعادتنا عبر الإصدار المتقاطع (2.2 → 2.5)، قام منطق الإصدار 2 بإعادة بناء المقاطع بشكل مختلف عن المجموعة الأصلية: فقد قام بتقسيم المقاطع الكبيرة إلى مقاطع أصغر حجمًا وغير متساوية. بمجرد التحميل، علقت بعض عُقد الاستعلام ببيانات أكثر من غيرها.</p>
<p>أضر هذا بالأداء بثلاث طرق:</p>
<ul>
<li><p><strong>العقد الساخنة:</strong> كان على عقد الاستعلام ذات المقاطع الأكبر أو الأكثر القيام بمزيد من العمل</p></li>
...
<h3 id="Improve-Segment-Monitoring" class="common-anchor-header">تحسين مراقبة الشرائح</h3><p>لا يعرض Milvus عدد المقاطع أو توزيع الصفوف أو توزيع الحجم لكل مجموعة في لوحات معلومات Grafana القياسية. كان علينا أن نبحث يدويًا من خلال <a href="https://github.com/zilliztech/attu">Attu</a> و etcd، وهو ما كان بطيئًا.</p>
...
<ul>
<li><p><strong>مراقب الطيور:</strong> يمكنه قراءة البيانات الوصفية Etcd مباشرة وإظهار تخطيط المقطع وتعيين القناة</p></li>
...
<tbody>
<tr><td>النسخ الاحتياطي</td><td>إنشاء النسخ الاحتياطي ميلفوس النسخ الاحتياطي</td><td>يتم دعم النسخ الاحتياطي الساخن، ولكن يجب التحقق من النسخة الاحتياطية بعناية</td></tr>
...
<tr><td>الترحيل</td><td>استعادة النسخ الاحتياطي ميلفوس النسخ الاحتياطي</td><td>كن حذرًا مع --استخدام_v2_استعادة. في استعادة الإصدارات المتقاطعة، لا تستخدم منطقًا غير افتراضي إلا إذا كنت تفهمه بوضوح</td></tr>
