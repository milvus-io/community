...
<li><p>يتم سحب البيانات إلى العُقد المحلية <strong>فقط عندما يحتاجها الاستعلام فعليًا</strong></p></li>
</ul>
<p>
...
<p>ومع ذلك، في أعباء العمل التي تكون فيها 80% أو أكثر من البيانات موجودة في الذيل الطويل، تظهر عيوب التحميل الكامل بسرعة، سواء من حيث <strong>الأداء</strong> أو <strong>التكلفة</strong>.</p>
...
<p><strong>كيف يعمل التحميل البطيء في Milvus 2.6 والإصدارات الأحدث</strong></p>
<p>
  <span class="img-wrapper">
...
<p>ينطبق التحميل الجزئي أيضًا على <strong>الحقول العدد</strong>ية، مما يسمح ل Milvus بتحميل الأعمدة المشار إليها صراحةً في الاستعلام فقط.</p>
...
<li><p>في <strong>Milvus 2.6+،</strong> يتم تحميل الحقول الثلاثة المطلوبة فقط. تظل الحقول الـ 47 المتبقية غير محملة ويتم جلبها بشكل كسول فقط إذا تم الوصول إليها لاحقًا.</p></li>
</ul>
...
<table>
<thead>
<tr><th style="text-align:center"><strong>نوع طلب البحث</strong></th><th style="text-align:center"><strong>زمن استجابة Milvus 2.5 P99</strong></th><th style="text-align:center"><strong>زمن انتقال P99 + P99 من Milvus 2.6</strong></th><th style="text-align:center"><strong>التغيير</strong></th></tr>
</thead>
<tbody>
<tr><td style="text-align:center">عمليات البحث عن البيانات الساخنة</td><td style="text-align:center">15 مللي ثانية</td><td style="text-align:center">16 مللي ثانية</td><td style="text-align:center">+6.7%</td></tr>
<tr><td style="text-align:center">عمليات البحث عن البيانات الساخنة</td><td style="text-align:center">15 مللي ثانية</td><td style="text-align:center">28 مللي ثانية</td><td style="text-align:center">+86%</td></tr>
<tr><td style="text-align:center">عمليات البحث عن البيانات الباردة (الوصول الأول)</td><td style="text-align:center">15 مللي ثانية</td><td style="text-align:center">120 مللي ثانية</td><td style="text-align:center">+700%</td></tr>
<tr><td style="text-align:center">عمليات البحث عن البيانات الباردة (تخزين مؤقت)</td><td style="text-align:center">15 مللي ثانية</td><td style="text-align:center">18 مللي ثانية</td><td style="text-align:center">+20%</td></tr>
</tbody>
</table>
<blockquote>
<p><em>يشير مصطلح "الاستعلام" هنا إلى طلبات البحث المتجهة، وليس إلى واجهة برمجة تطبيقات Milvus <code translate="no">query()</code>.</em></p>
</blockquote>
<p>بالنسبة للبيانات الساخنة، والتي تمثل ما يقرب من 80% من جميع الاستعلامات، يزيد زمن انتقال P99 بنسبة 6.7% فقط، مما يؤدي إلى عدم وجود تأثير ملموس في الإنتاج.</p>
<p>تُظهر استعلامات البيانات الباردة وقت استجابة أعلى عند الوصول الأول بسبب التحميل عند الطلب من تخزين الكائنات. ومع ذلك، بمجرد تخزينها مؤقتًا، يزيد زمن وصولها بنسبة 20% فقط. نظرًا لانخفاض تكرار الوصول إلى البيانات الباردة، فإن هذه المفاضلة مقبولة بشكل عام لمعظم أعباء العمل في العالم الحقيقي.</p>
...
<p>باستخدام مجموعة بيانات متجهية بسعة 2 تيرابايت في بيئة AWS كمثال، وبافتراض أن 20% من البيانات ساخنة (400 جيجابايت)، تكون مقارنة التكلفة على النحو التالي:</p>
<table>
<thead>
...
<li><p><strong>الفوائد المتوقعة:</strong> تخفيض التكلفة بنسبة 50-70%؛ قد تتكبد البيانات الباردة زمن وصول يصل إلى 500 مللي ثانية تقريبًا عند أول وصول، وهو ما يجب تقييمه مقابل متطلبات اتفاقية مستوى الخدمة.</p></li>
</ul>
...
<li><p><a href="https://milvus.io/blog/introducing-aisaq-in-milvus-billion-scale-vector-search-got-3200-cheaper-on-memory.md">تقديم AISAQ في Milvus: أصبح البحث في المتجهات بمليارات النطاقات أرخص ب 3,200 مرة على الذاكرة</a></p></li>
