...
<p><strong>فهارس المتجهات: التحميل المدرك للمستأجر</strong></p>
...
<table>
<thead>
<tr><th style="text-align:center"><strong>نوع طلب البحث</strong></th><th style="text-align:center"><strong>زمن استجابة Milvus 2.5 P99</strong></th><th style="text-align:center"><strong>زمن انتقال P99 + P99 في Milvus 2.6</strong></th><th style="text-align:center"><strong>التغيير</strong></th></tr>
</thead>
<tbody>
...
<h2 id="When-to-Use-Tiered-Storage-in-Milvus" class="common-anchor-header">متى تستخدم التخزين المتدرج في ميلفوس<button data-href="#When-to-Use-Tiered-Storage-in-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p><strong>لماذا غير مناسب:</strong> حتى الاختلافات الصغيرة في وقت الاستجابة غير مقبولة؛ يوفر التحميل الكامل أداءً أكثر قابلية للتنبؤ به</p></li>
</ul>
