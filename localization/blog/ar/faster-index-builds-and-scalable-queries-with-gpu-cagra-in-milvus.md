...
<p>أُجريت التجارب على أجهزة معتمدة على نطاق واسع ومتوافقة مع معايير الصناعة لضمان أن تظل النتائج موثوقة وقابلة للتطبيق على نطاق واسع.</p>
<ul>
...
<li><p><strong>يزداد وقت البناء خطيًا مع تكرار NN-Descent.</strong> ومع ارتفاع عدد مرات التكرار، يزداد وقت البناء بطريقة شبه خطية، مما يعكس طبيعة التنقيح التكراري ل NN-Descent ويوفر مفاضلة يمكن التنبؤ بها بين تكلفة البناء وجودة الرسم البياني.</p></li>
</ul>
