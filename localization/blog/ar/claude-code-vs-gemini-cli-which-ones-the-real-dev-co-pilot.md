...
<li><p>حافظ على الوعي الأمني من خلال مراجعة سياسات جمع البيانات وتوخي الحذر مع التعليمات البرمجية الحساسة</p></li>
</ul>
<h3 id="Gemini-CLI-Setup-and-Best-Practices" class="common-anchor-header">إعداد واجهة برمجة Gemini CLI وأفضل الممارسات</h3><p><strong>التثبيت:</strong> مثل كود Claude Code، يتطلب Gemini CLI الإصدار 18 أو أعلى من Npm و Node.js.</p>
