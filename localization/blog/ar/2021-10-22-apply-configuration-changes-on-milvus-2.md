...
<p>بمجرد تعديل ملف milvus <strong>.yaml،</strong> ستحتاج أيضًا إلى <a href="https://github.com/milvus-io/milvus/blob/master/deployments/docker/standalone/docker-compose.yml">تنزيل</a> وتعديل ملف <strong>docker-compose.yaml</strong> لملف مستقل عن طريق تعيين المسار المحلي لملف milvus.yaml إلى مسار حاوية docker المقابل لملف التكوين <code translate="no">/milvus/configs/milvus.yaml</code> ضمن قسم <code translate="no">volumes</code>.</p>
<p>
