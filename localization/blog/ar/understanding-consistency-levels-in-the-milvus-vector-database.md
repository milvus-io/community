...
desc: >-
  تعرّف على مستويات الاتساق الأربعة - القوة، والثبات المحدود، والجلسة، والنهائي
  المدعوم في قاعدة بيانات Milvus vector.
