...
<p>تتم مقارنة متجهات السمات المستخرجة مع متجهات المكتبة، ويتم إرجاع المعلومات المقابلة للمتجهات الأكثر تشابهًا. يمثل الحساب تحديًا كبيرًا بالنسبة لمجموعات بيانات متجهات السمات واسعة النطاق. يقدّم هذا الموضوع كيفية تحليل متجهات السمات باستخدام ميلفوس.</p>
...
<p>كقاعدة بيانات متجهة مفتوحة المصدر، تدعم Milvus متجهات الميزات المستخرجة باستخدام نماذج مختلفة للتعلم العميق. مدمجًا مع مكتبات مثل Faiss وNMSLIB وAnnoy، يوفر Milvus مجموعة من واجهات برمجة التطبيقات البديهية، التي تدعم تبديل أنواع الفهرس وفقًا للسيناريوهات. بالإضافة إلى ذلك، تدعم Milvus التصفية القياسية، مما يزيد من معدل الاستدعاء ومرونة البحث. وقد تم تطبيق Milvus في العديد من المجالات مثل معالجة الصور، والرؤية الحاسوبية، ومعالجة اللغات الطبيعية، والتعرف على الكلام، ونظام التوصية، واكتشاف الأدوية الجديدة.</p>
...
<p>[3] R. Boia, C. Florea, L. Florea, R. Dogaru. "توطين الشعار والتعرف على الشعارات في الصور الطبيعية باستخدام الرسوم البيانية للفئات المتجانسة." رؤية الآلة وتطبيقاتها 27 (2), 2016. https://link.springer.com/article/10.1007/s00138-015-0741-7</p>
