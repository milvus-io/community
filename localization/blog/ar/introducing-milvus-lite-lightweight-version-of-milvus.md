...
<button class="copy-code-btn"></button></code></pre>
<p>جميع العناصر القابلة للتكوين موجودة في القالب <code translate="no">config.yaml</code> الذي يتم شحنه مع حزمة ميلفوس.</p>
