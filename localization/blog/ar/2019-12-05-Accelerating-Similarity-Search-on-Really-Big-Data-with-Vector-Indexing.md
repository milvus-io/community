...
<h4 id="IVFFLAT-performance-test-results" class="common-anchor-header">نتائج اختبار أداء IVF_FLAT:</h4><p>تم إجراء اختبار أداء وقت الاستعلام IVF_FLAT في Milvus باستخدام مجموعة بيانات SIFT العامة 1B SIFT، والتي تحتوي على مليار متجه 128 بُعدًا.</p>
<p>
...
<p>تم إجراء اختبار أداء الاستدعاء IVF_FLAT في Milvus باستخدام كل من مجموعة بيانات SIFT العامة 1M SIFT، والتي تحتوي على مليون متجه 128 بُعدًا، ومجموعة بيانات glove-200-angular، والتي تحتوي على أكثر من مليون متجه 200 بُعد، لبناء الفهرس (nq = 16,384).</p>
<p>
...
<h4 id="IVFSQ8-performance-test-results" class="common-anchor-header">نتائج اختبار أداء IVF_SQ8:</h4><p>أُجري اختبار وقت الاستعلام IVF_SQ8 في Milvus باستخدام مجموعة بيانات SIFT 1B SIFT العامة، والتي تحتوي على مليار متجه 128 بُعدًا، لبناء الفهرس.</p>
<p>
