...
<h3 id="Connecting-and-Creating-a-Collection" class="common-anchor-header">الاتصال وإنشاء مجموعة:</h3><p>أولاً، قم بالاتصال بمثيل ميلفوس الخاص بك باستخدام المنفذ الذي قمت بإعادة توجيهه مسبقاً. تأكد من تطابق URI مع المنفذ المحلي المعين من قبل K8s:</p>
...
<li><p>يُظهر نشر Milvus على مجموعة Kubernetes العنقودية قابلية التوسع والمرونة في قواعد البيانات المتجهة في التعامل مع أعباء عمل الذكاء الاصطناعي والتعلم الآلي. من خلال هذا البرنامج التعليمي، تكون قد تعلمت أساسيات إعداد Milvus مع Helm، وإنشاء مجموعة، وإجراء عمليات استيعاب البيانات وعمليات البحث عن التشابه.</p></li>
