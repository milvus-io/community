...
<ul>
<li><p><strong>زمن انتقال P95/P99 لقياس تجربة المستخدم الحقيقية</strong>: يخفي متوسط/متوسط زمن الكمون القيم المتطرفة التي تحبط المستخدمين الحقيقيين. هذا هو السبب في أن VDBBench يركز على زمن كمون الذيل مثل P95/P99، مما يكشف عن الأداء الذي سيحققه 95% أو 99% من استفساراتك بالفعل.</p></li>
...
<p>تضمن هذه الأساليب المنظمة بعناية أن تكون قيم <code translate="no">max_qps</code> و <code translate="no">conc_latency_p99</code> التي أبلغ عنها VDBBench <strong>دقيقة وذات صلة بالإنتاج،</strong> مما يوفر رؤى مفيدة لتخطيط سعة الإنتاج وتصميم النظام.</p>
<p>
  <span class="img-wrapper">
...
<h3 id="Static-Collection" class="common-anchor-header">التجميع الثابت</h3><p>على عكس المقاييس الأخرى التي تتسرع في الاختبار، يضمن VDBBench أولاً أن كل قاعدة بيانات قد حسّنت فهارسها بالكامل - وهو شرط أساسي بالغ الأهمية للإنتاج غالبًا ما تهمله العديد من المقاييس. هذا يعطيك الصورة الكاملة:</p>
<ul>
