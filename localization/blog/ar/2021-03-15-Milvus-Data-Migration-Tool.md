...
---
<custom-h1>تقديم أداة ميلفوس لترحيل البيانات</custom-h1><p><em><strong>ملاحظة مهمة</strong>: تم إهمال أداة ترحيل بيانات Mivus. لترحيل البيانات من قواعد البيانات الأخرى إلى ميلفوس، نوصي باستخدام خدمة نقل المتجهات (VTS) الأكثر تقدمًا.</em></p>
<p><strong>لمزيد من المعلومات، راجع <a href="https://zilliz.com/vector-transport-service">الصفحة المقصودة لخدمة نقل المتجهات</a> أو <a href="https://github.com/zilliztech/vts">مستودع GitHub</a> الخاص بها.</strong></p>
<p>تدعم VTS حاليًا الترحيل من:</p>
<ul>
<li>بينيكون</li>
<li>كيدرانت</li>
<li>Elasticsearch</li>
...
<li>OpenSearch</li>
<li>فايس</li>
<li>Milvus 1.x إلى Milvus 2.x</li>
<li>من Milvus 2.3.x إلى Milvus 2.3.x أو أعلى</li>
</ul>
<p>--------------------------------- <strong>أداة ترحيل بيانات Mivus تم إهمالها</strong> ----------------------</p>
...
<button class="copy-code-btn"></button></code></pre>
<p><br/></p>
<h3 id="HDF5-to-Milvus" class="common-anchor-header">من HDF5 إلى ملفوس</h3><h4 id="Steps" class="common-anchor-header">الخطوات</h4><p>1- تنزيل <strong>H2M.yaml.</strong></p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="MilvusDM-File-Structure" class="common-anchor-header">بنية ملف MilvusDM</h3><p>يوضح المخطط البياني أدناه كيف يقوم MilvusDM بتنفيذ المهام المختلفة وفقًا لملف YAML الذي يتلقاه:</p>
<p>
