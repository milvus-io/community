...
<p>كما هو مبين في الرسم البياني أعلاه، بعد قبول طلب بحث TopK، تقوم Mishards أولاً بتقسيم الطلب إلى طلبات فرعية وإرسال الطلبات الفرعية إلى خدمة المنبع. عندما يتم جمع جميع الاستجابات الفرعية، يتم دمج الاستجابات الفرعية وإعادتها إلى المنبع.</p>
...
<h3 id="Tracing" class="common-anchor-header">التتبع</h3><p>الكلمات الرئيسية: التتبع المفتوح، جايجر، زيبكين</p>
