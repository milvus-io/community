...
title: Open Tag：Claude CodeとCodex向けのオープンソースClaude Tag
author: Cheney Zhang
...
desc: >-
  MFS上に構築された、Claude CodeとCodex向けのオープンソースのSlackネイティブなClaude
  Tag：コード、ドキュメント、チケット、データベースを横断する、検索可能で閲覧可能な単一のインターフェース。
