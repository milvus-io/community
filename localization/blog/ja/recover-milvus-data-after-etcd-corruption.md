...
title: バックアップなしでetcd破損後にMilvusデータを復旧する方法
author: Jack Li
date: 2026-7-22
cover: >-
...
desc: >-
  etcd が破損し、バックアップもなく、ソースデータも消失？MinIO の binlog から bulkInsert を使って Milvus
  コレクションを復旧した方法と、インポート前にセグメントを検証する方法をご紹介します。
