...
<h3 id="Audio-feature-extraction" class="common-anchor-header">音声特徴抽出</h3><p>音声の特徴抽出は、音声の類似検索を可能にするため、音声検索システムにおいて最も重要な技術である。音声特徴量を抽出する方法は2つに分類される：</p>
<ul>
...
<p>ディープラーニングベースのモデルは、従来のモデルよりもエラー率が桁違いに低いため、オーディオ信号処理分野の中核技術として勢いを増している。</p>
<p>オーディオデータは通常、抽出されたオーディオ特徴によって表現される。検索プロセスでは、オーディオデータそのものではなく、これらの特徴や属性を検索・比較する。そのため、音声類似検索の有効性は特徴抽出の品質に大きく依存する。</p>
...
<p>以下の図は、Milvusを使用した一般的な類似検索プロセスを表しています。<span class="img-wrapper"> <img translate="no" src="https://assets.zilliz.com/how_does_milvus_work_6926180543.png" alt="how-does-milvus-work.png" class="doc-image" id="how-does-milvus-work.png" /><span>how-does-milvus-work.png</span> </span></p>
<ol>
