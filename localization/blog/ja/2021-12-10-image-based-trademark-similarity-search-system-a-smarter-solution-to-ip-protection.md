...
<p>前述のアップルとウールワースの紛争は、主に商標権侵害をめぐるものであり、正確には両者の商標イメージの類似をめぐるものである。ウールワースの二の舞にならないためには、商標出願前および商標出願審査中の両方において、商標の徹底的な類似性調査が重要なステップとなる。最も一般的な方法は、<a href="https://tmsearch.uspto.gov/search/search-information">米国特許商標庁（USPTO）のデータベースで</a>検索することである。あまり魅力的なUIではないにもかかわらず、この検索プロセスは、画像を検索するために単語と商標意匠コード（デザインの特徴を手作業で注釈したラベル）に依存しているため、そのテキストベースの性質によって深い欠陥もある。</p>
<p>
...
<li><a href="https://bit.ly/3ob7kd8">Twitterで</a>私たちとつながりましょう。</li>
</ul></li>
</ul>
