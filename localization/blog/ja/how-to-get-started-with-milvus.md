...
<p>また、Milvus StandaloneとMilvus Liteは同じクライアントサイドAPIを共有しているため、Milvus LiteでMilvusの機能を学習した後、Milvus Standaloneを使用することも可能です。</p>
