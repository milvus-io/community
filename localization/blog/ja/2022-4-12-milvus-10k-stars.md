...
<p>Milvusがオープンソースプロジェクトになってから2年半が経ちました。私たちが始めた当初は、ベクターデータベースがどのようなものかを正確に理解している人はほとんどいませんでしたし、ましてや、それが私たちの日常生活におけるAIの導入をどのように可能にし、加速させるかを話している人はほとんどいませんでした。Milvusベクトル・データベースは、AIのための次世代データベースを定義し構築するという我々のビジョンを受け継いでいる。私たちはMilvusプロジェクトでSOTAアルゴリズムとクラウド技術を組み合わせ、開発者がMilvusベクトルデータベースを使って簡単にAIアプリケーションを構築できるようにしました。</p>
<p>
