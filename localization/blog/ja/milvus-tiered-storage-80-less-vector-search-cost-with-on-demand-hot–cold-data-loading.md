...
<p>ベクター検索をプロダクションで運用しているのであれば、おそらくこのような状況を目の当たりにしていることだろう。大量のメモリとSSDをプロビジョニングすることで、データセットのほんの一部しかアクティブになっていないにもかかわらず、すべてが「クエリ・レディ」の状態に保たれているのだ。そして、それはあなただけではない。同じようなケースはたくさん見てきました：</p>
<ul>
...
<p>Milvus 2.5では、コレクションのロードに<strong>25分かかって</strong>いた。Milvus 2.6+のTiered Storageでは、同じワークロードがわずか<strong>45</strong>秒で完了し、ロード効率が一段と向上しています。</p>
...
<p>全クエリの約80%を占めるホットデータでは、P99のレイテンシはわずか6.7%しか増加せず、その結果、本番環境ではほとんど影響を感じない。</p>
