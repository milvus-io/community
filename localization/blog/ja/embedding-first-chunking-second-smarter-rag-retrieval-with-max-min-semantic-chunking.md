...
title: 最初に埋め込み、次にチャンキング：最大最小の意味的チャンキングでよりスマートなRAG検索
author: Rachel Liu
...
<h2 id="Max–Min-Semantic-Chunking-Embed-First-Chunk-Second" class="common-anchor-header">最大最小のセマンティック・チャンキングまず埋め込み、次にチャンク<button data-href="#Max–Min-Semantic-Chunking-Embed-First-Chunk-Second" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>しかし、この方法にはまだ盲点がある。局所的にしか意味を見出せず、意図的にばらばらになった情報をつなぎ直すことができないのだ。オーバーラッピングウィンドウ、マルチパススキャン、その他の文脈を維持するトリックは、特に参考文献と説明が離れた場所にある文書にはまだ必要である。</p>
...
<p>RAGのパフォーマンスを向上させる方法についてご質問がありますか？私たちの<a href="https://discord.com/invite/8uyFbECzPX">Discordに</a>参加して、毎日実際の検索システムを構築し、チューニングしているエンジニアとつながりましょう。</p>
