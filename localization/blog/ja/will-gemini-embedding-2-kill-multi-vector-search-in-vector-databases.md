...
<li>1リクエストあたり6枚までの<strong>画像</strong>（PNG、JPEG）</li>
...
<tr><td><strong>クロスモーダル入力</strong></td><td>別々のエンコーダー、別々の呼び出し</td><td>インターリーブ入力（例：画像＋テキストを1つのリクエストにまとめる）</td></tr>
...
<li><strong>クロスモーダル画像検索。</strong> <a href="https://zilliz.com/learn/exploring-openai-clip-the-future-of-multimodal-ai-learning">CLIPの</a>ようなモデルからの密なベクトルを使用したテキストクエリを使用して、商品画像に対してクエリを実行します。</li>
</ul>
...
<p>試してみたいですか？<a href="https://milvus.io/docs/quickstart.md">Milvusのクイックスタートから始めて</a>、上記のデモを実行するか、BGE-M3での完全なマルチベクトルのセットアップについては、<a href="https://milvus.io/docs/hybrid_search_with_milvus.md">ハイブリッド検索ガイドを</a>チェックしてください。ご質問は<a href="https://milvus.io/discord">Discord</a>または<a href="https://meetings.hubspot.com/chloe-williams1/milvus-meeting">Milvusオフィスアワーまで</a>。</p>
