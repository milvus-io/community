...
title: Gemini Embedding 2はベクトル・データベースにおける多ベクトル探索を殺すか？
author: Jack Li
date: 2026-3-13
...
---
<p>Googleは<a href="https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-embedding-2/">Gemini Embedding 2を</a>リリースした。これは、テキスト、画像、動画、音声、ドキュメントを単一のベクトル空間にマッピングする初のマルチモーダル埋め込みモデルである。</p>
...
<h3 id="Gemini-Embedding-2-vs-CLIPCLAP-One-Model-vs-Many-for-Multimodal-Embeddings" class="common-anchor-header">Gemini Embedding 2とCLIP/CLAPの比較 マルチモーダルエンベッディングのための1つのモデルと多数のモデルの比較</h3><table>
<thead>
...
<h2 id="Gemini-Embedding-2-Will-be-Available-in-MilvusZilliz-Cloud-Soon" class="common-anchor-header">Gemini Embedding 2は、Milvus/Zilliz Cloudでまもなく利用可能になります。<button data-href="#Gemini-Embedding-2-Will-be-Available-in-MilvusZilliz-Cloud-Soon" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
