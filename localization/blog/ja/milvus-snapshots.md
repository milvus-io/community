...
title: 'Milvusスナップショット: データをコピーせずにポイントインタイムのコレクションビュー'
author: Leo Liu
date: 2026-7-30
...
desc: >-
  Milvusのスナップショットは、データをコピーする代わりにファイル参照を記録することでコレクションを固定します —
  低コストの復旧ポイント、インデックス再構築なしの復元、そしてSpark向けの安定した入力を実現します。
