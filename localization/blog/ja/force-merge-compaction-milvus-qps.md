...
title: Force Merge Compaction が Milvus の検索 QPS をほぼ倍増させた方法
author: Jack Li
date: 2026-07-1
...
desc: >-
  Force Merge は、Milvus の小さな sealed segment を統合し、より少数の大きな segment にまとめます。HNSW
  インデックスを持つ 100 万ベクトルでは、検索 QPS が約 3,000 から約 5,600〜6,000 に向上しました。
