...
title: Force Merge CompactionがMilvusの検索QPSをほぼ2倍にした方法
author: Jack Li
date: 2026-07-1
...
desc: >-
  Force Merge は、Milvus の小さな sealed セグメントを、より少数の大きなセグメントへ統合します。HNSW インデックスを使用した
  100 万ベクトルでは、検索 QPS が約 3,000 から約 5,600～6,000 に上昇しました。
