...
---
<custom-h1>Milvusデータ移行ツールのご紹介</custom-h1><p><em><strong>重要</strong>：Mivusデータ移行ツールは廃止されました。他のデータベースからmilvusへのデータ移行には、より高度なベクタートランスポートサービス(VTS)を使用することをお勧めします。</em></p>
<p><strong>詳細については、<a href="https://zilliz.com/vector-transport-service">ベクタートランスポートサービスのランディングページ</a>または<a href="https://github.com/zilliztech/vts">GitHub リポジトリを</a>参照してください。</strong></p>
<p>VTSは現在、以下のデータベースからの移行をサポートしています：</p>
<ul>
<li>Pinecone</li>
<li>Qdrant</li>
<li>Elasticsearch</li>
...
<li>Milvus 2.3.xからMilvus 2.3.x以上へ</li>
</ul>
<p>---------------------------------<strong>Mivus データ移行ツールは廃止されました</strong>。</p>
<h3 id="Overview" class="common-anchor-header">概要</h3><p><a href="https://github.com/milvus-io/milvus-tools">MilvusDM</a>(Milvus Data Migration) は、Milvus のデータファイルのインポート/エクスポート専用に設計されたオープンソースツールです。MilvusDMを利用することで、以下のようなデータ管理効率の大幅な向上とDevOpsコストの削減が可能となります：</p>
<ul>
