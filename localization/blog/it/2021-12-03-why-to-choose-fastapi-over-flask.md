...
<h3 id="1-Performance" class="common-anchor-header">1. Prestazioni</h3><p>La maggior parte dei progetti del Milvus Bootcamp sono costruiti intorno a sistemi di ricerca inversa di immagini, chatbot QA, motori di ricerca di testi, che hanno tutti elevate esigenze di elaborazione dei dati in tempo reale. Di conseguenza, abbiamo bisogno di un framework con prestazioni eccezionali, che è esattamente il punto forte di FastAPI. Pertanto, dal punto di vista delle prestazioni del sistema, abbiamo deciso di scegliere FastAPI.</p>
...
<li><a href="https://milvus.io/blog/2021-09-26-onnx.md">Combinazione di modelli di intelligenza artificiale per la ricerca di immagini con ONNX e Milvus</a></li>
...
<li><a href="https://milvus.io/blog/audio-retrieval-based-on-milvus.md">Recupero audio basato su Milvus</a></li>
