...
<button class="copy-code-btn"></button></code></pre>
<p>Dopo aver avviato Milvus Lite, è possibile utilizzare PyMilvus o altri strumenti per connettersi al server standalone.</p>
