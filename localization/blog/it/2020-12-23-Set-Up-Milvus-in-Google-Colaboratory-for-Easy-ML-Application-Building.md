...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Create-a-collectionpartitionindex" class="common-anchor-header">Creare una raccolta/partizione/indice:</h4><pre><code translate="no"><span class="hljs-comment"># Information needed to create a collection</span>
...
<li>Per ulteriori informazioni sull'azienda che ha lanciato Milvus, visitate <a href="https://zilliz.com/">Zilliz.com</a>.</li>
</ul>
