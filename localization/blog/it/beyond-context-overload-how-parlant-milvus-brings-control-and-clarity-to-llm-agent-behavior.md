...
<p><strong>4. Iniezione nel contesto</strong> - Queste linee guida corrispondenti vengono inserite dinamicamente nel contesto del LLM, in modo che il modello possa agire secondo le regole corrette.</p>
<p>
  <span class="img-wrapper">
