...
<p>Ma questo è solo l'inizio. Con il rilascio della versione 2.5, abbiamo aggiornato la <a href="https://milvus.io/docs/roadmap.md">roadmap dei prodotti Milvus</a>. Nelle future iterazioni di Milvus, la nostra attenzione si concentrerà sull'evoluzione delle capacità di Milvus in quattro direzioni chiave:</p>
<ul>
...
<h2 id="Documentation-and-Developer-Experience" class="common-anchor-header">Documentazione ed esperienza per gli sviluppatori<button data-href="#Documentation-and-Developer-Experience" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
