...
title: >-
  Introduzione alla funzione di incorporamento: Come Milvus 2.6 semplifica la
...
<li><p><strong>Restituzione dei risultati</strong> - Milvus restituisce i risultati top-k più simili, mappati ai dati originali, direttamente all'applicazione.</p></li>
</ol>
...
<li><p><code translate="no">params</code> - Contiene i parametri di configurazione della funzione di embedding. I valori di <code translate="no">provider</code> e <code translate="no">model_name</code> devono corrispondere alle voci corrispondenti del file di configurazione <code translate="no">milvus.yaml</code>.</p></li>
</ul>
