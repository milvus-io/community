...
<h2 id="Preparation" class="common-anchor-header">Preparazione<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Quando l'utente è pronto a inserire un vettore in Milvus, deve innanzitutto creare una Collection (* Milvus rinomina Table in Collection nella versione 0.7.0). La Collezione è l'unità di base per la registrazione e la ricerca di vettori in Milvus.</p>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>2-query-near-real-time-milvus.png</span> </span></p>
