...
<h3 id="Image-embeddings" class="common-anchor-header">Incorporazione di immagini</h3><p>Il riconoscimento delle immagini è decollato nel 2012, dopo la comparsa di AlexNet. Da allora, il campo della computer vision ha visto numerosi progressi. L'ultimo modello di riconoscimento delle immagini degno di nota è ResNet-50, una rete residuale profonda a 50 strati basata sulla precedente architettura ResNet-34.</p>
