...
<p>Infine, è possibile avviare il cluster Milvus utilizzando <code translate="no">docker-compose up -d</code> e verificare se le modifiche sono state apportate con successo.</p>
