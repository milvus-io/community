...
<li><strong>Trigger:</strong> I trigger definiscono quando un agente viene eseguito. Oltre all'esecuzione manuale, è possibile collegare gli agenti a pianificazioni o eventi esterni in modo che rispondano automaticamente a messaggi, e-mail o attività webhook. Quando si attiva un trigger, Agent Builder avvia un nuovo thread di esecuzione ed esegue la logica dell'agente, consentendo un comportamento continuo e guidato dagli eventi.</li>
