...
<p>Per il momento, il database vettoriale Milvus conserva una replica per ogni segmento in memoria. Tuttavia, con le repliche in memoria, è possibile avere più repliche di un segmento su diversi nodi di interrogazione. Ciò significa che se un nodo di interrogazione sta conducendo una ricerca su un segmento, una nuova richiesta di ricerca in arrivo può essere assegnata a un altro nodo di interrogazione inattivo, poiché questo nodo di interrogazione ha una replica esattamente dello stesso segmento.</p>
