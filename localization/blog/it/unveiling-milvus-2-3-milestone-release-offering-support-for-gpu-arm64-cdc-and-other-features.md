...
<li>Upsert è implementato come una combinazione di <code translate="no">delete</code> e <code translate="no">insert</code>, che può comportare una certa perdita di prestazioni. Si consiglia di utilizzare <code translate="no">insert</code> se si utilizza Milvus in scenari di scrittura intensiva.</li>
</ul>
