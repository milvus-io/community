...
<p>Dopo il successo dell'implementazione di Milvus 1.0, il primo progetto a utilizzare Milvus è stato il progetto di richiamo delle pubblicità avviato dal team Ad di SmartNews. Durante la fase iniziale, il set di dati pubblicitari era su scala milionaria. Nel frattempo, la latenza di P99 era strettamente controllata entro i 10 millisecondi.</p>
...
<p>Alla fine di luglio, Yusup, ingegnere di SmartNews, ha proposto l'idea di utilizzare gli <a href="https://milvus.io/docs/v2.0.x/collection_alias.md#Collection-Alias">alias delle collezioni</a> per ottenere il ricaricamento a caldo.</p>
...
<p>Attualmente, il team dell'infrastruttura AI sta prendendo l'iniziativa di distribuire Milvus 2.0 e di migrare gradualmente tutti i dati da Milvus 1.0 a 2.0.</p>
<p>
