...
<p>Quando il buffer raggiunge una soglia predefinita, il sistema costruisce gli indici in batch e li persiste. Questo migliora le prestazioni di recupero a lungo termine senza bloccare le scritture in tempo reale. Separando l'ingestione veloce dalla costruzione più lenta degli indici, Milvus raggiunge un equilibrio pratico tra velocità di scrittura e qualità di ricerca che funziona bene per la memoria degli agenti.</p>
