...
<p>Il commento del mio collega: se i dati di allenamento sono un record perdente, cosa sta imparando esattamente l'IA? Ma è proprio questo il punto: l'agente non sta copiando le mie operazioni, ma le sta memorizzando in modo da convincermi a non fare la prossima.</p>
