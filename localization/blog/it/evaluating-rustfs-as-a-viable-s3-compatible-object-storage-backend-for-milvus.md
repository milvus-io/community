...
title: >-
  ...
  come backend per l'archiviazione di oggetti compatibile con S3 per Milvus
author: Min Yin
...
<h2 id="Hands-On-Replacing-MinIO-with-RustFS-in-Milvus" class="common-anchor-header">Esercitazione pratica: sostituzione di MinIO con RustFS in Milvus<button data-href="#Hands-On-Replacing-MinIO-with-RustFS-in-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>L'obiettivo di questo esercizio è sostituire il servizio di archiviazione degli oggetti predefinito MinIO e distribuire Milvus 2.6.7 utilizzando RustFS come backend di archiviazione degli oggetti.</p>
