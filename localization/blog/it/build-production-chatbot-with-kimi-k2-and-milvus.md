...
<p>La filosofia di progettazione è quella di creare un'interfaccia in linguaggio naturale che dia l'impressione di parlare con un assistente esperto, non di gestire un database tramite comandi vocali.</p>
