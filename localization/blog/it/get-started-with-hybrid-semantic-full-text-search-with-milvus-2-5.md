...
<h2 id="Summary" class="common-anchor-header">Riassunto<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ora avete tutte le conoscenze necessarie per eseguire ricerche full-text e ibride semantiche/full-text con Milvus 2.5. Per ulteriori informazioni su come funziona la ricerca full-text e perché è complementare alla ricerca semantica, consultare i seguenti articoli:</p>
<ul>
