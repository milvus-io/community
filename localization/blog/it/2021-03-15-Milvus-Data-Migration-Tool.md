...
---
<custom-h1>Introducing Milvus Data Migration Tool</custom-h1><p><em><strong>Important Note</strong>: The Mivus Data Migration Tool has been deprecated. For data migration from other databases to Milvus, we recommend that you use the more advanced vector transport service (VTS).</em></p>
<p><strong>For more information, see the <a href="https://zilliz.com/vector-transport-service">Vector Transport Service landing page</a> or its <a href="https://github.com/zilliztech/vts">GitHub repository</a>.</strong></p>
<p>VTS currently supports migration from:</p>
<ul>
<li>Pinecone</li>
<li>Qdrant</li>
<li>Elasticsearch</li>
