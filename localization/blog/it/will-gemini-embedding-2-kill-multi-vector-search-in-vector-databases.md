...
<p>L'idea di base è che spesso un singolo oggetto ha più di un significato. Un prodotto ha un titolo <em>e una</em> descrizione. Un post sui social media ha una didascalia <em>e un'</em> immagine. Ogni angolo racconta qualcosa di diverso, quindi ognuno ha un proprio campo vettoriale.</p>
