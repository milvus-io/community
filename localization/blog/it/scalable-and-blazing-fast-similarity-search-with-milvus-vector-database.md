...
<p>Gestire un numero enorme di vettori per la ricerca di similarità (anche con gli indici) può essere molto costoso. Ciononostante, i database vettoriali migliori e più avanzati dovrebbero consentire di inserire, indicizzare e ricercare tra milioni o miliardi di vettori di destinazione, oltre a specificare un algoritmo di indicizzazione e una metrica di similarità a scelta.</p>
