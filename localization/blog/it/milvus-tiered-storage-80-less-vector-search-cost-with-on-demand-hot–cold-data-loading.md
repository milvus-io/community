...
desc: >-
  ...
  dei dati caldi e freddi, con una riduzione dei costi fino all'80% e tempi di
  caricamento più rapidi su scala.
origin: >-
...
<p>Se gestite la ricerca vettoriale in produzione, probabilmente lo avete visto di persona. Avete bisogno di grandi quantità di memoria e di unità SSD per mantenere tutto "pronto per le query", anche se solo una piccola parte del vostro set di dati è effettivamente attiva. E non siete i soli. Abbiamo visto molti casi simili:</p>
<ul>
...
<table>
<thead>
<tr><th style="text-align:center"><strong>Tipo di richiesta di ricerca</strong></th><th style="text-align:center"><strong>Milvus 2.5 P99 latenza</strong></th><th style="text-align:center"><strong>Milvus 2.6+ latenza P99</strong></th><th style="text-align:center"><strong>Cambiamento</strong></th></tr>
</thead>
<tbody>
<tr><td style="text-align:center">Ricerca di dati a caldo</td><td style="text-align:center">15 ms</td><td style="text-align:center">16 ms</td><td style="text-align:center">+6.7%</td></tr>
<tr><td style="text-align:center">Ricerche di dati a caldo</td><td style="text-align:center">15 ms</td><td style="text-align:center">28 ms</td><td style="text-align:center">+86%</td></tr>
<tr><td style="text-align:center">Ricerche di dati a freddo (primo accesso)</td><td style="text-align:center">15 ms</td><td style="text-align:center">120 ms</td><td style="text-align:center">+700%</td></tr>
<tr><td style="text-align:center">Ricerche di dati a freddo (cache)</td><td style="text-align:center">15 ms</td><td style="text-align:center">18 ms</td><td style="text-align:center">+20%</td></tr>
</tbody>
</table>
<blockquote>
<p><em>Il termine "query" si riferisce alle richieste di ricerca vettoriale, non all'API Milvus <code translate="no">query()</code>.</em></p>
</blockquote>
...
<h3 id="Benchmark-Summary" class="common-anchor-header">Riepilogo dei benchmark</h3><p>In tutti i test, il Tiered Storage offre miglioramenti costanti e misurabili:</p>
<ul>
...
<ul>
<li><p><strong>Caratteristiche:</strong> Un gran numero di tenant con un'attività molto disomogenea; la ricerca vettoriale è il carico di lavoro principale.</p></li>
