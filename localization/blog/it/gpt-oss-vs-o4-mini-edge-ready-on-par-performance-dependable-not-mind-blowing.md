...
---
<p>Il mondo dell'intelligenza artificiale è in fermento. In poche settimane, Anthropic ha lanciato Claude 4.1 Opus, DeepMind ha stupito tutti con il simulatore di mondo Genie 3 e ora OpenAI ruba i riflettori con l'open-sourcing di due modelli di ragionamento: <a href="https://huggingface.co/openai/gpt-oss-120b">gpt-oss-120b</a> e <a href="https://huggingface.co/openai/gpt-oss-20b">gpt-oss-20b</a>, con licenza Apache 2.0.</p>
...
<h3 id="5-Potential-GPT-5-Preview" class="common-anchor-header">5: Potenziale anteprima del GPT-5</h3><p>OpenAI non ha rivelato tutto, ma i dettagli dell'architettura suggeriscono che questa potrebbe essere un'anteprima della direzione del <strong>GPT-5</strong>:</p>
<ul>
<li><p>Utilizza MoE con 4 esperti per ingresso</p></li>
<li><p>Segue l'alternanza di attenzione densa + rada locale (modello GPT-3)</p></li>
