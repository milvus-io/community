...
<h2 id="What-is-the-Milvus-Operator" class="common-anchor-header">Che cos'è Milvus Operator?<button data-href="#What-is-the-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://milvus.io/docs/install_cluster-milvusoperator.md"><strong>Milvus Operator</strong></a> è uno strumento di gestione nativo di Kubernetes che automatizza il ciclo di vita completo delle distribuzioni di database vettoriali Milvus. Costruito sul modello di Kubernetes Operator, racchiude anni di conoscenze operative sull'esecuzione di Milvus in produzione e codifica tale esperienza in un software che viene eseguito insieme al vostro cluster.</p>
