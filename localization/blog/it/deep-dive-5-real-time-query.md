...
<li><a href="https://milvus.io/docs/v2.0.x/four_layers.md">Ruolo e funzione di ogni componente di Milvus</a></li>
...
<p>Ad esempio, come mostrato nell'illustrazione, al nodo di query 4 sono stati assegnati più segmenti sigillati rispetto agli altri nodi di query. È molto probabile che questo faccia del nodo di query 4 il collo di bottiglia che rallenta l'intero processo di interrogazione. Per risolvere questo problema, il sistema deve assegnare diversi segmenti del nodo di query 4 ad altri nodi di query. Questa operazione è chiamata bilanciamento del carico.</p>
<p>
