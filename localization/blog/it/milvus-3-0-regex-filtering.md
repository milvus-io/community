...
title: 'Oltre =~: come Milvus 3.0 trasforma le regex in un filtro nativo del database'
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  Milvus 3.0 sposta le regex dalla post-elaborazione lato applicazione al
  percorso di query del database, dove possono essere combinate con la ricerca
  vettoriale, la ricerca full-text, i filtri scalari e l’esecuzione indicizzata.
