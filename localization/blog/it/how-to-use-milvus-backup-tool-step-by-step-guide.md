...
<h2 id="BackupRestore-Use-Cases" class="common-anchor-header">Casi d'uso del backup/ripristino<button data-href="#BackupRestore-Use-Cases" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ci sono diversi casi d'uso in cui lo strumento milvus-backup può essere applicato efficacemente, a seconda delle esigenze e delle configurazioni specifiche:</p>
<ol>
...
<p>
 <span class="img-wrapper">
   ...
   <span>Figura: Il flusso di lavoro del backup e del ripristino all'interno di un'istanza Milvus</span> </span></p>
...
<p>
 <span class="img-wrapper">
   ...
   <span>Figura: Flusso di lavoro del backup e del ripristino tra due istanze Milvus in un S3, con bucket differenti</span> </span></p>
