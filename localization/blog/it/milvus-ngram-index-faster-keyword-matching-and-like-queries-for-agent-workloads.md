...
<h2 id="Limitations-and-Trade-offs-of-the-Ngram-Index" class="common-anchor-header">Limitazioni e compromessi dell'indice Ngram<button data-href="#Limitations-and-Trade-offs-of-the-Ngram-Index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Evaluating-Ngram-Index-Performance-on-LIKE-Queries" class="common-anchor-header">Valutazione delle prestazioni dell'indice Ngram su query LIKE<button data-href="#Evaluating-Ngram-Index-Performance-on-LIKE-Queries" class="anchor-icon" translate="no">
    ...
    </button></h2><p>L'obiettivo di questo benchmark è valutare l'efficacia dell'indice Ngram nell'accelerare le query <code translate="no">LIKE</code>.</p>
