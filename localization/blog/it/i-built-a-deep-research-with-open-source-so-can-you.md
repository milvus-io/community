...
<p><strong>Deep Research è addestrato su dati proprietari, utilizzando diversi tipi di messa a punto, il che è probabilmente una componente chiave delle sue prestazioni:</strong></p>
<ul>
...
<h2 id="Can-I-build-my-own" class="common-anchor-header">Posso costruirne una mia?<button data-href="#Can-I-build-my-own" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Certamente! Costruiamo la nostra "Ricerca profonda", in locale e con strumenti open-source. Avremo a disposizione solo una conoscenza di base dell'IA generativa, buon senso, un paio di ore libere, una GPU e gli strumenti open-source <a href="https://milvus.io/docs">Milvus</a>, <a href="https://huggingface.co/unsloth/DeepSeek-R1-Distill-Llama-8B-unsloth-bnb-4bit">DeepSeek R1</a> e <a href="https://python.langchain.com/docs/introduction/">LangChain</a>.</p>
...
<li><p>Quaderno: <em>"</em><a href="https://colab.research.google.com/drive/1W5tW8SqWXve7ZwbSb9pVdbt5R2wq105O?usp=sharing"><em>Linea di base per una ricerca profonda open source</em></a><em>".</em></p></li>
