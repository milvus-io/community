...
<li><p>Un'interfaccia chatbot che risponde a domande tecniche con precisione millimetrica.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>Ora siamo pronti ad avviare i contenitori Docker. Per farlo, tutto quello che dobbiamo fare è eseguire il comando <code translate="no">docker compose up -d</code>. Al termine, nel terminale verrà visualizzato un output simile a quello riportato di seguito:</p>
