...
<tr><td>gpt-5-chat</td><td>Equivalente a gpt-5, utilizzato nelle conversazioni ChatGPT</td><td>-</td><td>-</td><td>2024-10-01</td></tr>
...
<h2 id="Why-Developers-Should-Care--Especially-for-RAG--Agents" class="common-anchor-header">Perché gli sviluppatori dovrebbero interessarsene, soprattutto per RAG e Agenti<button data-href="#Why-Developers-Should-Care--Especially-for-RAG--Agents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
