...
title: 'Open Tag: un Claude Tag open source per Claude Code e Codex'
author: Cheney Zhang
...
desc: >-
  Un Claude Tag open-source e nativo per Slack per Claude Code e Codex, basato
  su MFS: un’unica interfaccia ricercabile e navigabile per il tuo codice, la
  documentazione, i ticket e i database.
