...
<ul>
<li><p><code translate="no">Etcd.endpoints</code>: Specifica l'indirizzo del cluster etcd. Per impostazione predefinita, Milvus lancia un'istanza in bundle, ma negli ambienti aziendali è consigliabile connettersi a un servizio <code translate="no">etcd</code> gestito per una migliore disponibilità e controllo operativo.</p></li>
