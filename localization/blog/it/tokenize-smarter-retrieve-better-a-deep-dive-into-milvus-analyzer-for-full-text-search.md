...
<tbody>
<tr><td>Standard</td><td>Inglese e lingue delimitate da spazi</td><td>Il più comune tokenizzatore generale; rileva i confini delle parole e le divide di conseguenza.</td></tr>
...
<p>Le operazioni di filtro più comuni includono la normalizzazione delle maiuscole e delle minuscole, l'eliminazione delle stop words (come "the" e "and"), l'eliminazione della punteggiatura e l'applicazione dello stemming (riducendo "running" a "run").</p>
...
<tr><td>Stemmatore</td><td>Stemming di parole</td><td>Scenari inglesi (ad es. &quot;studies&quot; e &quot;studying&quot; → &quot;study&quot;)</td></tr>
...
<h2 id="Hands-on-Coding-with-Milvus-Analyzer" class="common-anchor-header">Codifica pratica con l'analizzatore Milvus<button data-href="#Hands-on-Coding-with-Milvus-Analyzer" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La teoria aiuta, ma non c'è niente di meglio di un esempio di codice completo. Vediamo come utilizzare gli analizzatori in Milvus con l'SDK Python, sia gli analizzatori integrati che quelli multilingue. Questi esempi usano Milvus v2.6.1 e Pymilvus v2.6.1.</p>
