...
<li><p>Più team che accedono alle stesse collezioni di vettori</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Quick-Tips-How-to-Operate-Access-Control-Safely-in-Production" class="common-anchor-header">Suggerimenti rapidi: Come gestire in modo sicuro il controllo degli accessi in produzione<button data-href="#Quick-Tips-How-to-Operate-Access-Control-Safely-in-Production" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
