...
<h2 id="What-if-You-Could-Build-Your-Own-Cursor" class="common-anchor-header">Bagaimana jika Anda Bisa Membuat Kursor Anda Sendiri?<button data-href="#What-if-You-Could-Build-Your-Own-Cursor" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Inilah masalahnya: teknologi inti di balik Cursor bukanlah teknologi eksklusif. Cursor dibangun di atas fondasi sumber terbuka yang sudah terbukti - database vektor seperti <a href="https://milvus.io/">Milvus</a>, <a href="https://zilliz.com/ai-models">model penyematan</a>, pengurai sintaksis dengan Tree-sitter - semuanya tersedia bagi siapa saja yang mau menghubungkan titik-titiknya.</p>
...
<p>Kami percaya bahwa infrastruktur terbuka adalah kunci untuk membangun alat pengembang yang kuat dan dapat dipercaya-dan mengundang pengembang untuk mengembangkannya untuk model, bahasa, atau kasus penggunaan yang baru.</p>
