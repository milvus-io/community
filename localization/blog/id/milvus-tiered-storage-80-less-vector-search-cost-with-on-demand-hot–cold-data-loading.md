...
<li><p><strong>Stempel</strong> waktu (Digunakan untuk mendukung kueri penelusuran waktu)</p></li>
...
<ul>
<li><p>Di <strong>Milvus 2.5</strong>, semua 50 bidang skalar dimuat terlepas dari persyaratan kueri.</p></li>
...
<p><strong>Catatan:</strong> Pemuatan parsial yang sadar penyewa untuk bidang skalar dan indeks vektor akan secara resmi diperkenalkan pada rilis yang akan datang. Setelah tersedia, fitur ini akan semakin mengurangi latensi pemuatan dan meningkatkan performa kueri dingin dalam penerapan multi-penyewa yang besar.</p>
...
<table>
<thead>
<tr><th style="text-align:center"><strong>Jenis permintaan pencarian</strong></th><th style="text-align:center"><strong>Milvus 2.5 Latensi P99</strong></th><th style="text-align:center"><strong>Milvus 2.6+ latensi P99</strong></th><th style="text-align:center"><strong>Perubahan</strong></th></tr>
</thead>
<tbody>
<tr><td style="text-align:center">Pencarian data panas</td><td style="text-align:center">15 ms</td><td style="text-align:center">16 ms</td><td style="text-align:center">+6.7%</td></tr>
<tr><td style="text-align:center">Pencarian data hangat</td><td style="text-align:center">15 ms</td><td style="text-align:center">28 ms</td><td style="text-align:center">+86%</td></tr>
<tr><td style="text-align:center">Pencarian data dingin (akses pertama)</td><td style="text-align:center">15 ms</td><td style="text-align:center">120 ms</td><td style="text-align:center">+700%</td></tr>
<tr><td style="text-align:center">Pencarian data dingin (cache)</td><td style="text-align:center">15 ms</td><td style="text-align:center">18 ms</td><td style="text-align:center">+20%</td></tr>
</tbody>
</table>
<blockquote>
<p><em>"Kueri" di sini mengacu pada permintaan pencarian vektor, bukan API Milvus <code translate="no">query()</code>.</em></p>
</blockquote>
