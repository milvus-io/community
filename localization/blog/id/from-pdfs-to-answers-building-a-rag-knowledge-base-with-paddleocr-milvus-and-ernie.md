...
<p>Bagian di bawah ini akan menjelaskan setiap tahap secara berurutan, dimulai dengan bagaimana dokumen mentah menjadi teks yang dapat dicari.</p>
...
<li><strong>Tanya Jawab Multimodal.</strong> Memasangkan gambar dengan teks halaman OCR di prompt memberikan model visi konteks yang cukup untuk menjawab pertanyaan tentang bagan dan diagram, dengan fallback hanya teks jika API gambar gagal.</li>
</ul>
