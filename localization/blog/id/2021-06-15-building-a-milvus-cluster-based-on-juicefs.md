...
<h3 id="Step-1-Launch-MySQL-service" class="common-anchor-header"><strong>Langkah 1: Meluncurkan layanan MySQL</strong></h3><p>Luncurkan layanan MySQL pada <strong>setiap</strong> node di dalam cluster. Untuk detailnya, lihat <a href="https://milvus.io/docs/v1.1.0/data_manage.md">Mengelola Metadata dengan MySQL</a>.</p>
