...
<button class="copy-code-btn"></button></code></pre>
<h3 id="LLM-and-embedding-model-setup" class="common-anchor-header">LLM dan penyiapan model penyematan</h3><p>Kita akan menggunakan GLM-5 sebagai LLM dan penyematan teks-3-kecil sebagai model penyematan:</p>
