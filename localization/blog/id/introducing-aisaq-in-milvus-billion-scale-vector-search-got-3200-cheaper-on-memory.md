...
<p>Pada dataset SIFT128D, AISAQ dapat menyamai performa DISKANN ketika semua data PQ dibuat sebaris sehingga data yang dibutuhkan setiap node dapat masuk seluruhnya ke dalam satu halaman SSD berukuran 4 KB (INLINE_PQ = 48). Dengan konfigurasi ini, setiap informasi yang dibutuhkan selama pencarian akan ditempatkan secara berurutan:</p>
<ul>
