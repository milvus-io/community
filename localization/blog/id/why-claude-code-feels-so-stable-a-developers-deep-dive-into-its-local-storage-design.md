...
<button class="copy-code-btn"></button></code></pre>
<p>Tata letak ini sengaja dibuat sederhana: semua yang dihasilkan oleh Claude Code berada di bawah satu direktori, diatur berdasarkan proyek dan sesi. Tidak ada status tersembunyi yang tersebar di sekitar sistem Anda, dan mudah untuk memeriksa atau membersihkannya bila perlu.</p>
...
<ul>
<li><p><strong>Pesan pengguna</strong> mewakili input baru yang masuk ke dalam sistem. Ini tidak hanya mencakup apa yang diketik pengguna, tetapi juga hasil yang dikembalikan oleh alat, seperti output dari perintah shell. Dari sudut pandang AI, keduanya merupakan masukan yang perlu ditanggapi.</p></li>
...
<p>Bersama-sama, jenis pesan ini tidak hanya merekam percakapan, tetapi juga seluruh rangkaian tindakan dan efek yang terjadi selama sesi.</p>
