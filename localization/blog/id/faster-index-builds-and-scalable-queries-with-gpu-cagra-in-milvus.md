...
<p>CAGRA dibangun di atas algoritma <strong>NN-Descent (Nearest Neighbor Descent)</strong>, yang membangun grafik k-nearest-neighbor (kNN) melalui penyempurnaan berulang. Dalam setiap iterasi, kandidat tetangga dievaluasi dan diperbarui, secara bertahap konvergen menuju hubungan ketetanggaan yang lebih berkualitas di seluruh kumpulan data.</p>
...
<h3 id="Understanding-adaptforcpu" class="common-anchor-header">Pemahaman <code translate="no">adapt_for_cpu</code></h3><p>Dalam Milvus, parameter <code translate="no">adapt_for_cpu</code> mengontrol bagaimana indeks CAGRA diserialisasikan ke disk selama pembuatan indeks dan bagaimana indeks tersebut diserialisasikan ke dalam memori pada waktu pemuatan. Dengan mengubah pengaturan ini pada saat membangun dan waktu pemuatan, Milvus dapat secara fleksibel beralih antara pembangunan indeks berbasis GPU dan eksekusi kueri berbasis CPU.</p>
