...
<h2 id="How-to-Evaluate-VectorDBs-with-Your-Custom-Datasets-with-VDBBench" class="common-anchor-header">Cara Mengevaluasi VectorDB dengan Dataset Kustom Anda dengan VDBBench<button data-href="#How-to-Evaluate-VectorDBs-with-Your-Custom-Datasets-with-VDBBench" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sebelum memulai, pastikan Anda sudah menginstal Python 3.11 atau lebih tinggi. Anda akan membutuhkan data vektor dalam format CSV atau NPY, sekitar 2-3 jam untuk penyiapan dan pengujian lengkap, dan pengetahuan Python tingkat menengah untuk pemecahan masalah jika diperlukan.</p>
...
<li><p><strong>File Label Skalar (scalar_labels.parquet</strong> ) bersifat opsional dan berisi label metadata yang terkait dengan vektor pelatihan, yang berguna untuk pengujian pencarian yang disaring.</p></li>
</ul>
...
<tr><td style="text-align:center">nama file label skalar</td><td style="text-align:center">(Opsional) Nama file label (tanpa ekstensi .parquet)</td><td style="text-align:center">Jika <code translate="no">scalar_labels.parquet</code> dibuat, isi <code translate="no">scalar_labels</code>, jika tidak, biarkan kosong</td></tr>
...
<h2 id="Supplemental-Tools-Test-Data-Generation" class="common-anchor-header">Alat Tambahan: Pembuatan Data Uji<button data-href="#Supplemental-Tools-Test-Data-Generation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk pengembangan dan skenario pengujian standar, Anda dapat menghasilkan set data sintetis dengan karakteristik yang terkontrol:</p>
