...
tag: Engineering
---
<custom-h1>DiskANN: Solusi ANNS Berbasis Disk dengan Recall dan QPS Tinggi pada Dataset Berskala Miliaran</custom-h1><blockquote>
...
<p>data_file.bin: File biner data asli. Dua bilangan bulat pertama dalam berkas tersebut masing-masing mewakili jumlah total n vektor kumpulan data dan dimensi vektor dim. N byte terakhir <em>dim</em> sizeof(data_type) adalah data vektor kontinu.</p>
<p>index_prefix_path: Awalan jalur dari file keluaran. Setelah indeks dibuat, beberapa berkas terkait indeks akan dibuat. Parameter ini adalah awalan umum dari direktori tempat berkas-berkas tersebut disimpan.</p>
...
<li>Secara global mengambil sampel secara seragam pada training set dengan tingkat pengambilan sampel 1500000 / n;</li>
...
<li>Tempatkan titik navigasi num_parts dari indeks Vamana ke dalam file titik tengah, yang akan digunakan saat mencari;</li>
