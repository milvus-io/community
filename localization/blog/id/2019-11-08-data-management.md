...
<p>Dan 'TableFiles' berisi nama tabel tempat file berada (table_id), tipe indeks file (engine_type), nama file (file_id), tipe file (file_type), ukuran file (file_size), jumlah baris (row_count), dan tanggal pembuatan file (created_on).</p>
<p>
