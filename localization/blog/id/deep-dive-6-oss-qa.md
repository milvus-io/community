...
<li><strong>Stabilitas</strong>: Periksa apakah Milvus dapat berjalan dengan stabil selama 5-10 hari di bawah tingkat beban kerja yang normal.</li>
...
<h3 id="Unit-test" class="common-anchor-header">Uji coba unit</h3><p>
...
<li>Ketika layanan Milvus sudah pulih (yang berarti semua pod sudah siap), buat pernyataan ketiga - semua operasi berhasil seperti yang diharapkan.</li>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Uji stabilitas dan kinerja</span> </span></p>
<ol>
