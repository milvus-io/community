...
<p>Jika kedua sistem ini membantu model untuk "mengingat", apa perbedaan yang sebenarnya?</p>
...
<ul>
<li><p><strong>Pembaruan implisit:</strong> Kadang-kadang model hanya memutuskan sesuatu sebagai preferensi atau fakta yang stabil dan secara diam-diam menuliskannya ke memori. Pembaruan ini tidak seketika; pembaruan ini muncul setelah beberapa kali, dan memori yang lebih lama dapat memudar jika percakapan yang terkait menghilang.</p></li>
...
<li><p>Debugging menjadi lebih sulit karena perilaku model bergantung pada pemicu alat yang tidak terlihat, bukan hanya input yang cepat.</p></li>
</ul>
...
<h3 id="Challenge-1-What-Is-Worth-Remembering" class="common-anchor-header">Tantangan 1: Apa yang Perlu Diingat?</h3><p>Tidak semua yang dilakukan pengguna harus disimpan di memori jangka panjang. Jika seseorang membuat file sementara dan menghapusnya lima menit kemudian, merekamnya selamanya tidak akan membantu siapa pun. Inilah kesulitan utamanya: <strong>bagaimana sistem memutuskan apa yang sebenarnya penting?</strong></p>
<p><strong>(1) Cara-cara umum untuk menilai kepentingan</strong></p>
...
<p>Memori waktu nyata menuntut latensi penulisan yang sangat rendah. Pada saat yang sama, pengambilan berkualitas tinggi bergantung pada indeks yang dibangun dengan baik, dan konstruksi indeks membutuhkan waktu. Membangun ulang indeks untuk setiap penulisan terlalu mahal, tetapi menunda pengindeksan berarti data yang baru ditulis untuk sementara waktu tidak dapat diambil. Pertukaran ini berada di pusat desain memori yang dapat ditulis.</p>
<p><strong>(3) Bagaimana Basis Data Vektor Membantu</strong></p>
