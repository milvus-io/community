...
<h2 id="Milvus-v225-NOT-RECOMMENDED" class="common-anchor-header">Milvus v2.2.5: TIDAK DIREKOMENDASIKAN<button data-href="#Milvus-v225-NOT-RECOMMENDED" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus v2.2.5 memiliki beberapa masalah kritis, dan oleh karena itu, kami tidak menyarankan untuk menggunakan rilis ini.  Kami mohon maaf atas ketidaknyamanan yang ditimbulkannya. Namun, masalah-masalah ini telah diatasi dalam Milvus v2.2.6.</p>
