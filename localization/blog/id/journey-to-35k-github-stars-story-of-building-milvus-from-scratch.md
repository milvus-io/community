...
<h2 id="Whats-Next-Vector-Data-Lake" class="common-anchor-header">Apa yang Berikutnya: Danau Data Vektor<button data-href="#Whats-Next-Vector-Data-Lake" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Kami menciptakan istilah &quot;<a href="https://zilliz.com/learn/what-is-vector-database">basis data vektor</a>&quot; dan menjadi yang pertama membangunnya, namun kami tidak berhenti sampai di situ. Kami sekarang membangun evolusi berikutnya: <strong>Vector Data Lake.</strong></p>
