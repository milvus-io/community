...
<p>Pada masanya, Word2Vec sangat revolusioner. Namun, ia memiliki dua keterbatasan yang signifikan. Pertama, pendekatan ini bersifat <strong>statis</strong>: setiap kata hanya memiliki satu vektor, sehingga "bank" memiliki arti yang sama, baik ketika kata tersebut berdekatan dengan "uang" atau "sungai". Kedua, ia hanya bekerja pada <strong>tingkat kata</strong>, meninggalkan kalimat dan dokumen di luar jangkauannya.</p>
