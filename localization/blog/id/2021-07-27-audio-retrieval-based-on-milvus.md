...
<li><strong>Musik:</strong> Suara vokal dan/atau instrumental yang digabungkan untuk menghasilkan komposisi yang terdiri dari melodi, harmoni, ritme, dan warna suara. Musik dapat diwakili oleh skor.</li>
...
<p>Dalam artikel ini, <a href="https://github.com/qiuqiangkong/audioset_tagging_cnn">jaringan syaraf tiruan audio yang telah dilatih sebelumnya dalam skala besar untuk pengenalan pola audio (PANN</a> ) digunakan untuk mengekstrak vektor fitur untuk akurasi rata-rata rata-rata (mAP) sebesar 0,439 (Hershey et al., 2017).</p>
