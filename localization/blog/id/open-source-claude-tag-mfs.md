...
title: 'Open Tag: Claude Tag Open-Source untuk Claude Code dan Codex'
author: Cheney Zhang
...
desc: >-
  Claude Tag sumber terbuka yang native Slack untuk Claude Code dan Codex,
  dibangun di atas MFS: satu antarmuka yang dapat dicari dan dijelajahi untuk
  kode, dokumen, tiket, dan basis data Anda.
