...
<h3 id="Step-3-Load-data" class="common-anchor-header">Langkah 3: Muat data</h3><p>Muatkan h_item embeddings film yang dihasilkan oleh model PinSage ke dalam Milvus, yang akan mengembalikan ID yang sesuai. Impor ID dan informasi film yang sesuai ke dalam MySQL.</p>
