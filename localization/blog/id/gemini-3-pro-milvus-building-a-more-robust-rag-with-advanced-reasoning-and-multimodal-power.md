...
<button class="copy-code-btn"></button></code></pre>
<h3 id="LLM-and-Embedding-Model-Setup" class="common-anchor-header">LLM dan Pengaturan Model Penyematan</h3><p>Untuk tutorial ini, kita akan menggunakan <code translate="no">gemini-3-pro-preview</code> sebagai LLM dan <code translate="no">text-embedding-004</code> sebagai model penyematan.</p>
