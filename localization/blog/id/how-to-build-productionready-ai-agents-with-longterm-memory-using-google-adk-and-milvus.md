...
<h2 id="ADK’s-Core-Design-Principles" class="common-anchor-header">Prinsip Desain Inti ADK<button data-href="#ADK’s-Core-Design-Principles" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
