...
<p>Jadi saya membuat agen dengan OpenClaw yang mengawasi pasar, bukan saya, dan menghentikan saya melakukan kesalahan yang sama. Agen ini tidak memperdagangkan atau menyentuh uang saya; agen ini mencegah saya melakukan sesuatu yang sudah saya sesali.</p>
...
<h2 id="Step-1-Get-Real-Time-Market-Intelligence-with-Exa" class="common-anchor-header">Langkah 1: Dapatkan Intelijen Pasar Waktu Nyata dengan Exa<button data-href="#Step-1-Get-Real-Time-Market-Intelligence-with-Exa" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sebelumnya, saya telah mencoba menjelajahi aplikasi keuangan, menulis scraper, dan mencari terminal data profesional. Aplikasi mengubur sinyal di bawah kebisingan, scraper terus-menerus rusak, dan API profesional berharga mahal untuk pedagang institusional. Exa adalah API pencarian yang dibuat untuk agen AI yang memecahkan masalah di atas.</p>
<p>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li><strong>Pemantauan berita waktu nyata.</strong> Selama jam pasar, saya membutuhkan berita terkini yang disaring hanya untuk hari ini.</li>
</ul>
...
<h2 id="Step-2-Store-Trading-History-in-Milvus-for-Smarter-Decisions" class="common-anchor-header">Langkah 2: Simpan Riwayat Perdagangan di Milvus untuk Keputusan yang Lebih Cerdas<button data-href="#Step-2-Store-Trading-History-in-Milvus-for-Smarter-Decisions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Exa memperbaiki masalah informasi saya. Namun saya masih mengulangi perdagangan yang sama - panic-selling selama penurunan yang pulih dalam beberapa hari, mengejar momentum ke dalam saham yang sudah terlalu mahal. Saya bertindak berdasarkan emosi, menyesalinya, dan melupakan pelajaran pada saat situasi yang sama terjadi.</p>
<p>Saya membutuhkan basis pengetahuan pribadi: perdagangan saya di masa lalu, alasan saya, kesalahan saya. Bukan sesuatu yang harus saya ulas secara manual (saya pernah mencobanya dan tidak pernah bisa mempertahankannya), tetapi sesuatu yang bisa dicari sendiri oleh agen setiap kali situasi serupa muncul. Jika saya akan mengulangi kesalahan, saya ingin agen memberi tahu saya sebelum saya menekan tombol. Mencocokkan "situasi saat ini" dengan "pengalaman masa lalu" adalah masalah pencarian kemiripan yang diselesaikan oleh basis data vektor, jadi semua data saya harus disimpan dalam satu tempat.</p>
<p>Saya menggunakan <a href="https://github.com/milvus-io/milvus-lite">Milvus Lite</a>, versi ringan dari Milvus yang berjalan secara lokal tanpa pengaturan server. Ini sempurna untuk membuat prototipe dan bereksperimen. Saya membagi data saya menjadi tiga koleksi. Dimensi penyematannya adalah 1536 agar sesuai dengan model penyematan teks-3-kecil dari OpenAI, yang dapat digunakan secara langsung:</p>
...
<p>Mencampur semua ini ke dalam satu koleksi akan berarti membengkak setiap permintaan dengan riwayat perdagangan yang tidak relevan atau kehilangan bias inti ketika mereka tidak cukup cocok dengan kueri saat ini.</p>
<p>Setelah koleksi tersebut ada, agen perlu mengisinya secara otomatis. Saya tidak ingin menulis catatan setelah setiap percakapan, jadi saya membuat ekstraktor memori yang berjalan di akhir setiap sesi obrolan.</p>
<p>Ia melakukan dua hal: mengekstrak dan menduplikasi. Pengekstrak meminta LLM untuk mengambil wawasan terstruktur dari percakapan - keputusan, preferensi, pola, pelajaran - dan merutekan setiap wawasan tersebut ke koleksi yang tepat. Sebelum menyimpan sesuatu, LLM akan memeriksa kemiripannya dengan apa yang sudah ada di sana. Jika sebuah wawasan baru memiliki kemiripan lebih dari 92% dengan entri yang sudah ada, maka wawasan tersebut akan dilewatkan.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Misalnya, ketika saham teknologi turun 3-4% karena ketegangan Timur Tengah pada awal Maret, agen menarik tiga hal: pelajaran dari Oktober 2024 tentang tidak melakukan panic-selling selama penurunan geopolitik, catatan preferensi bahwa saya cenderung kelebihan risiko geopolitik, dan pola yang saya catat bahwa aksi jual teknologi yang didorong oleh geopolitik biasanya pulih dalam satu hingga tiga minggu.</p>
<p>Rekan kerja saya menyebutnya sebagai "pembelajaran penguatan untuk investor ritel" di mana saya menjadi model yang dilatih untuk fungsi kerugian saya sendiri. Cukup adil. Setidaknya sekarang ada umpan balik antara apa yang saya lakukan dan apa yang akan saya lakukan.</p>
<h2 id="Step-3-Teach-Your-Agent-to-Analyze-with-OpenClaw-Skills" class="common-anchor-header">Langkah 3: Ajari Agen Anda untuk Menganalisis dengan Keterampilan OpenClaw<button data-href="#Step-3-Teach-Your-Agent-to-Analyze-with-OpenClaw-Skills" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pada titik ini, agen memiliki informasi yang baik<a href="https://exa.ai/">(Exa</a>) dan memori pribadi<a href="https://github.com/milvus-io/milvus-lite">(Milvus</a>). Tetapi jika Anda memberikan keduanya kepada LLM dan mengatakan "analisis ini," Anda akan mendapatkan respons yang generik dan bersifat lindung nilai. Ia menyebutkan setiap sudut pandang yang mungkin dan diakhiri dengan "investor harus mempertimbangkan risikonya," dengan kata lain, tidak ada.</p>
<p>Cara mengatasinya adalah dengan menulis kerangka analisis Anda sendiri dan memberikannya kepada agen sebagai instruksi eksplisit. Indikator mana yang Anda pedulikan, situasi mana yang Anda anggap berbahaya, kapan harus bersikap konservatif versus agresif. Aturan-aturan ini berbeda untuk setiap investor, jadi Anda harus menentukannya sendiri.</p>
...
<h2 id="Step-4-Start-Your-Agent-with-OpenClaw-Heartbeat" class="common-anchor-header">Langkah 4: Mulai Agen Anda dengan Detak Jantung OpenClaw<button data-href="#Step-4-Start-Your-Agent-with-OpenClaw-Heartbeat" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Semua hal di atas masih mengharuskan Anda untuk memicunya secara manual. Jika Anda harus membuka terminal setiap kali Anda ingin pembaruan, Anda kembali ke titik awal - mungkin Anda harus membuka aplikasi broker Anda selama rapat lagi.</p>
<p>Mekanisme Detak Jantung OpenClaw memperbaiki hal ini. Sebuah gateway melakukan ping ke agen setiap 30 menit (dapat dikonfigurasi), dan agen memeriksa file HEARTBEAT.md untuk memutuskan apa yang harus dilakukan pada saat itu. Ini adalah file markdown dengan aturan berbasis waktu:</p>
...
<ul>
<li><strong>Pengarahan singkat di pagi hari (pukul 07:00).</strong> Agen menjalankan Exa semalaman, menarik posisi saya dan riwayat yang relevan dari Milvus, dan mengirimkan ringkasan yang dipersonalisasi ke ponsel saya - kurang dari 500 kata. Apa yang terjadi dalam semalam, bagaimana hal itu berkaitan dengan kepemilikan saya, dan satu hingga tiga item tindakan. Saya membacanya sambil menyikat gigi.</li>
...
<p>Kualitas informasinya juga lebih baik. Saya membaca ringkasan dari Reuters dan Bloomberg, bukannya apa pun yang menjadi viral di Twitter. Dan dengan agen yang mengingatkan kesalahan saya di masa lalu setiap kali saya tergoda untuk bertindak, saya telah mengurangi perdagangan impulsif saya secara signifikan. Saya belum bisa membuktikan bahwa hal ini membuat saya menjadi investor yang lebih baik, tapi ini membuat saya tidak terlalu gegabah.</p>
<p>Total biaya: <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>10/bulan</mi><mn>untuk OpenClaw</mn></mrow><annotation encoding="application/x-tex">, 10/bulan untuk OpenClaw,</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">10/bulan</span><span class="mord">untuk OpenClaw</span><span class="mpunct">,</span></span></span></span>10/bulan untuk Exa, dan sedikit biaya listrik untuk menjaga Milvus Lite tetap berjalan.</p>
<h2 id="Conclusion" class="common-anchor-header">Kesimpulan<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Saya terus melakukan perdagangan impulsif yang sama karena informasi saya buruk, saya jarang meninjau sejarah saya sendiri, dan menatap pasar sepanjang hari membuatnya lebih buruk. Jadi saya membangun agen AI yang memecahkan masalah tersebut dengan melakukan tiga hal:</p>
<ul>
<li><strong>Mengumpulkan berita pasar yang dapat diandalkan secara otomatis</strong> <strong>menggunakan</strong> <strong><a href="https://exa.ai/">Exa</a></strong>, jadi saya memulai setiap pagi dengan pengarahan yang jelas, bukannya satu jam melakukan doomscrolling.</li>
<li><strong>Mengingat perdagangan saya di masa lalu dengan <a href="https://milvus.io/">Milvus</a> dan memperingatkan saya</strong> ketika saya akan mengulangi kesalahan, menggunakan Milvus sebagai basis data vektor pribadi.</li>
<li><strong>Berjalan dengan</strong> <strong>autopilot</strong> <strong><a href="https://milvus.io/blog/openclaw-formerly-clawdbot-moltbot-explained-a-complete-guide-to-the-autonomous-ai-agent.md">OpenClaw</a></strong> <strong>dan hanya melakukan ping kepada saya saat dibutuhkan</strong>, menggunakan OpenClaw Skills dan Heartbeat - tidak ada pekerjaan cron, tidak ada kode lem.</li>
</ul>
<p>Total biaya: $ 20/bulan. Agen tidak memperdagangkan atau menyentuh uang saya.</p>
<p>Perubahan terbesar bukanlah data atau peringatannya. Itu adalah bahwa saya berhenti mengamati pasar. Saya lupa sama sekali pada hari Rabu lalu, yang tidak pernah terjadi selama bertahun-tahun trading. Saya masih kehilangan uang kadang-kadang, tetapi jauh lebih jarang, dan saya benar-benar menikmati akhir pekan saya lagi. Rekan kerja saya belum memperbarui lelucon itu, tapi beri waktu.</p>
