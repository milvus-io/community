...
<h2 id="Custom-a-command" class="common-anchor-header">Menyesuaikan perintah<button data-href="#Custom-a-command" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">createCollection</span>(<span class="hljs-params">obj, collectionName, primaryField, autoId, description, fields</span>):
    <span class="hljs-keyword">pass</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-arguments" class="common-anchor-header">Menambahkan argumen</h3><p>Dalam proyek ini kita mengganti semua penggunaan argumen dengan penggunaan opsi. Tetapi kita masih memperkenalkan penggunaan argumen di sini. Berbeda dengan options, argumen digunakan seperti <code translate="no">cli COMMAND [OPTIONS] ARGUEMENTS</code>. Jika kita ubah contoh di atas menjadi penggunaan argumen, maka akan menjadi seperti ini:</p>
<pre><code translate="no" class="language-python"><span class="hljs-meta">@createDetails.command(<span class="hljs-params"><span class="hljs-string">&#x27;collection&#x27;</span></span>)</span>
