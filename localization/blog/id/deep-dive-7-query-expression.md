...
<p>Mekanisme walker adalah bagian yang sangat penting dalam alat ANTLR. Mekanisme ini dirancang untuk berjalan melalui semua pohon parsing untuk memeriksa apakah setiap node mematuhi aturan sintaksis, atau untuk mendeteksi kata-kata sensitif tertentu. Beberapa API yang relevan tercantum dalam gambar di bawah ini. Karena ANTLR dimulai dari simpul akar dan turun melalui setiap sub-simpul hingga ke bawah, maka tidak perlu membedakan urutan cara menelusuri pohon parsing.</p>
<p>
