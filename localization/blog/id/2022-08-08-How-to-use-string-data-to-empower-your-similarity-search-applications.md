...
<h2 id="Insert-data" class="common-anchor-header">Menyisipkan data<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah koleksi dibuat, kita dapat menyisipkan data ke dalamnya. Pada contoh berikut, kita memasukkan 2.000 baris data string yang dibuat secara acak.</p>
