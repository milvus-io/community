...
<p>Namun alur kerja saja tidak cukup. Agen juga membutuhkan <strong>memori jangka panjang</strong> agar dapat mengambil informasi yang berguna dari sesi sebelumnya. Di sinilah <a href="https://milvus.io/"><strong>Milvus</strong></a>, database vektor sumber terbuka, berperan. Dengan menyimpan embeddings dari percakapan, dokumen, dan hasil alat, Milvus memungkinkan agen untuk mencari dan mengingat kembali pengetahuan sebelumnya.</p>
...
<p>Berikut ini adalah cara utama yang dapat Anda gunakan untuk menyesuaikan Deep Agents:</p>
