...
<p><strong>Ketika pengguna mengucapkan maksud yang sama secara berbeda di seluruh sesi, FTS5 gagal mencocokkan.</strong> Learning Loop tidak berjalan. Tidak ada Skill baru yang ditulis, dan saat maksudnya muncul lagi, pengguna kembali ke perutean secara manual.</p>
...
<p>Sebagai contoh: tanyakan &quot;apa prinsip asinkronisasi&quot;, dan pencarian vektor akan mencari konten yang terkait secara semantik. Tanyakan &quot;di mana fungsi <code translate="no">find_similar_task</code> didefinisikan&quot;, dan BM25 secara tepat mencocokkan nama fungsi dalam kode. Untuk pertanyaan yang melibatkan fungsi di dalam jenis tugas tertentu, pencarian hybrid mengembalikan hasil yang tepat dalam satu kali pemanggilan, tanpa logika perutean yang ditulis tangan.</p>
