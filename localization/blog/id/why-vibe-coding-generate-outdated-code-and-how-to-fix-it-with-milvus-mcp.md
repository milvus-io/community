...
<p>Lebih buruk lagi, ketika saya meminta kode API OpenAI, Cursor menghasilkan cuplikan menggunakan <code translate="no">gpt-3.5-turbo</code>-model yang sekarang ditandai sebagai <em>Legacy</em> oleh OpenAI, dengan harga tiga kali lipat lebih mahal daripada penggantinya, namun memberikan hasil yang lebih rendah. Kode ini juga mengandalkan <code translate="no">openai.ChatCompletion</code>, sebuah API yang sudah tidak digunakan lagi pada Maret 2024.</p>
...
<p>Bagi pengembang Milvus, ini berarti tidak ada lagi debugging panggilan <code translate="no">connections.connect()</code> yang sudah usang atau bergulat dengan pola ORM yang sudah ketinggalan zaman. Tiga alat bantu - generator-kode-milvus, konverter-kode-klien-ORM, dan penerjemah-bahasa - menangani masalah yang paling umum secara otomatis.</p>
