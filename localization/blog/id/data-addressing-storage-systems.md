...
<p>Hasilnya: jumlah file turun lebih dari 10x lipat, pemanggilan API turun lebih dari 10x lipat, dan latensi kueri turun dari menit ke detik.</p>
...
<li><strong>Baca daftar manifes</strong> (1 I/O) - Terapkan filter <a href="https://milvus.io/docs/use-partition-key.md">tingkat partisi</a> untuk melewatkan seluruh partisi (mis., semua data 2023 dihilangkan)</li>
...
<tr><td>HDFS</td><td>Jalur → blok → DataNode</td><td>HashMaps dalam memori + penghitungan blok</td><td>1 RPC + pembacaan blok N</td></tr>
