...
<h3 id="1-Install-Minikube" class="common-anchor-header">1. Menginstal Minikube</h3><p>Kunjungi<a href="https://github.com/kubernetes/minikube/releases"> laman rilis minikube</a> dan unduh versi yang sesuai untuk sistem operasi Anda. Untuk macOS/Linux, Anda dapat menggunakan perintah berikut:</p>
...
<h3 id="1-Check-Installed-StorageClasses" class="common-anchor-header">1. Memeriksa StorageClass yang Terinstal</h3><p>Untuk melihat StorageClass yang tersedia di cluster Kubernetes Anda, jalankan perintah berikut:</p>
...
<p>Skrip ini membuat koneksi ke kluster Milvus dan membuat koleksi, yang berfungsi sebagai titik awal untuk operasi yang lebih kompleks seperti menyisipkan vektor dan melakukan pencarian kemiripan.</p>
