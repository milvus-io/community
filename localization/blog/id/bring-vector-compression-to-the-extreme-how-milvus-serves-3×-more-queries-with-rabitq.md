...
<p>Terinspirasi oleh sifat ruang dimensi tinggi ini, <strong>RaBitQ berfokus pada pengkodean informasi sudut daripada koordinat spasial yang tepat.</strong> Hal ini dilakukan dengan menormalkan setiap vektor data relatif terhadap titik referensi seperti titik pusat dataset. Setiap vektor kemudian dipetakan ke titik terdekat pada hypercube, memungkinkan representasi hanya dengan 1 bit per dimensi. Pendekatan ini secara alami meluas ke <code translate="no">IVF_RABITQ</code>, di mana normalisasi dilakukan relatif terhadap centroid cluster terdekat, sehingga meningkatkan akurasi penyandian lokal.</p>
<p>
  <span class="img-wrapper">
...
<p>RaBitQ juga sangat kompatibel dengan teknik pengoptimalan lainnya, seperti<a href="https://www.vldb.org/pvldb/vol9/p288-andre.pdf"> FastScan</a> dan<a href="https://github.com/facebookresearch/faiss/wiki/Pre--and-post-processing"> preprocessing rotasi acak</a>. Selain itu, RaBitQ <strong>ringan untuk dilatih dan cepat untuk dieksekusi</strong>. Pelatihan hanya melibatkan penentuan tanda setiap komponen vektor, dan pencarian dipercepat melalui operasi bitwise cepat yang didukung oleh CPU modern. Bersama-sama, pengoptimalan ini memungkinkan RaBitQ untuk menghasilkan pencarian berkecepatan tinggi dengan kehilangan akurasi yang minimal.</p>
