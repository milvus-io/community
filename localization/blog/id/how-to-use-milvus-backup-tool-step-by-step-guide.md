...
<h2 id="Conclusion" class="common-anchor-header">Kesimpulan<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Alat Pencadangan <a href="https://milvus.io/docs/milvus_backup_overview.md"><strong>Milvus</strong></a> menyediakan solusi yang tangguh untuk mencadangkan dan memulihkan koleksi di dalam dan di seluruh instance Milvus. Baik Anda mengelola backup dalam satu instance, antar instance dalam layanan S3 yang sama, atau di seluruh layanan S3 yang berbeda, milvus-backup menangani semuanya dengan fleksibilitas dan presisi.</p>
<h3 id="Key-Takeaways" class="common-anchor-header">Hal-hal penting yang dapat diambil dari milvus-backup</h3><ol>
