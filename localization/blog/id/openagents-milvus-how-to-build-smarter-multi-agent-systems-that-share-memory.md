...
<ul>
<li><p>mengingat kembali keputusan atau rencana sebelumnya,</p></li>
...
<h4 id="3-Multi-Tenant-Isolation" class="common-anchor-header"><strong>3. Isolasi Multi-Penyewa</strong></h4><p>Milvus menyediakan isolasi multi-tenant secara granular melalui <strong>Partition Key</strong>, sebuah mekanisme partisi ringan yang menyegmentasikan memori di dalam satu koleksi. Hal ini memungkinkan:</p>
<ul>
...
<h3 id="2-Environment-Variables" class="common-anchor-header">2. Variabel Lingkungan</h3><p>Berikut ini adalah template untuk konfigurasi lingkungan Anda:</p>
