...
---
<p>Sebagian besar aplikasi AI mengandalkan satu model untuk setiap permintaan. Tetapi pendekatan itu dengan cepat mengalami keterbatasan. Model besar sangat kuat namun mahal, bahkan ketika digunakan untuk kueri sederhana. Model yang lebih kecil lebih murah dan lebih cepat, namun tidak dapat menangani penalaran yang rumit. Ketika lalu lintas melonjak-katakanlah aplikasi AI Anda tiba-tiba menjadi viral dengan sepuluh juta pengguna dalam semalam-inefisiensi pengaturan satu model untuk semua ini menjadi sangat jelas. Latensi melonjak, tagihan GPU meledak, dan model yang berjalan dengan baik kemarin mulai terengah-engah.</p>
