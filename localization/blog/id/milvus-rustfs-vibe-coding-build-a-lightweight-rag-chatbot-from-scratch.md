...
collection.flush()
<button class="copy-code-btn"></button></code></pre>
<p>Setelah penyisipan selesai, Anda dapat memverifikasi koleksi di Attu di <ip>:8000 - Anda akan melihat docs_collection yang terdaftar di bawah Collections.</p>
<p>
...
<p>Semua kode dari build ini ada di <a href="https://github.com/majinghe/chatbot"></a> github<a href="https://github.com/majinghe/chatbot">.com/majinghe/chatbot</a>. Jika Anda ingin mencoba <a href="http://milvus.io">Milvus</a> sendiri, <a href="https://milvus.io/docs/quickstart.md">quickstart</a> adalah tempat yang baik untuk memulai. Jika Anda ingin membicarakan apa yang sedang Anda bangun atau menemukan sesuatu yang tidak terduga, datang dan temui kami di <a href="https://milvus.io/slack">Milvus Slack</a>. Jika Anda lebih suka melakukan percakapan khusus, Anda juga dapat <a href="https://meetings.hubspot.com/chloe-williams1/milvus-meeting">memesan slot pada jam kerja</a>.</p>
