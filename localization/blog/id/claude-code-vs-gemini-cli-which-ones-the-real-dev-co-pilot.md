...
<ol>
<li><strong>Mulailah dengan pemahaman arsitektur:</strong> Ketika mendekati proyek baru, mintalah Claude Code untuk membantu Anda memahami keseluruhan struktur terlebih dahulu menggunakan bahasa alami.</li>
</ol>
...
<button class="copy-code-btn"></button></code></pre>
<ol start="3">
<li><strong>Jelajahi integrasi alat:</strong> Gemini CLI dapat berintegrasi dengan beberapa alat dan server MCP untuk fungsionalitas yang lebih baik.</li>
</ol>
