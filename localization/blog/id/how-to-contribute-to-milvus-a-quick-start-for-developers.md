...
<li><p><strong>Milvus Distributed</strong> adalah mode terdistribusi Milvus, yang ideal untuk pengguna perusahaan yang membangun sistem basis data vektor berskala besar atau platform data vektor.</p></li>
</ul>
