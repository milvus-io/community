...
<p>Dengan mengintegrasikan Milvus 2.6.8 sebagai tulang punggung vektor, pengambilan menjadi lapisan khusus tingkat produksi yang beroperasi secara independen dari visualisasi. Milvus menangani penyimpanan vektor, pengindeksan, dan pencarian. Project_Golem berfokus pada rendering - menggunakan ID dokumen dari Milvus dan menyorotnya dalam tampilan 3D.</p>
...
<ul>
<li>UMAP menghasilkan koordinat 3D selama proses pemasukan data (n_neighbors = 30, min_dist = 0.1).</li>
