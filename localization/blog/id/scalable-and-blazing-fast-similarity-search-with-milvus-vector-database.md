...
<p>Basis data vektor adalah platform data yang dapat diskalakan untuk menyimpan, mengindeks, dan melakukan kueri di seluruh vektor penyisipan yang dihasilkan dari data tidak terstruktur (gambar, teks, dll.) dengan menggunakan model pembelajaran yang mendalam.</p>
