...
---
<custom-h1>Memperkenalkan Alat Migrasi Data Milvus</custom-h1><p><em><strong>Catatan Penting</strong>: Alat Migrasi Data Mivus sudah tidak digunakan lagi. Untuk migrasi data dari basis data lain ke Milvus, kami sarankan Anda menggunakan layanan transportasi vektor (VTS) yang lebih canggih.</em></p>
<p><strong>Untuk informasi lebih lanjut, lihat <a href="https://zilliz.com/vector-transport-service">halaman arahan Vector Transport Service</a> atau <a href="https://github.com/zilliztech/vts">repositori GitHub</a>.</strong></p>
<p>VTS saat ini mendukung migrasi dari:</p>
<ul>
<li>Pinecone</li>
<li>Qdrant</li>
<li>Elasticsearch</li>
...
<li>OpenSearch</li>
<li>Faiss</li>
<li>Milvus 1.x hingga Milvus 2.x</li>
<li>Milvus 2.3.x ke Milvus 2.3.x atau lebih tinggi</li>
</ul>
...
<li><p><strong>read_data.py</strong>: Membaca file data HDF5 pada drive lokal Anda. (Tambahkan kode Anda di sini untuk mendukung pembacaan file data dalam format lain).</p></li>
