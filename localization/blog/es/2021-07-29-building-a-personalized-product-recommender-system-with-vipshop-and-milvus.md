...
<p>La información sobre los productos, la intención de búsqueda de los usuarios y sus preferencias son datos no estructurados. Intentamos calcular la similitud de estos datos utilizando CosineSimilarity(7.x) del motor de búsqueda Elasticsearch (ES), pero este método presenta los siguientes inconvenientes.</p>
<ul>
