...
title: >-
  Configurar Milvus en Google Colaboratory para facilitar la creación de
  aplicaciones ML
author: milvus
date: 2020-12-23T10:30:58.020Z
desc: >-
  Google Colab hace que desarrollar y probar aplicaciones de aprendizaje
  automático sea pan comido. Aprende a configurar Milvus en Colab para una mejor
  gestión de datos vectoriales a escala masiva.
