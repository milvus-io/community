...
<li>Servicio de metadatos: Todos los nodos Milvus utilizan este servicio para compartir metadatos. Actualmente, sólo se admite MySQL. Este servicio requiere una solución MySQL de alta disponibilidad.</li>
</ul>
...
<h2 id="Summary" class="common-anchor-header">Resumen<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Como middleware de servicios, Mishards integra el descubrimiento de servicios, la solicitud de enrutamiento, la fusión de resultados y el rastreo. También se proporciona expansión basada en plugins. Actualmente, las soluciones distribuidas basadas en Mishards siguen presentando los siguientes inconvenientes:</p>
<ul>
