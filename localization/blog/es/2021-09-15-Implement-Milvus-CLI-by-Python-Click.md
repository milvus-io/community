...
<h3 id="Add-choices" class="common-anchor-header">Añadir opciones</h3><p>A veces queremos que el usuario sólo introduzca un rango/tipo de valor limitado, podemos añadir <code translate="no">type=click.Choice([&lt;any&gt;])</code> a <code translate="no">click.prompt</code>, <code translate="no">click.options</code> y etc...</p>
<p>Por ejemplo,</p>
