...
<h2 id="How-a-Typical-RAG-Pipeline-Works" class="common-anchor-header">Cómo funciona una canalización RAG típica<button data-href="#How-a-Typical-RAG-Pipeline-Works" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Max–Min-Semantic-Chunking-Embed-First-Chunk-Second" class="common-anchor-header">Fragmentación semántica Max-Min: Incrustar primero, trocear después<button data-href="#Max–Min-Semantic-Chunking-Embed-First-Chunk-Second" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>
   ...
   </span> <span class="img-wrapper"> <span>Ejemplo que muestra la fragmentación del contexto en las Notas de Publicación de Milvus 2.4.13 con el identificador de versión y la lista de características en trozos separados</span> </span></li>
</ul>
