...
<h3 id="Setting-Up-K8s" class="common-anchor-header">Configuración de K8s</h3><p>Después de instalar todo lo necesario para ejecutar un clúster K8s, y si ha utilizado <code translate="no">minikube</code>, inicie su clúster con:</p>
