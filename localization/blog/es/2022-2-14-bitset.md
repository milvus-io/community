...
<h3 id="Case-two" class="common-anchor-header">Caso dos</h3><p>Supongamos que el valor que el usuario establece para <code translate="no">time_travel</code> es 250. En otras palabras, el usuario realiza una consulta sobre los datos almacenados en Milvus cuando <code translate="no">ts</code> = 250. La figura 2 ilustra el proceso de generación del conjunto de bits.</p>
