...
<h2 id="Installation" class="common-anchor-header">Instalación<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Puede instalar Milvus_CLI en línea o sin conexión.</p>
...
<p>Si está utilizando un Mac con el chip M1 o un PC sin un entorno Python, puede optar por utilizar una aplicación portátil en su lugar. Para ello, <a href="https://github.com/milvus-io/milvus_cli/releases">descargue</a> un archivo en la página de versiones correspondiente a su sistema operativo, ejecute <code translate="no">chmod +x</code> en el archivo para hacerlo ejecutable y ejecute <code translate="no">./</code> en el archivo para ejecutarlo.</p>
