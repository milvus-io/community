...
<h4 id="Reflection" class="common-anchor-header">Reflexión</h4><p>A diferencia de la entrada anterior, DeepSearcher ilustra una verdadera forma de reflexión agéntica, introduciendo los resultados anteriores como contexto en una pregunta que "reflexiona" sobre si las preguntas formuladas hasta el momento y los trozos recuperados relevantes contienen alguna laguna informativa. Se trata de una etapa de análisis.</p>
