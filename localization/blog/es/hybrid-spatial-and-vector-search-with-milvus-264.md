...
<p>Milvus 2.6.4 resuelve esto añadiendo soporte de geometría espacial directamente a la base de datos vectorial. La búsqueda semántica y el filtrado por localización se ejecutan ahora en la misma consulta. Con todo en un mismo sistema, la búsqueda híbrida es más rápida y fácil de gestionar.</p>
