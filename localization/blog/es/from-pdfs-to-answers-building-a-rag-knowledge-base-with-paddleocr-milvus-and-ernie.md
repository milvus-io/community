...
<li><strong>Reordenación.</strong> Un reordenador transparente basado en reglas puntúa cada fragmento en función de la concordancia difusa, la cobertura de palabras clave, la similitud semántica, la longitud y la detección de sustantivos propios; no se necesitan datos de entrenamiento y cada puntuación es depurable.</li>
