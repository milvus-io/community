...
<p>En este artículo, se utilizan <a href="https://github.com/qiuqiangkong/audioset_tagging_cnn">redes neuronales de audio preentrenadas a gran escala para el reconocimiento de patrones de audio (PANN)</a> para extraer vectores de características por su precisión media media (mAP) de 0,439 (Hershey et al., 2017).</p>
