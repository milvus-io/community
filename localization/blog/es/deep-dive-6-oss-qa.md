...
<p>La garantía de calidad (GC) es un proceso sistemático para determinar si un producto o servicio cumple determinados requisitos. Un sistema de GC es una parte indispensable del proceso de I+D porque, como su nombre indica, garantiza la calidad del producto.</p>
