...
<p>El SDK/API actualizado se centra en mejorar la experiencia de los desarrolladores mediante interfaces más intuitivas y una mejor integración con la documentación. Creemos que notará estas mejoras cuando trabaje con la serie 2.5.x.</p>
