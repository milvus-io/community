...
<p>y tenga una instancia en ejecución de Milvus Standalone (por ejemplo, en su máquina local) siguiendo las <a href="https://milvus.io/docs/prerequisite-docker.md">instrucciones de instalación de la documentación de Milvus</a>.</p>
...
<h2 id="Summary" class="common-anchor-header">Resumen<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ahora dispone de todos los conocimientos necesarios para realizar búsquedas de texto completo e híbridas semánticas/de texto completo con Milvus 2.5. Consulte los siguientes artículos para obtener más información sobre cómo funciona la búsqueda de texto completo y por qué es complementaria a la búsqueda semántica:</p>
<ul>
