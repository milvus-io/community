...
title: >-
  Más allá de =~: Cómo Milvus 3.0 convierte las expresiones regulares en un
  filtro nativo de base de datos
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  Milvus 3.0 traslada las expresiones regulares del posprocesamiento del lado de
  la aplicación a la ruta de consulta de la base de datos, donde pueden
  combinarse con la búsqueda vectorial, la búsqueda de texto completo, los
  filtros escalares y la ejecución indexada.
