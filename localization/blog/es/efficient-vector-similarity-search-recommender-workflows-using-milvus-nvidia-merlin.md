...
<li><p>Utiliza la GPU para acelerar los cálculos de indexación de bases de datos vectoriales y búsqueda de RNA con tecnologías como <a href="https://github.com/rapidsai/raft">RAPIDS RAFT</a>.</p></li>
</ul>
<p>
  <span class="img-wrapper">
...
<p>Para terminar, nos gustaría dar las gracias a todos los miembros de los equipos de Zilliz/Milvus y Merlin y de RAFT que han contribuido a la elaboración de este trabajo y de la entrada del blog. Esperamos tener noticias suyas si tiene la oportunidad de implantar Merlin y Milvus en sus recsys u otros flujos de trabajo.</p>
