...
desc: >-
  En Milvus v0.7.0 hemos creado un diseño completamente nuevo para que el
  borrado sea más eficiente y admita más tipos de índices.
cover: assets.zilliz.com/header_c9b45e546c.png
tag: Engineering
canonicalUrl: 'https://zilliz.com/blog/deleting-data-in-milvus'
---
<custom-h1>Cómo Milvus realiza la función de borrado</custom-h1><p>Este artículo trata de cómo Milvus implementa la función de borrado. Como una característica muy esperada por muchos usuarios, la función de borrado fue introducida en Milvus v0.7.0. No llamamos remove_ids en FAISS directamente, en su lugar, se nos ocurrió un nuevo diseño para hacer la eliminación más eficiente y soportar más tipos de índices.</p>
