...
<p>Un sistema de memoria grabable tiene que resolver tres problemas reales:</p>
<ol>
...
<li><p><strong>Cómo almacenar y ordenar la memoria:</strong> No toda la memoria es igual. Los elementos recientes, los hechos a largo plazo y las notas efímeras necesitan diferentes niveles de almacenamiento, políticas de retención y estrategias de indexación.</p></li>
...
<p>A medida que los agentes de larga duración vayan madurando, es probable que sus arquitecturas converjan en este diseño híbrido. Cowork es un claro indicio de hacia dónde se dirigen las cosas, no hacia un mundo sin RAG, sino hacia agentes con pilas de memoria más ricas alimentadas por bases de datos vectoriales.</p>
