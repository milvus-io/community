...
<p>En los hiperparámetros anteriores, L representa el número de capas de la red (es decir, el número de bloques Transformer), A representa el número de autoatención en Atención Multicabezal, y el tamaño del filtro es 4H.</p>
<p><br/></p>
