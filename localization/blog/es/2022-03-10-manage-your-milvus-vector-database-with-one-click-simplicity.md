...
<p style="font-size: 12px;color: #4c5a67">Pulse <a href="https://zilliz.com/blog/manage-your-milvus-vector-database-with-one-click-simplicity">aquí</a> para consultar el post original.</p> 
...
<p>Haga clic en cada nodo para acceder a la <strong>vista de lista de nodos</strong>. Puede comprobar todos los nodos hijos de un nodo coord. Mediante la ordenación, puede identificar rápidamente los nodos con un uso elevado de CPU o memoria, y localizar el problema del sistema.</p>
<p>
...
<p>Esperamos sinceramente que Attu pueda ofrecerle una mejor experiencia de usuario con Milvus. Y si le gusta Attu, o tiene alguna opinión sobre el uso, puede completar esta <a href="https://wenjuan.feishu.cn/m/cfm?t=suw4QnODU1ui-ok7r">Encuesta de Usuario Attu</a> para ayudarnos a optimizar Attu para una mejor experiencia de usuario.</p>
