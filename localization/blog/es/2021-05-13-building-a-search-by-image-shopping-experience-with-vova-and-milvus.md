...
<p>Como muestra la siguiente ilustración, una imagen de entrada de 448 × 448 es convertida por varias capas convolucionales y capas de agrupación en un tensor de 7 × 7 × 1024 dimensiones (representado en el antepenúltimo cubo), y luego es convertida por dos capas totalmente conectadas en un tensor de salida de 7 × 7 × 30 dimensiones.</p>
