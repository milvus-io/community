...
<h2 id="What-We’ll-Build" class="common-anchor-header">Qué construiremos<button data-href="#What-We’ll-Build" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Estamos construyendo un chatbot inteligente combinando las capacidades de razonamiento de Kimi K2 con el rendimiento de la base de datos vectorial de Milvus. El sistema gestiona tres flujos de trabajo básicos que los ingenieros necesitan realmente:</p>
<ol>
