...
<p>Por eso considero que <strong>la ingeniería del contexto</strong> es el siguiente paso fundamental. En lugar de intentar eliminar todas las alucinaciones, deberíamos centrarnos en <em>dirigirlas</em>. Diseñando el contexto adecuado, podemos encontrar un equilibrio: mantener los modelos lo bastante imaginativos como para explorar nuevos terrenos y, al mismo tiempo, garantizar que permanezcan lo bastante anclados como para que se pueda confiar en ellos.</p>
...
<h2 id="Milvus-+-Loon-Purpose-Built-Data-Infrastructure-for-AI" class="common-anchor-header">Milvus + Loon: Infraestructura de datos creada específicamente para la IA<button data-href="#Milvus-+-Loon-Purpose-Built-Data-Infrastructure-for-AI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
