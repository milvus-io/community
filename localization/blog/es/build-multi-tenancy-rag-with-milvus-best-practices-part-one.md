...
<h2 id="Example-Multi-Tenancy-Strategy-for-a-RAG-Powered-Enterprise-Knowledge-Base" class="common-anchor-header">Ejemplo: Estrategia multiarrendamiento para una base de conocimiento empresarial potenciada por RAG<button data-href="#Example-Multi-Tenancy-Strategy-for-a-RAG-Powered-Enterprise-Knowledge-Base" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>En estos sistemas, los usuarios finales suelen interactuar con la base de conocimientos en modo de sólo lectura a través de los LLM. Sin embargo, las organizaciones siguen necesitando hacer un seguimiento de los datos de preguntas y respuestas generados por los usuarios y vincularlos a usuarios específicos para diversos fines, como mejorar la precisión de la base de conocimientos u ofrecer servicios personalizados.</p>
