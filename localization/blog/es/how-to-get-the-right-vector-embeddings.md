...
<p>La dimensionalidad de un vector incrustado equivale al tamaño de la penúltima capa del modelo y, por tanto, es intercambiable con el tamaño o la longitud del vector. Las dimensiones de vector más comunes son 384 (generado por Sentence Transformers Mini-LM), 768 (por Sentence Transformers MPNet), 1.536 (por OpenAI) y 2.048 (por ResNet-50).</p>
