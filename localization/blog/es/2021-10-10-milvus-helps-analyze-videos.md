...
<h3 id="Implementation" class="common-anchor-header">Implementación</h3><p>Para detectar y reconocer objetos en un vídeo, el sistema primero debe extraer fotogramas de un vídeo y detectar objetos en las imágenes de fotogramas utilizando la detección de objetos, en segundo lugar, extraer vectores de características de los objetos detectados y, por último, analizar el objeto en función de los vectores de características.</p>
<ul>
