...
Paso 2: Clonar el Proyecto</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Implement-the-Pipeline" class="common-anchor-header">Paso 3: Implementar el Pipeline</h3><p><strong>Integrar la base de datos vectorial Milvus</strong></p>
...
<p><strong>¿Listo para simplificar su desarrollo de RAG?</strong> Pruebe UltraRAG v2 con Milvus. Explore la canalización de ejemplo, ejecútela usted mismo y cree un flujo de trabajo RAG completo con sólo unas pocas líneas de configuración.</p>
