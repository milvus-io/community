...
<h2 id="Milvus-the-vector-search-engine" class="common-anchor-header">Milvus, el motor de búsqueda vectorial<button data-href="#Milvus-the-vector-search-engine" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Extraer vectores de características de una imagen no es suficiente. También necesitamos gestionar dinámicamente estos vectores de características (adición, eliminación y actualización), calcular la similitud de los vectores y devolver los datos de los vectores en el rango de vecinos más cercanos. El motor de búsqueda de vectores de código abierto Milvus realiza estas tareas bastante bien.</p>
