...
<h3 id="milvusproto" class="common-anchor-header">milvus.proto</h3><p><code translate="no">milvus.proto</code> 是 Milvus 通訊協定 API 的重要元件，因為它定義了<code translate="no">MilvusService</code> ，而 進一步定義了 Milvus 的所有 RPC 介面。</p>
...
<h3 id="commonproto" class="common-anchor-header">common.proto</h3><p><code translate="no">common.proto</code> 定義了常見的資訊類型，包括<code translate="no">ErrorCode</code>, 和<code translate="no">Status</code> 。</p>
<p>
...
<p>如果您深入源代碼並仔細觀察，您會發現當像<code translate="no">create_index</code> 之類的介面被呼叫時，它們實際上呼叫了多個 RPC 介面，例如<code translate="no">describe_collection</code> 和<code translate="no">describe_index</code> 。Milvus 的許多外向介面都是多個 RPC 介面的組合。</p>
