...
<h2 id="Installation" class="common-anchor-header">安裝<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以在<a href="https://github.com/zilliztech/attu/releases">GitHub</a> 找到最新的 Attu 版本。Attu 提供適用於不同作業系統的可執行安裝程式。它是一個開放原始碼的專案，歡迎大家貢獻心力。</p>
<p>
...
<p><code translate="no">attu IP</code> 是 Attu 執行環境的 IP 位址，而<code translate="no">milvus server IP</code> 是 Milvus 執行環境的 IP 位址。</p>
...
<p><strong>總覽頁</strong>面會顯示載入的集合。而<strong>Collection</strong>頁面則列出所有的集合，並顯示它們是否已載入或釋放。</p>
<p>
...
<p>您可以在向量<strong>搜尋頁</strong>面執行向量相似性搜尋。</p>
<p>
...
<p>我們衷心希望 Attu 能帶給您更好的 Milvus 使用經驗。如果您喜歡Attu，或對使用有任何意見，您可以填寫這份<a href="https://wenjuan.feishu.cn/m/cfm?t=suw4QnODU1ui-ok7r">Attu用戶調查問卷</a>，幫助我們優化Attu，以獲得更好的用戶體驗。</p>
