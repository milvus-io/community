...
<h2 id="What-is-the-Milvus-Operator" class="common-anchor-header">Milvus Operator 是什麼？<button data-href="#What-is-the-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://milvus.io/docs/install_cluster-milvusoperator.md"><strong>Milvus Operator</strong></a>是 Kubernetes 原生管理工具，可自動化 Milvus 向量資料庫部署的完整生命週期。它以 Kubernetes Operator 模式為基礎，將多年來有關在生產中運行 Milvus 的作業知識濃縮，並將這些專業知識編成軟體，與您的叢集一起運行。</p>
...
<p>基礎結構的未來是智慧型、自動化且開發人員友善的。<strong>Milvus Operator 將這個未來帶到您的資料庫層，就是今天。</strong></p>
<hr>
