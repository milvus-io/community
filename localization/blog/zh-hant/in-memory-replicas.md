...
desc: 使用記憶體內複製以提高讀取吞吐量和硬體資源的利用率。
...
<h3 id="Streaming-replica" class="common-anchor-header">串流複製</h3><p>串流複製包含來自相同 DML 通道的所有<a href="https://milvus.io/docs/v2.1.x/glossary.md#Segment">成長區段</a>。技術上來說，一個串流複製應該只由一個複製中的一個查詢節點提供服務。</p>
...
<li><a href="https://milvus.io/blog/in-memory-replicas.md">使用記憶體內複製提高向量資料庫的讀取吞吐量</a></li>
