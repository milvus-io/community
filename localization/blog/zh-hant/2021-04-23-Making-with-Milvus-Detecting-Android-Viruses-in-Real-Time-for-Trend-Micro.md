...
<h4 id="Milvus-bests-the-competition" class="common-anchor-header">Milvus 勝過競爭對手</h4><p>我們從上述各種向量相似性搜尋解決方案中，編譯了許多不同的測試結果。從以下的比較表中我們可以看到，儘管測試的資料集有 10 億個 128 維向量，但 Milvus 的速度明顯快於競爭對手。</p>
<table>
<thead>
...
<p><br/></p>
<h3 id="System-Performance" class="common-anchor-header">系統效能</h3><p>建立在 Milvus 上的 ThashSearch 服務已推出數月。下圖顯示端對端查詢延遲小於 95 毫秒。</p>
<p>
