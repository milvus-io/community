...
<h3 id="3-Import-to-Milvus-and-PostgreSQL" class="common-anchor-header">3.匯入 Milvus 和 PostgreSQL</h3><p>將產生的特徵向量匯入到 Milvus，再將 Milvus 傳回的 ID 和對應的答案匯入 PostgreSQL。以下為 PostgreSQL 中的表結構：</p>
<p>
