...
<li><strong>輕量級工作流程協調：</strong>內建的 MCP Client 會執行管道，讓工作流程行為與底層實作完全解耦。傳統的 RAG 系統通常需要編輯核心程式碼才能新增功能，而 UltraRAG v2 則採用類似微服務的模式，新的模組可以獨立部署，就像安裝外掛一樣。</li>
</ul>
<p>
...
<h3 id="Step-2-Clone-the-Project" class="common-anchor-header">步驟 2：克隆專案</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
...
<p>將 Milvus 整合到此工作流程中，還可增加另一項優勢：高性能、生產就緒的向量資料庫，專為可擴充的語意檢索而設計。Milvus 和 UltraRAG v2 結合起來，可以更輕鬆地快速建立原型、自信地進行迭代，以及部署能夠處理實際工作負載的 RAG 系統。</p>
