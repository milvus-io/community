...
步驟 2：複製專案</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Implement-the-Pipeline" class="common-anchor-header">步驟 3：執行管道</h3><p><strong>整合 Milvus 向量資料庫</strong></p>
...
<h2 id="Conclusion" class="common-anchor-header">結論<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>建立一個傳統的 RAG 管道通常需要編寫數百甚至上千行的程式碼。UltraRAG v2 採用了非常不同的方法。藉由其基於 MCP 的模組化設計、宣告式 YAML 設定以及輕量級的協調模型，您只需要幾十行就能建立相同的端對端管道。此外，YAML 用來描述工作流程的步驟，您不需要真正寫程式碼。這使得將企業級的 RAG 融入實際應用程式變得更加容易。</p>
