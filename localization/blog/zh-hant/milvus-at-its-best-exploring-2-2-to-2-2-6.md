...
<ul>
<li><p><strong>滾動升級</strong>：此功能允許 Milvus 在升級過程中回應傳入的請求，這在以前的版本中是不可能實現的。滾動升級可確保系統即使在升級過程中也能保持可用，並對使用者的要求作出回應。</p></li>
...
<h2 id="Summary" class="common-anchor-header">總結<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>總的來說，Milvus 從 v2.2 到 v2.2.6 的最新版本提供了許多令人振奮的更新和改進。從新功能到錯誤修復和優化，Milvus 繼續履行其承諾，提供最先進的解決方案，並賦予應用程序在不同領域的能力。請持續關注 Milvus 社群提供的更多令人振奮的更新和創新。</p>
