...
title: 如何將您的資料無縫遷移至 Milvus：全面指南
author: Wenhui Zhang
...
<p><strong>注意：</strong>我們將簡化這一步驟，讓用戶很快就能只使用一個命令完成遷移。敬請期待。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>遷移完成後，在 Milvus 2.x 中產生的集合將包含兩個欄位：<code translate="no">id</code> 和<code translate="no">data</code> 。您可以使用多合一向量資料庫管理工具<a href="https://zilliz.com/attu">Attu</a> 檢視更多細節。</p>
...
<h2 id="Stay-tuned-for-future-migration-plans" class="common-anchor-header">敬請期待未來的遷移計劃<button data-href="#Stay-tuned-for-future-migration-plans" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
