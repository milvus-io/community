...
---
<p>隨著人工智能系統越來越多地被應用於即時決策，地理空間資料在越來越多的應用程式中變得越來越重要，尤其是那些在實體世界中運作或在真實地點為使用者提供服務的應用程式。</p>
...
<ul>
<li><p>地理空間資料庫和空間擴充設計用來儲存座標、多邊形和空間關係，例如包含或距離。</p></li>
...
<p><a href="https://milvus.io/docs/release_notes.md#v264">Milvus 2.6</a>引入了<a href="https://milvus.io/docs/geometry-field.md">幾何領域 (Geometry Field)</a>，允許向量相似性搜尋與空間限制直接結合，從而解決了這個問題。這使得以下使用案例成為可能：</p>
<ul>
...
<p>這種統一的方法可讓平台在單一查詢中執行空間與語意推理。舉例來說，當使用者搜尋「咖哩飯」時，Milvus 會擷取與語意相關的餐廳<em>，並優先</em>選取鄰近、送貨速度快且符合使用者過往口味習慣的餐廳。</p>
