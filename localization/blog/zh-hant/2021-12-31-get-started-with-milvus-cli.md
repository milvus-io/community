...
<h3 id="Calculate-the-distance-between-two-vectors" class="common-anchor-header">計算兩個向量之間的距離</h3><p>執行以下指令，將資料匯入<code translate="no">car</code> 資料集中。</p>
...
<h3 id="Delete-a-collection" class="common-anchor-header">刪除集合</h3><p>執行下列指令以刪除<code translate="no">car</code> 集合。</p>
