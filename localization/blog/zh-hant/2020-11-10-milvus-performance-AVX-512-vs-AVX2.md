...
<h2 id="What-are-Advanced-Vector-Extensions" class="common-anchor-header">什麼是進階向量擴充？<button data-href="#What-are-Advanced-Vector-Extensions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>進階向量擴充 (AVX) 是依賴 x86 系列指令集架構的微處理器的指令集。AVX 由 Intel 於 2008 年 3 月首次提出，三年後隨著 Sandy Bridge (用於第二代 Intel Core 處理器 (如 Core i7、i5、i3) 的微架構) 以及 AMD 於 2011 年推出的競爭微架構 Bulldozer 的推出，AVX 獲得廣泛支持。</p>
