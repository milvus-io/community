...
<p>我們可以看到<code translate="no">1- Jaccard = Tanimoto</code> 。這裡我們使用 Milvus 中的 Jaccard 來計算化學指紋，這其實與 Tanimoto 距離是一致的。</p>
...
<h2 id="Conclusion" class="common-anchor-header">結論<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>相似性搜尋在許多領域都是不可或缺的，例如圖片和影片。對於藥物發現，相似性搜尋可應用於化學結構資料庫，以發現潛在的可用化合物，然後將其轉換為種子進行實際合成和護理點測試。Milvus 作為針對大規模特徵向量的開放源碼相似性搜尋引擎，採用異質運算架構，以達到最佳的成本效益。使用最少的運算資源，搜尋十億級的向量只需要幾毫秒。因此，Milvus 有助於在生物和化學等領域實現精確、快速的化學結構搜尋。</p>
