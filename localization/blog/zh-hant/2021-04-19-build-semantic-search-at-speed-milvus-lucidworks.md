...
<p>如何讓語意搜尋變得快速？慢速的語意搜尋並不能解決問題。</p>
<p>幸運的是，這正是 Lucidworks 喜歡解決的問題。我們最近測試了一個中等規模的叢集 - 詳情請繼續閱讀 - 結果是對超過 100 萬個文件的集合產生了 1500 RPS（每秒請求量），平均回應時間約為 40 毫秒。這樣的速度真是驚人。</p>
<p><br/></p>
...
<ol>
<li>查詢會傳送到<a href="https://lucidworks.com/products/smart-answers/">Smart Answers</a>索引管道。</li>
