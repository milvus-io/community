...
---
<custom-h1>Milvus 1.1.0 內容</custom-h1><p><a href="https://github.com/milvus-io">Milvus</a>是一個持續進行中的開放原始碼軟體 (OSS) 專案，專注於建立全球最快、最可靠的向量資料庫。由於開源社群的長期支持以及 Zilliz 的贊助，Milvus v1.1.0 的新功能是眾多更新中的第一個。這篇部落格文章涵蓋 Milvus v1.1.0 所包含的新功能、改進和錯誤修正。</p>
