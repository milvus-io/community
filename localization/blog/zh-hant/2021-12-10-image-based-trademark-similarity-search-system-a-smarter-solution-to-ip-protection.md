...
tag: Scenarios
---
<p>近年來，由於人們對智慧財產權侵權的意識不斷提高，智慧財產權保護的議題也受到關注。最值得注意的是，跨國科技巨擘<a href="https://en.wikipedia.org/wiki/Apple_Inc._litigation">蘋果</a>公司（Apple Inc.除了這些最臭名昭著的案件之外，Apple Inc. 還在 2009 年以商標侵權為由，對澳洲連鎖超市<a href="https://www.smh.com.au/business/apple-bites-over-woolworths-logo-20091005-ghzr.html">Woolworths Limited 的商標申請提出爭議</a>。  Apple.Inc. 辯稱，該澳洲品牌的標誌（一個造型化的「w」），與他們自己的蘋果標誌相似。因此，Apple Inc.對 Woolworths 申請銷售的一系列產品（包括電子設備）的標誌提出異議。故事的結局是 Woolworths 修改標誌，Apple 撤回反對。</p>
<p>
...
<p>在以下的章節中，讓我們仔細看看建立商標向量相似性搜尋系統的兩個主要步驟：使用 AI 模型進行圖像特徵抽取，以及使用 Milvus 進行向量相似性搜尋。在我們的案例中，我們使用卷積神經網路 (CNN) VGG16 來擷取影像特徵，並將其轉換成嵌入向量。</p>
