...
<p>我們希望花一些時間來分享我們的故事 - 一個真實的故事，包括所有亂七八糟的部分。</p>
<h2 id="We-Started-Building-Milvus-Because-Nothing-Else-Worked" class="common-anchor-header">我們開始建立 Milvus，因為其他方法都行不通<button data-href="#We-Started-Building-Milvus-Because-Nothing-Else-Worked" class="anchor-icon" translate="no">
    ...
    </button></h2><p>回到 2017 年，我們從一個簡單的問題開始：隨著人工智能應用程式開始湧現，非結構化資料也呈爆炸性成長，您該如何有效率地儲存和搜尋能夠強化語意理解的向量嵌入？</p>
...
<p><strong>因此，我們開始建立自己的解決方案。</strong>這並不是因為我們認為這會很容易 - 數據庫是出了名的難以用好，而是因為我們可以看到 AI 的發展方向，並知道它需要專門為此而建的基礎架構。</p>
...
<p>2020 年，我們加入了<a href="https://lfaidata.foundation/">LF AI 與資料基金會</a>。這不僅是為了提高可信度，還教會我們如何維護一個可持續的開源專案。如何處理治理、向後相容性，以及建立可持續數年而非數月的軟體。</p>
...
<h2 id="The-Hardest-Decision-Starting-Over" class="common-anchor-header">最難的決定：重新開始<button data-href="#The-Hardest-Decision-Starting-Over" class="anchor-icon" translate="no">
    ...
    </button></h2><p>事情變得複雜了。到 2021 年，Milvus 1.0 在許多使用個案中都運作良好，但企業客戶不斷要求相同的事項：更好的雲原生架構、更容易的水平擴充、更簡單的操作。</p>
...
<h2 id="When-Everything-Accelerated-with-AI" class="common-anchor-header">當一切都因人工智慧而加速時<button data-href="#When-Everything-Accelerated-with-AI" class="anchor-icon" translate="no">
    ...
    </button></h2><p>2023 年是<a href="https://zilliz.com/learn/Retrieval-Augmented-Generation">RAG</a>（<a href="https://zilliz.com/learn/Retrieval-Augmented-Generation">Retrieval</a>-augmented Generation）之年。突然之間，語意搜尋從一種有趣的 AI 技術，變成聊天機器人、文件問答系統和 AI 代理的重要基礎架構。</p>
...
<p>接下來就是 2024 年。<a href="https://zilliz.com/blog/zilliz-named-a-leader-in-the-forrester-wave-vector-database-report"><strong>Forrester 評選我們為</strong></a> <strong>向量資料庫類別的</strong> <a href="https://zilliz.com/blog/zilliz-named-a-leader-in-the-forrester-wave-vector-database-report"><strong>領導者</strong></a> <strong>。</strong>Milvus 在 GitHub 上突破了 30,000 顆星星。<strong>我們意識到：我們鋪設了七年的道路終於成為了高速公路。</strong>隨著越來越多企業採用向量資料庫作為關鍵基礎架構，我們的業務成長也迅速加速，證明我們所建立的基礎，無論在技術上或商業上都可以擴充。</p>
...
<li><p><strong>優化成本效益：</strong>分層冷/熱資料儲存、可回應實際工作負載的彈性擴充，以及隨用隨付的價格，與自行管理的部署相比，總擁有成本可降低 50% 或更多。</p></li>
