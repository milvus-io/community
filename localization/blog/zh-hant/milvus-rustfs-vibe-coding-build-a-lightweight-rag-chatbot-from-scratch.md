...
<p>有兩種方式可以套用此變更：</p>
<ul>
<li><strong>掛載本機組態檔案。</strong>複製 configs/milvus.yaml 到本機，更新 MinIO 欄位以指向 RustFS，然後透過 Docker volume 將其掛載到容器中。</li>
...
<h3 id="Reading-and-Chunking-the-Docs" class="common-anchor-header">讀取並將文件分塊</h3><p>腳本會遞迴讀取 docs 資料夾中的每個 .md 檔案，然後按新行將每個檔案的內容分割成小塊：</p>
...
<p>我從這個過程中得到的一些啟發：</p>
<ul>
<li><strong><a href="https://milvus.io/docs">Milvus 的文件</a></strong> <strong>很棒。</strong>尤其是部署部分 - 清晰、完整、易於遵循。</li>
