...
<p>本文將解釋為何需要這項變更，GEOMETRY 和 R-Tree 如何在 Milvus 中運作，預期的效能提升，以及如何使用 Python SDK 設定。</p>
...
<ul>
<li><strong>"浪漫」需要語意搜尋。</strong>系統必須將餐廳評論和標籤向量化，然後在嵌入空間中以相似度來尋找匹配。這只適用於向量資料庫。</li>
...
<table>
<thead>
<tr><th><strong>層次</strong></th><th><strong>Milvus 的功能</strong></th><th><strong>直覺的比喻</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>樹葉層</strong></td><td>對於每個幾何物件 (點、線或多邊形)，Milvus 會計算其最小邊界矩形 (MBR)，並將其儲存為葉節點。</td><td>將每個物件包裝在一個完全符合它的透明方塊中。</td></tr>
