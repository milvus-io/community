...
<li><p><strong>角色</strong>：特權及其適用資源的組合。角色決定可以執行<em>哪些</em>作業，以及<em>在何處</em>執行。</p></li>
...
<h2 id="How-to-Configure-Access-Control-via-RBAC-in-Milvus" class="common-anchor-header">如何在 Milvus 中通過 RBAC 配置存取控制<button data-href="#How-to-Configure-Access-Control-via-RBAC-in-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Prerequisites" class="common-anchor-header">1.先決條件</h3><p>在評估和執行 RBAC 規則之前，必須啟用使用者驗證，以便 Milvus 的每個請求都能與特定使用者身份相關聯。</p>
<p>以下是兩種標準的部署方法。</p>
<ul>
...
<p>對最新 Milvus 的任何功能有問題或想要深入瞭解？加入我們的<a href="https://discord.com/invite/8uyFbECzPX"> Discord 頻道</a>或在<a href="https://github.com/milvus-io/milvus"> GitHub</a> 上提出問題。您也可以透過<a href="https://milvus.io/blog/join-milvus-office-hours-to-get-support-from-vectordb-experts.md"> Milvus Office Hours</a> 預約 20 分鐘的一對一會議，以獲得洞察力、指導和問題解答。</p>
