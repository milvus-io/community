...
title: 揭曉 2023 年主宰 Milvus 社群的十大關鍵字
...
<h2 id="1-Version--The-rise-of-AIGC-drives-rapid-Milvus-iteration" class="common-anchor-header">#1 版本 - AIGC 的興起帶動 Milvus 快速迭代<button data-href="#1-Version--The-rise-of-AIGC-drives-rapid-Milvus-iteration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>令人驚訝的是，「版本」成為 2023 年討論最多的關鍵字。這一啟示根源於這一年的人工智能浪潮，向量資料庫成為解決 AIGC 應用程式幻覺問題挑戰的重要基礎設施。</p>
<p>圍繞向量資料庫的熱情驅使 Milvus 進入快速迭代的階段。僅在 2023 年，社群就見證了 20 個版本的釋出，滿足了 AIGC 開發人員的需求，他們的詢問充斥著社群，詢問如何為各種應用選擇最佳版本的 Milvus。對於瀏覽這些更新的使用者，我們建議您使用最新的版本，以增強功能和效能。</p>
...
<p>對於人工智慧產生的內容 (AIGC)，開發人員通常會將快速回應和結果精確度放在首位，而非嚴格的效能要求。Milvus 新增的 MMap 和 DiskANN 可將記憶體佔用量降至最低，同時最大化資料處理和結果精確度，達到符合 AIGC 應用程式實際需求的平衡。</p>
...
<h2 id="10-Deletion--unraveling-the-impact" class="common-anchor-header">#10 刪除 - 解開影響<button data-href="#10-Deletion--unraveling-the-impact" class="anchor-icon" translate="no">
    ...
    </button></h2><p>關於「刪除」的討論普遍圍繞刪除後資料數量不變、刪除資料的持續可擷取性，以及刪除後磁碟空間恢復失敗等問題。</p>
