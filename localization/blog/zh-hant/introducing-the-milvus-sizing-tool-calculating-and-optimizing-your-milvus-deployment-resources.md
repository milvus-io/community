...
<h3 id="Advanced-Index-Options-ScaNN-DiskANN-CAGRA-and-more" class="common-anchor-header">進階索引選項：ScaNN、DiskANN、CAGRA 等等</h3><p>對於有特殊需求的開發人員，Milvus 也提供了以下服務：</p>
<ul>
...
<li><p><a href="https://milvus.io/docs/disk_index.md"><strong>DiskANN</strong></a>：磁碟/記憶體混合索引，適合需要支援大量向量且召回率高，並能接受稍長延遲 (~100ms) 的情況。它只將索引的一部分保留在記憶體中，其他部分則保留在磁碟上，從而平衡記憶體使用量與效能。</p></li>
...
<li><p><strong>HNSW_PRQ</strong>：中速查詢；記憶體資源非常有限；接受召回率的輕微折衷。</p></li>
...
<li><p><strong>二進位、稀疏和其他專用索引</strong>：適用於特定資料類型和使用個案。如需詳細資訊，請參閱<a href="https://milvus.io/docs/index.md">此索引說明文件頁面</a>。</p></li>
</ul>
...
<p>我們會根據使用者的回饋持續改善我們的工具和說明文件。如果您對 Milvus 部署的大小有任何疑問或需要進一步協助，請聯絡我們<a href="https://github.com/milvus-io/milvus/discussions"> GitHub</a>或<a href="https://discord.com/invite/8uyFbECzPX"> Discord</a> 上的社群。</p>
