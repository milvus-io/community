...
<h3 id="Which-CNN-model-should-I-use" class="common-anchor-header">我應該使用哪個 CNN 模型呢？</h3><p>答案是 VGG16。為什麼選擇它？首先，VGG16 具備良好的泛化能力，也就是說，它的用途非常廣泛。第二，VGG16 擷取的特徵向量有 512 個維度。如果維度太少，可能會影響精確度。如果維度太多，則儲存和計算這些特徵向量的成本相對較高。</p>
...
<p>向量的搜尋方式相當不同。查詢結果會以相似度從高到低的順序排序，並選取最相似 (topK) 的結果 (topK 由使用者在查詢時指定)。</p>
