...
<p>抽取出來的特徵向量會先由 Milvus 建立索引並儲存在 Ceph 中，然後再<a href="https://milvus.io/blog/deep-dive-5-real-time-query.md">由 Milvus 查詢節點載入</a>，以便進一步搜尋。這些特徵向量所對應的影片 ID 也會依據實際需求，同時儲存在 TiDB 或 Pika 中。</p>
...
<p>作為一個高性能的向量搜尋引擎，Milvus 在 Likee 的視頻去重複系統中表現出色，大大推動了 BIGO 短視頻業務的增長。在視頻業務方面，Milvus 還可以應用在很多其他場合，例如非法內容封堵或個性化視頻建議等。BIGO和Milvus都期待未來在更多領域的合作。</p>
