...
---
<custom-h1>Milvus 版本介紹</custom-h1><p>選擇適當的Milvus版本是任何利用向量搜尋技術的專案成功的關鍵。不同的Milvus版本針對不同的需求量身打造，了解選擇正確版本的重要性，對於達成預期的結果至關重要。</p>
...
<li><p><strong>索引類型與相似度指標</strong>：提供 11 種索引類型與 5 種類似度指標的支援，針對您的特定使用個案提供彈性與客製化選項。</p></li>
