...
<p>Milvus 2.6 將大幅提升 BM25 的效能。我們在 BEIR 資料集上的測試顯示，在召回率相等的情況下，吞吐量比 Elasticsearch 高出 3-4倍。對於某些工作負載，改善幅度最高可達 7 倍的 QPS。</p>
<p>
  <span class="img-wrapper">
...
<p>這種對時間敏感的重新排序將確保最新且與上下文最相關的結果出現在第一位，這對新聞推薦系統、電子商務平台和社群媒體饋送（social media feeds）至關重要。</p>
...
<p>Milvus 2.6 將會引進一個基本的架構變革，以符合成本效益的方式擴充至數千億向量。最大的亮點是全新的冷熱分層儲存架構，可根據存取模式智慧地管理資料放置，自動將熱資料移至高效能記憶體/SSD，同時將冷資料放置在更經濟的物件儲存中。這種方法可以大幅降低成本，同時在最重要的地方維持查詢效能。</p>
