...
<p>身為 Milvus 的常客，我對新發布的 Milvus 2.0 RC 感到非常興奮。根據官網上的介紹，Milvus 2.0 似乎在很大程度上超越了前代產品。我非常渴望親自試用一下。</p>
...
<p>然後，您需要<a href="https://github.com/milvus-io/milvus/blob/master/deployments/docker/cluster/docker-compose.yml">下載並</a>修改叢集的<strong>docker-compose.yml</strong>檔案，將本機的<strong>milvus.yaml</strong>路徑映射到所有元件中配置檔案的對應路徑，也就是 root coord、data coord、data node、query coord、query node、index coord、index node 和 proxy。</p>
<p>
