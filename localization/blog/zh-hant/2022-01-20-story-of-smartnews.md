...
<p>資訊在我們的生活中無所不在。Meta (前身為 Facebook)、Instagram、Twitter 和其他社交媒體平台讓資訊流更加無所不在。因此，處理這些資訊流的引擎已成為大多數系統架構的必備功能。然而，身為社交媒體平台和相關應用程式的使用者，我想您一定曾被重複的文章、新聞、memes 等內容所困擾。接觸重複的內容會妨礙資訊檢索的過程，並導致不良的使用者體驗。</p>
...
<p>2021 年 6 月，舒展和演算法團隊的同事將 Milvus 應用到更多的業務場景中，並嘗試進行資料聚合和線上資料/索引的即時更新。</p>
