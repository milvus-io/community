...
3  
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Audio-search" class="common-anchor-header">步驟 2：音訊搜尋</h3><p>Milvus 會計算預先儲存的特徵向量與輸入特徵向量之間的內積距離，輸入特徵向量是使用 PANNs 推理模型從查詢的音訊資料中萃取出來的，並傳回類似特徵向量的<strong>ids_milvus</strong>，這些特徵向量對應於所搜尋的音訊資料。</p>
