...
desc: >-
  Создание с помощью Milvus Интеллектуальная система поиска изображений для
  спорта Приложение iYUNDONG
...
<p>Для достижения мгновенного чтения iYUNDONG разработал собственное промежуточное ПО для шардинга, чтобы легко достичь горизонтальной масштабируемости и снизить воздействие на систему от чтения с диска. Кроме того, <a href="https://redis.io/">Redis</a> используется в качестве кэширующего слоя для обеспечения стабильной производительности в условиях высокого параллелизма.</p>
<ul>
