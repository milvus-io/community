...
<button class="copy-code-btn"></button></code></pre>
<p>Но Mistral также может понимать документы на разных языках или в более сложном формате, например, давайте попробуем этот счет-фактуру на немецком языке, в котором сочетаются некоторые названия товаров на английском.</p>
<p>
