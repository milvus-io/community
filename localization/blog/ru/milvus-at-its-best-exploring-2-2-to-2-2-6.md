...
<p>В дополнение к новым функциям, упомянутым выше, Milvus v2.2 включает исправления пяти ошибок и множество улучшений, повышающих стабильность, наблюдаемость и производительность Milvus. Более подробную информацию можно найти в <a href="https://milvus.io/docs/release_notes.md#v220">информации о выпуске Milvus v2.2</a>.</p>
...
<p>Более подробную информацию можно найти в <a href="https://milvus.io/docs/release_notes.md#v221">Milvus v2.2.1 Release Notes</a> и <a href="https://milvus.io/docs/release_notes.md#v222">Milvus v2.2.2 Release Notes</a>.</p>
