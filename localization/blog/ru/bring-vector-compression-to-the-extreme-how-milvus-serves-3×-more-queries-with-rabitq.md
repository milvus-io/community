...
<li><p><code translate="no">nprobe</code> неотрицательное целое число, определяющее количество бакетов ЭКО, которые посещаются для одного вектора данных в процессе поиска. Это параметр, связанный с поиском.</p></li>
...
<p>Полученные результаты позволяют сделать важные выводы:</p>
<p>
  <span class="img-wrapper">
