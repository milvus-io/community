...
<h2 id="Ask-MilMil-about-Milvus" class="common-anchor-header">Спросите Милмила о Milvus<button data-href="#Ask-MilMil-about-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Чтобы пообщаться с MilMil, перейдите на любую страницу на <a href="https://milvus.io/">Milvus.io</a> и нажмите на значок птички в правом нижнем углу. Введите свой вопрос в поле ввода текста и нажмите кнопку "Отправить". МилМил ответит вам через миллисекунды! Кроме того, выпадающий список в левом верхнем углу можно использовать для переключения между технической документацией для разных версий Milvus.</p>
<p>
