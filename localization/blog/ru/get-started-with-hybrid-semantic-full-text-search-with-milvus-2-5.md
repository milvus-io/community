...
<p>и наличие запущенного экземпляра Milvus Standalone (например, на вашей локальной машине), используя <a href="https://milvus.io/docs/prerequisite-docker.md">инструкции по установке в документации Milvus</a>.</p>
...
<h2 id="Performing-Hybrid-Semantic-and-Full-Text-Search" class="common-anchor-header">Выполнение гибридного семантического и полнотекстового поиска<button data-href="#Performing-Hybrid-Semantic-and-Full-Text-Search" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Теперь давайте объединим полученные знания и выполним гибридный поиск, сочетающий в себе раздельный семантический и полнотекстовый поиск с реранкером:</p>
