...
---
<p><a href="https://milvus.io/docs/release_notes.md"><strong>Milvus 2.6</strong></a> уже давно в продаже, и это серьезный шаг вперед для проекта. В релизе усовершенствована архитектура, повышена производительность в реальном времени, снижено потребление ресурсов и улучшено поведение при масштабировании в производственных средах. Многие из этих улучшений были разработаны непосредственно под влиянием отзывов пользователей, и первые пользователи 2.6.x уже сообщили о заметно более быстром поиске и более предсказуемой производительности системы при больших или динамических нагрузках.</p>
...
<p>Milvus по-прежнему можно обновить с 2.5 до 2.6 с помощью Helm, выполнив следующие действия.</p>
