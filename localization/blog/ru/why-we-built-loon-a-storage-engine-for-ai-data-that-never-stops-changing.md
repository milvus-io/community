...
title: >-
  Почему мы создали Loon: движок хранения для AI-данных, которые никогда не
...
desc: >-
  Loon усиливает Milvus 3.0 версионированным векторным хранилищем для
  эволюционирующих наборов данных ИИ, эффективных обратных заполнений,
  гибридного поиска и lake-native рабочих процессов.
origin: >-
