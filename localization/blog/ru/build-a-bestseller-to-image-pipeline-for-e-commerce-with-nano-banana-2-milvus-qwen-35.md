...
<li><strong>До 14 опорных изображений.</strong> Поддерживает сходство персонажей для 5 персонажей и достоверность объектов для 14 объектов в одном рабочем процессе.</li>
...
<h3 id="Step-9-Side-by-Side-Comparison" class="common-anchor-header">Шаг 9: Сравнение бок о бок</h3><p>Выходные данные в общих чертах совпадают: освещение мягкое и ровное, поза модели выглядит естественно, а настроение соответствует бестселлеру.</p>
