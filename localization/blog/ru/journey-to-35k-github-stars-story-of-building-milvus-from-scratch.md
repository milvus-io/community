...
<p>В 2020 году мы присоединились к <a href="https://lfaidata.foundation/">фонду LF AI &amp; Data Foundation</a>. Это было сделано не только для повышения авторитета - это научило нас тому, как поддерживать устойчивый проект с открытым исходным кодом. Как справляться с управлением, обратной совместимостью и создавать программное обеспечение, которое прослужит годы, а не месяцы.</p>
