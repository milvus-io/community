...
Шаг 2: Клонирование проекта</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Implement-the-Pipeline" class="common-anchor-header">Шаг 3: Внедрение конвейера</h3><p><strong>Интеграция векторной базы данных Milvus</strong></p>
...
<p><strong>Готовы упростить разработку RAG?</strong> Попробуйте UltraRAG v2 с Milvus. Изучите пример конвейера, запустите его самостоятельно и постройте полный рабочий процесс RAG с помощью всего нескольких строк конфигурации.</p>
