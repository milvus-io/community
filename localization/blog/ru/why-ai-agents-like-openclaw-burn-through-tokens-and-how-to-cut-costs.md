...
<ul>
<li><strong>Поиск:</strong> Плохо построенный поиск втягивает в себя огромную полезную нагрузку контекста - целые файлы, журналы, сообщения и участки кода, которые на самом деле не нужны модели.</li>
