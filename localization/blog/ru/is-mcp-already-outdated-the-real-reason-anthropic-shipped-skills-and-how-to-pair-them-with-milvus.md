...
<li><p>Индивидуальные инструкции (тон или точка зрения для конкретного проекта).</p></li>
</ul>
...
<ul>
<li><p><strong>MCP (например, claude-context):</strong> Предоставляет возможность доступа к векторной базе данных Milvus.</p></li>
