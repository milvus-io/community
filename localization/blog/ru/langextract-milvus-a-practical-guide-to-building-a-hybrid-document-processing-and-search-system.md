...
<ul>
<li><p>Структурированное извлечение: Определите схему и извлекайте имена, даты, местоположение, расходы и другую необходимую информацию.</p></li>
...
<h3 id="What’s-Milvus" class="common-anchor-header">Что такое Milvus?</h3><p><a href="https://milvus.io/">Milvus</a> - это векторная база данных с открытым исходным кодом, имеющая более 36 тыс.+ звезд на Github и используемая более чем 10 тыс. предприятий в различных отраслях. Milvus широко используется в системах RAG, агентах искусственного интеллекта, рекомендательных системах, системах обнаружения аномалий и семантического поиска, что делает ее основным компонентом приложений, основанных на искусственном интеллекте.</p>
...
<ul>
<li><p>LangExtract генерирует чистые, структурированные метаданные, а затем хранит их и осуществляет эффективный поиск с помощью Milvus, что дает нам лучшее из двух миров: точную фильтрацию и семантический поиск.</p></li>
<li><p>Milvus будет выступать в качестве поисковой основы, храня как вкрапления (для семантического поиска), так и структурированные метаданные, извлеченные LangExtract, что позволит нам выполнять точные и интеллектуальные гибридные запросы в масштабе.</p></li>
</ul>
...
<h3 id="Preparing-Sample-Data" class="common-anchor-header"><strong>Подготовка образцов данных</strong></h3><p>В этой демонстрации мы будем использовать описания фильмов в качестве образцов документов. Это покажет, как LangExtract может извлекать структурированную информацию, такую как жанры, персонажи и темы, из неструктурированного текста.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Demonstrating-Metadata-Filtering" class="common-anchor-header"><strong>Демонстрация фильтрации метаданных</strong></h3><p>Одно из ключевых преимуществ сочетания LangExtract с Milvus - возможность выполнять точную фильтрацию на основе извлеченных метаданных. Давайте посмотрим на это в действии с помощью поиска по выражению фильтра.</p>
