...
<p>В наших бенчмарках с 10 миллионами векторов для 100 арендаторов Milvus с кластерным уплотнением обеспечил <strong>3-5-кратное увеличение QPS</strong> по сравнению с неоптимизированной базовой версией.</p>
...
<li><strong>Низкий трафик или прототипирование:</strong> Модель с хостингом, например <code translate="no">gpt-4o-mini</code>, быстрее настраивается и требует меньше оперативной работы, но задержки и стоимость каждого вызова выше.</li>
</ul>
