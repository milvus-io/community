...
<h2 id="Milvus-Standalone" class="common-anchor-header">Автономный Milvus<button data-href="#Milvus-Standalone" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus предлагает два режима работы: Standalone и Cluster. Оба режима идентичны по основным функциям векторной базы данных и различаются по поддержке объема данных и требованиям к масштабируемости. Это различие позволяет выбрать режим, который лучше всего соответствует размеру вашего набора данных, объему трафика и другим требованиям к производственной инфраструктуре.</p>
...
<li><p><strong>Масштабируемость</strong>: Достижение динамической масштабируемости за счет масштабирования на уровне компонентов, что позволяет плавно увеличивать и уменьшать масштабы в зависимости от потребностей. Milvus может автомасштабироваться на уровне компонентов, оптимизируя распределение ресурсов для повышения эффективности.</p></li>
