...
---
<custom-h1>Представляем инструмент для миграции данных Milvus</custom-h1><p><em><strong>Важное замечание</strong>: Инструмент миграции данных Mivus был снят с производства. Для миграции данных из других баз данных в Milvus мы рекомендуем использовать более продвинутую службу векторной транспортировки (VTS).</em></p>
<p><strong>Для получения дополнительной информации см. <a href="https://zilliz.com/vector-transport-service">целевую страницу Vector Transport Service</a> или ее <a href="https://github.com/zilliztech/vts">репозиторий на GitHub</a>.</strong></p>
<p>В настоящее время VTS поддерживает миграцию из:</p>
<ul>
<li>Pinecone</li>
<li>Qdrant</li>
<li>Elasticsearch</li>
...
<li>Milvus 2.3.x в Milvus 2.3.x или выше</li>
</ul>
