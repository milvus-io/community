...
<p>Мы рады сообщить о выходе новой версии Milvus 2.2.8. Этот релиз включает в себя многочисленные улучшения и исправления ошибок по сравнению с предыдущими версиями, что позволяет повысить производительность запросов, экономить ресурсы и увеличить пропускную способность. Давайте вместе посмотрим, что нового появилось в этом выпуске.</p>
