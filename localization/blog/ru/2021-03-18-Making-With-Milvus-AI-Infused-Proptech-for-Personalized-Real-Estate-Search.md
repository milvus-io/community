...
<li><p>Извлеченные коллекции признаков используются для выполнения поиска по сходству в Milvus. Результаты запроса по каждой коллекции векторов являются мерой сходства между входным объявлением и другими похожими объявлениями.</p></li>
