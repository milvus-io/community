...
<h3 id="Step-5-Try-It-Out" class="common-anchor-header">Шаг 5: Попробуйте</h3><p>Зайдите в Slack и отправьте боту сообщение. Если все настроено правильно, OpenClaw ответит и будет готов выполнять задания на вашей машине.  <span class="img-wrapper">
