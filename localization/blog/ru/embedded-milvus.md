...
<h3 id="When-to-use-embedded-Milvus" class="common-anchor-header">Когда использовать встраиваемый Milvus?</h3><p>Embedded Milvus и <a href="https://milvus.io/docs/v2.1.x/install-pymilvus.md">PyMilvus</a> созданы для разных целей. Вы можете выбрать встроенный Milvus в следующих сценариях:</p>
<ul>
