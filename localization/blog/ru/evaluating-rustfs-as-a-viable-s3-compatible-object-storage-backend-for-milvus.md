...
<p>По результатам этой оценки текущая реализация S3 API в RustFS удовлетворяет базовым функциональным требованиям Milvus. Это делает ее пригодной для практического тестирования в непроизводственных средах.</p>
...
<li><p>Порт хоста 9000 открыт для доступа извне, либо соответствующим образом настроен альтернативный порт.</p></li>
