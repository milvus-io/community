...
desc: >-
  ...
  надежная балансировка нагрузки и планирование, а также улучшена наблюдаемость
  и работоспособность.
