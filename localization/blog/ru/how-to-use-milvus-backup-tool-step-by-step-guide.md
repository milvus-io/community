...
<li><p><strong>Между экземплярами Milvus в одном S3 с одним ведром:</strong> Перенос коллекции между экземплярами Milvus с разными корневыми путями, но использующими один и тот же ведро S3.</p></li>
...
<p>Рисунок: Рабочий процесс резервного копирования и восстановления в рамках одного экземпляра Milvus</p>
...
<p>Рисунок: Рабочий процесс резервного копирования и восстановления между двумя экземплярами Milvus на разных сервисах S3</p>
