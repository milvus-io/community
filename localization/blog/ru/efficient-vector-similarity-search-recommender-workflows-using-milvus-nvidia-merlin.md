...
<p>Мы кратко описываем каждый этап и отсылаем читателя к нашим <a href="https://github.com/bbozkaya/merlin-milvus/tree/main/notebooks">блокнотам</a> для получения подробной информации.</p>
...
<h4 id="Users-vs-Items-vector-similarity-search" class="common-anchor-header">Пользователи против предметов Поиск векторного сходства</h4><p>Наконец, мы рассмотрим еще один реалистичный случай использования, когда векторы пользователей запрашиваются по отношению к векторам элементов (как показано выше в Notebook 01). В этом случае индексируется 49 тыс. векторов элементов, а 7,3 млн векторов пользователей запрашиваются на 100 наиболее похожих элементов.</p>
