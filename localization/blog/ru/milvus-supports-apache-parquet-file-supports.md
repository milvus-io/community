...
<h2 id="How-to-Import-Parquet-Files-into-Milvus" class="common-anchor-header">Как импортировать файлы Parquet в Milvus<button data-href="#How-to-Import-Parquet-Files-into-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Если ваши данные уже представлены в формате файла Parquet, импортировать их очень просто. Загрузите файл Parquet в систему хранения объектов, например MinIO, и вы готовы к импорту.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Затем вы можете приступить к импорту файлов Parquet в Milvus.</p>
