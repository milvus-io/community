...
<ul>
<li><strong><a href="https://github.com/nicepkg/openclaw">OpenClaw</a></strong> - фреймворк с открытым исходным кодом для агентов ИИ, который организует рабочий процесс и подключается к платформам обмена сообщениями, таким как Telegram, WhatsApp и Slack.</li>
