...
---
<p>Технология<a href="https://zilliz.com/learn/Retrieval-Augmented-Generation">Retrieval Augmented Generation (RAG)</a> стала стандартным подходом для обеспечения контекста и памяти в приложениях ИИ - на нее полагаются агенты ИИ, ассистенты поддержки клиентов, базы знаний и поисковые системы.</p>
...
<h3 id="The-Challenges-of-Getting-Chunking-Right" class="common-anchor-header">Трудности правильного использования чанков</h3><p>Большинство систем RAG сегодня используют один из двух основных методов разбиения на части, оба из которых имеют свои ограничения.</p>
