...
<p>Параметр <strong>beam_width_ratio</strong> управляет тем, сколько кандидатов расширяется параллельно: <strong>Ширина пучка = количество ядер процессора × соотношение ширины пучка.</strong> Более высокое соотношение расширяет поиск, потенциально повышая точность, но также увеличивает объем вычислений и дисковых операций ввода-вывода.</p>
...
<p>Последовательная компоновка дает два важных преимущества:</p>
<ul>
