...
<p>Например, если вы ищете книги, вступление которых наиболее похоже на Hello Milvus, но хотите получить только те книги, названия которых начинаются с 'book_2', вы можете использовать оператор <code translate="no">like</code>для выполнения префиксного соответствия и получения целевых книг, как показано в примере ниже.</p>
