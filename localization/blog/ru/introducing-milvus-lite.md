...
<p>Для масштабируемости ИИ-приложение, разработанное с помощью Milvus Lite, может легко перейти к использованию Milvus, развернутого на Docker или Kubernetes, просто указав <code translate="no">uri</code> в качестве конечной точки сервера.</p>
