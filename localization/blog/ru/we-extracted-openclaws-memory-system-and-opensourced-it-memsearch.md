...
<p>Разделение по умолчанию 70/30 хорошо подходит для большинства случаев. Для рабочих процессов, которые в значительной степени склоняются к точным совпадениям, увеличение веса BM25 до 50% - это однострочное изменение конфигурации.</p>
