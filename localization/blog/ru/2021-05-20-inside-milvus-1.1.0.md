...
<p><br/></p>
<h3 id="Hnswlib-upgraded-to-v050" class="common-anchor-header">Hnswlib обновлен до версии 0.5.0</h3><p>Milvus использует несколько широко используемых библиотек индексов, включая Faiss, NMSLIB, Hnswlib и Annoy, чтобы упростить процесс выбора правильного типа индекса для конкретного сценария.</p>
