...
<li><p>Milvus перемещает SearchTask в GpuResource. Поток загрузки в GpuResource копирует данные из памяти CPU в память GPU. GpuResource считывает соответствующие блоки данных в память GPU.</p></li>
