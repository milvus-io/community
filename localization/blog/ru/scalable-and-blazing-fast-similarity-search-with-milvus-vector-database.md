...
<ul>
<li><strong>Преобразование векторов:</strong> Включает в себя добавление дополнительных преобразований к векторам, таких как уменьшение размерности (например, PCA \ t-SNE), вращение и т. д.</li>
