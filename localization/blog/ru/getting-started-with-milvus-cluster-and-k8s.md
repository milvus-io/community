...
desc: >-
  В этом руководстве вы узнаете об основах настройки Milvus с помощью Helm,
  создании коллекции и выполнении поиска по сходству и вводу данных.
...
<h2 id="Why-Use-Them-Together" class="common-anchor-header">Зачем использовать их вместе?<button data-href="#Why-Use-Them-Together" class="anchor-icon" translate="no">
    ...
    </button></h2><p>K8s может автоматически масштабировать кластеры Milvus в зависимости от рабочей нагрузки. По мере роста данных или увеличения количества запросов K8s может запустить дополнительные экземпляры Milvus, чтобы справиться с нагрузкой, обеспечивая высокую скорость работы приложений.</p>
