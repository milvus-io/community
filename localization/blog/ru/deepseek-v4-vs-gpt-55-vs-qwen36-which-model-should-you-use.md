...
<h2 id="What-Should-You-Improve-Before-Production" class="common-anchor-header">Что нужно улучшить перед производством?<button data-href="#What-Should-You-Improve-Before-Production" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В демонстрации используется простое разбиение на секции и поиск по принципу top-k. Этого достаточно, чтобы продемонстрировать механику, но производственный RAG обычно нуждается в большем контроле поиска.</p>
<table>
<thead>
