...
<tr><td>Кросс-модальный поиск является основным сценарием использования (текстовый запрос → результаты в виде изображений)</td><td>Gemini Embedding 2 унифицированный вектор</td><td>Единое общее пространство делает кросс-модальное сходство естественным</td></tr>
...
<h2 id="Quick-Start-Set-Up-Gemini-Embedding-2-+-Milvus" class="common-anchor-header">Быстрый старт: Настройка Gemini Embedding 2 + Milvus<button data-href="#Quick-Start-Set-Up-Gemini-Embedding-2-+-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вот рабочая демонстрация. Вам понадобится запущенный <a href="https://milvus.io/docs/install-overview.md">экземпляр Milvus или Zilliz Cloud</a> и ключ GOOGLE_API_KEY.</p>
...
<p>Хотите попробовать? Начните с <a href="https://milvus.io/docs/quickstart.md">быстрого запуска Milvus</a> и запустите демонстрацию выше, или посмотрите <a href="https://milvus.io/docs/hybrid_search_with_milvus.md">руководство по гибридному поиску</a> для полной настройки мультивектора в BGE-M3. Приносите свои вопросы в <a href="https://milvus.io/discord">Discord</a> или <a href="https://meetings.hubspot.com/chloe-williams1/milvus-office-hour">Milvus Office Hours</a>.</p>
