...
<tr><td><strong>Архитектура</strong></td><td>Отдельные зрительные и текстовые кодировщики, выровненные по контрастным потерям</td><td>Единая модель, наследующая мультимодальное понимание от Gemini</td></tr>
</tbody>
</table>
