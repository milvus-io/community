...
<h3 id="Step-5-Encode-Images-and-Insert-into-Milvus" class="common-anchor-header">Шаг 5: Кодирование изображений и вставка в Milvus</h3><p>ColQwen2 кодирует каждую страницу в многовекторные патч-эмбеддинги. Затем каждый патч вставляется в Milvus в виде отдельной строки.</p>
...
<p><strong>Агрегирование по страницам</strong> с помощью MaxSim: для каждого токена запроса возьмите патч с наибольшим количеством баллов на каждой странице, затем суммируйте эти баллы по всем токенам. Страница с наибольшей суммарной оценкой является наилучшим совпадением.</p>
...
<p>Чтобы начать, установите <a href="https://github.com/milvus-io/milvus-lite">Milvus Lite</a> с помощью pip install pymilvus и возьмите весы ColQwen2 с сайта HuggingFace.</p>
