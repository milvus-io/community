...
<li>Векторы встраивания выражаются через плотные векторы с плавающей точкой, что позволяет приложениям использовать преимущества SIMD. Поскольку SIMD поддерживается графическими процессорами и почти всеми современными CPU, вычисления с векторами могут достигать высокой производительности при относительно низкой стоимости.</li>
