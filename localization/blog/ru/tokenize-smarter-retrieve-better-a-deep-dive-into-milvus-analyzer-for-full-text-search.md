...
<tbody>
<tr><td>Нижний регистр</td><td>Преобразовывает все лексемы в нижний регистр</td><td>Необходима для поиска на английском языке, чтобы избежать несоответствия регистров</td></tr>
