...
desc: >-
  Узнайте, как SDK взаимодействуют с Milvus и почему API в стиле ORM помогает
  вам лучше управлять Milvus.
...
<p>Разобравшись с поведением RPC, вы сможете разработать новые возможности для Milvus с помощью комбинаций. Мы будем рады, если вы воспользуетесь своим воображением и творческим подходом и внесете свой вклад в развитие сообщества Milvus.</p>
