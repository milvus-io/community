...
title: Как восстановить данные Milvus после повреждения etcd без резервной копии
author: Jack Li
date: 2026-7-22
cover: >-
...
desc: >-
  etcd повреждён, бэкапа нет, исходные данные потеряны? Вот как мы восстановили
  коллекцию Milvus из binlog-файлов MinIO с помощью bulkInsert и как проверить
  сегменты перед импортом.
