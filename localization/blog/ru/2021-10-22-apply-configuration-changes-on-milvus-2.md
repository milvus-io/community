...
<p>Наконец, запустите Milvus standalone с помощью <code translate="no">docker-compose up -d</code> и проверьте, успешно ли прошли модификации. Например, запустите <code translate="no">docker logs</code>, чтобы проверить формат журнала.</p>
<p>
