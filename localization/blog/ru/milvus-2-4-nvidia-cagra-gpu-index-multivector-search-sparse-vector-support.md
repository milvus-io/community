...
<p>Традиционно разработчики полагались на обширный поиск по Top-K с последующей ручной постобработкой для выделения результатов, относящихся к конкретной группе, что требовало больших вычислительных затрат и большого объема кода. Grouping Search совершенствует этот процесс, эффективно связывая результаты запросов с агрегированными идентификаторами групп, такими как названия документов или видео, что упрощает работу с сегментированными сущностями в больших наборах данных.</p>
...
<p>Мы обозначили эту функцию как "бета-версию", чтобы продолжить тестирование ее производительности и собрать отзывы сообщества. Общедоступность (GA) поддержки разреженных векторов ожидается с выходом Milvus 3.0.</p>
...
<h2 id="Additional-Enhancements-and-Features" class="common-anchor-header">Дополнительные улучшения и возможности<button data-href="#Additional-Enhancements-and-Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
