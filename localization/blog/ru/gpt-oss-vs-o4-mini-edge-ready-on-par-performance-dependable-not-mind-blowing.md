...
<ul>
<li><p><strong>gpt-oss-120b</strong>: 2,1 млн. H100-часов → ~$10M</p></li>
...
<p><strong>А вот в чем он не дотягивает, так это в многоязыковой поддержке.</strong> Если вы работаете не на английском языке, вы столкнетесь со странными формулировками, проблемами с орфографией и общей путаницей. Модель явно обучалась с учетом английского языка. Если вам важен глобальный охват, то, скорее всего, вам придется доработать ее с помощью многоязычного набора данных.</p>
