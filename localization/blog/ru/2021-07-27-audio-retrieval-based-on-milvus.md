...
<p>Как волна, звук включает в себя четыре свойства: частоту, амплитуду, форму волны и продолжительность. В музыкальной терминологии они называются питч, динамика, тон и длительность. Звуки также помогают людям и другим животным воспринимать и понимать окружающую среду, предоставляя контекстные подсказки о местоположении и движении объектов в нашем окружении.</p>
...
<h2 id="API-reference-and-demo" class="common-anchor-header">Ссылка на API и демонстрация<button data-href="#API-reference-and-demo" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="API" class="common-anchor-header">API</h3><p>Данная система поиска аудиоданных построена на основе открытого кода. Ее основными функциями являются вставка и удаление аудиоданных. Все API можно посмотреть, набрав в браузере <strong>127.0.0.1:<port></strong> /docs.</p>
...
<li><p>Найдите Milvus на <a href="https://github.com/milvus-io/milvus/">GitHub</a> или внесите в него свой вклад.</p></li>
