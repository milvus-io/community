...
title: >-
  За пределами =~: как Milvus 3.0 превращает регулярные выражения в нативный
  фильтр базы данных
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  Milvus 3.0 переносит регулярные выражения из постобработки на стороне
  приложения в путь выполнения запросов базы данных, где их можно сочетать с
  векторным поиском, полнотекстовым поиском, скалярными фильтрами и выполнением
