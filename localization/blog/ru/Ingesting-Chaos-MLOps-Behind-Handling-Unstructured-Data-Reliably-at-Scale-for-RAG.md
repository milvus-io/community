...
<li>Создайте автоматизированную систему оценки, которая оценивает, как поиск справляется с каждым вопросом. Один из способов сделать это - взять ответ из системы RAG и прогнать его через LLM с подсказкой, которая спрашивает, отвечает ли этот результат RAG на заданный вопрос правильным ответом. Это должен быть ответ "да" или "нет". Например, если в ваших документах 25 вопросов, а система отвечает на 20, вы можете использовать этот результат для сравнения с другими подходами.</li>
