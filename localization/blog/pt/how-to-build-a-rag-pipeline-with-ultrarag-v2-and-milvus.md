...
<li><strong>Orquestração de fluxo de trabalho leve:</strong> Um cliente MCP integrado executa o pipeline, mantendo o comportamento do fluxo de trabalho totalmente desacoplado das implementações subjacentes. Enquanto os sistemas RAG tradicionais exigem frequentemente a edição do código principal para adicionar novas funcionalidades, o UltraRAG v2 adopta um modelo semelhante a um microsserviço em que os novos módulos podem ser implementados de forma independente, tal como a instalação de um plug-in.</li>
</ul>
<p>
