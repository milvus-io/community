...
<h2 id="UltraRAG-v2-Architecture-at-a-Glance" class="common-anchor-header">Visão geral da arquitetura do UltraRAG v2<button data-href="#UltraRAG-v2-Architecture-at-a-Glance" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Em diferentes sistemas RAG, as funções principais, como a recuperação, a geração e a avaliação, são semelhantes mas implementadas de formas diferentes, o que dificulta a reutilização ou a combinação de componentes. O MCP resolve este problema padronizando a forma como os LLMs comunicam com ferramentas externas através de uma arquitetura simples Cliente-Servidor.</p>
...
Etapa 2: Clonar o projeto</h3><pre><code translate="no">git <span class="hljs-built_in">clone</span> https://github.com/OpenBMB/UltraRAG.git
<button class="copy-code-btn"></button></code></pre>
