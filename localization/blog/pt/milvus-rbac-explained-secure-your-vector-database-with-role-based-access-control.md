...
<h2 id="What-is-RBAC-in-Milvus" class="common-anchor-header">O que é RBAC em Milvus<button data-href="#What-is-RBAC-in-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Milvus RBAC é construído em torno dos seguintes componentes principais:</p>
<p>
...
<p>Actualize a palavra-passe predefinida <code translate="no">root</code> imediatamente após a inicialização e restrinja a sua utilização apenas a tarefas administrativas. Evite usar ou compartilhar a conta root para operações de rotina. Em vez disso, crie utilizadores e funções dedicados para acesso diário para reduzir o risco e melhorar a responsabilidade.</p>
...
<li><p><strong>Melhorar a segurança</strong> através da aplicação do acesso de menor privilégio aos dados do vetor</p></li>
