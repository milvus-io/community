...
<p>Ao dissociar as dependências e implementar a contentorização de testes, conseguimos diminuir o tempo médio de compilação em 60% enquanto trabalhávamos no projeto open-source de pesquisa por semelhança de embeddings <a href="https://milvus.io/">Milvus</a>.</p>
<p><br/></p>
...
<li>"<a href="https://dev.to/brpaz/factors-to-consider-when-adding-third-party-dependencies-to-a-project-46hf">Fatores a considerar ao adicionar dependências de terceiros a um projeto</a>"</li>
