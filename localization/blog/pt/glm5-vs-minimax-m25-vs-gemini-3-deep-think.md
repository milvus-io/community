...
<p>O pensamento mais assustador? Provavelmente, o seu chefe já viu os anúncios e está ansioso por que crie nove aplicações internas utilizando os três modelos antes mesmo de a semana terminar.</p>
...
<h3 id="Dependencies-and-environment-setup" class="common-anchor-header">Dependências e configuração do ambiente</h3><p>Instale ou actualize pymilvus, openai, requests e tqdm para as suas versões mais recentes:</p>
