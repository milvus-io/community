...
<p>Agora, ao encerrarmos nossa série Milvus Week, estou animado para dar uma espiada no que está por vir no Milvus 2.6 - um marco crucial em nosso roteiro de produtos para 2025 que está atualmente em desenvolvimento e como essas melhorias transformarão a pesquisa baseada em IA. Esta próxima versão reúne todas estas inovações e muito mais em três frentes críticas: <strong>otimização da relação custo-eficácia</strong>, <strong>capacidades de pesquisa avançadas</strong> e <strong>uma nova arquitetura</strong> que leva a pesquisa vetorial para além da escala de 10 mil milhões de vectores.</p>
...
<p>Os nossos benchmarks preliminares revelam resultados promissores:</p>
<table>
<thead>
...
<p>Figura: Milvus vs. Elasticsearch em taxa de transferência</p>
...
<p>O Milvus 2.6 adicionará a <strong>Correspondência de Frases</strong>, dando aos utilizadores mais controlo sobre a ordem das palavras e a proximidade do que a pesquisa de texto completo ou a correspondência exacta de palavras:</p>
...
<h3 id="Time-Aware-Decay-Functions-Automatically-Prioritize-Fresh-Content" class="common-anchor-header">Funções de declínio sensíveis ao tempo: Dar automaticamente prioridade a conteúdos recentes</h3><p>O valor da informação diminui frequentemente com o tempo. Os artigos de notícias, os lançamentos de produtos e as publicações nas redes sociais tornam-se menos relevantes à medida que envelhecem, mas os algoritmos de pesquisa tradicionais tratam todos os conteúdos da mesma forma, independentemente da data de registo.</p>
