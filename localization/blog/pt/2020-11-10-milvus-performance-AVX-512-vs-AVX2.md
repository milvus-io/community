...
<li>cahce.cahe_size: 25, O tamanho da memória da CPU usada para armazenar dados em cache para uma consulta mais rápida.</li>
<li>nlist: 4096</li>
<li>nprobe: 128</li>
</ul>
<p>Nota: <code translate="no">nlist</code> é o parâmetro de indexação a criar a partir do cliente; <code translate="no">nprobe</code> o parâmetro de pesquisa. Tanto o IVF_FLAT como o IVF_SQ8 utilizam um algoritmo de agrupamento para particionar um grande número de vectores em intervalos, sendo <code translate="no">nlist</code> o número total de intervalos a particionar durante o agrupamento. O primeiro passo de uma consulta consiste em encontrar o número de intervalos que estão mais próximos do vetor alvo e o segundo passo consiste em encontrar os vectores top-k nesses intervalos comparando a distância dos vectores. <code translate="no">nprobe</code> refere-se ao número de intervalos no primeiro passo.</p>
