...
<p>Com os vectores gerados, precisamos de poderosas bases de dados vectoriais e motores de pesquisa para os processar.</p>
<p>
...
<li>Reconhecer etiquetas de caraterísticas dos guarda-roupas e codificar as caraterísticas em dados do Elasticsearch no ficheiro <code translate="no">.json</code>.</li>
<li>Preparar dados de recuperação codificando dados não estruturados em vectores.</li>
<li>Utilizar a base de dados vetorial Milvus para classificar os resultados recuperados obtidos na etapa anterior.</li>
</ol>
<p>
