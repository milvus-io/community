...
<li><strong>Conteúdo sensível:</strong> reduzir o peso do conteúdo sinalizado em vez de o remover completamente. Limita a exposição sem censura rígida.</li>
...
<p>O multiplicador aplicado às pontuações dos registos correspondentes. A forma como o define depende do critério de avaliação:</p>
<table>
<thead>
...
<p>Várias<strong>regras</strong> - quando você precisar de várias restrições (priorizar itens em estoque + rebaixar produtos com classificação baixa + adicionar aleatoriedade), crie vários objetos <code translate="no">Function</code> e combine-os com <code translate="no">FunctionScore</code>. Você configura:</p>
<ul>
...
<h2 id="Conclusion" class="common-anchor-header">Conclusão<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://milvus.io/docs/reranking.md">O Boost Ranker</a> oferece uma maneira de injetar lógica de negócios nos resultados da pesquisa vetorial sem tocar nas suas incorporações ou reconstruir índices. Impulsione o conteúdo oficial, rebaixe resultados obsoletos, adicione diversidade controlada - tudo através de uma configuração simples de filtro + peso na <a href="https://milvus.io/docs/manage-functions.md">API de função Milvus</a>.</p>
