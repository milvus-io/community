...
<p>Seguem-se alguns pormenores de baixo nível sobre os botões de configuração do IVF, do RaBitQ e do processo de refinamento:</p>
<ul>
...
<li><p><code translate="no">refine_k</code> é um valor fp não negativo. O processo de refinamento utiliza um método de quantização de qualidade superior para selecionar o número necessário de vizinhos mais próximos a partir de um conjunto <code translate="no">refine_k</code> vezes maior de candidatos, escolhidos utilizando <code translate="no">IVFRaBitQ</code>. Trata-se de um parâmetro relacionado com a pesquisa.</p></li>
