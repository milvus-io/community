...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Velocidade de saída - DeepSeek R1</span> </span></p>
<h2 id="DeepSearcher-Architecture" class="common-anchor-header">Arquitetura do DeepSearcher<button data-href="#DeepSearcher-Architecture" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A arquitetura do <a href="https://github.com/zilliztech/deep-searcher">DeepSearcher</a> segue nosso post anterior, dividindo o problema em quatro etapas - <em>definir/refinar a pergunta</em>, <em>pesquisar</em>, <em>analisar</em>, <em>sintetizar</em> - embora desta vez com alguma sobreposição. Passamos por cada etapa, destacando as melhorias do <a href="https://github.com/zilliztech/deep-searcher">DeepSearcher</a>.</p>
<p>
   ...
   </span> <span class="img-wrapper"> <span>Arquitetura do DeepSearcher</span> </span></p>
