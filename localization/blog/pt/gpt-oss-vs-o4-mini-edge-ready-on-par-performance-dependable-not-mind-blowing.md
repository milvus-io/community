...
<ul>
<li><p><strong>gpt-oss-120b</strong> tem um desempenho quase igual ao do o4-mini em raciocínio, uso de ferramentas e codificação de competição (Codeforces, MMLU, TauBench)</p></li>
...
<h2 id="Hands-on-Building-with-GPT-oss-+-Milvus" class="common-anchor-header">Hands-on: Construindo com GPT-oss + Milvus<button data-href="#Hands-on-Building-with-GPT-oss-+-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
