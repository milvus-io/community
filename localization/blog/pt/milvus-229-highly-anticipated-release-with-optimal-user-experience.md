...
<p>A partir do Milvus 2.2.9, o Milvus SDK inclui uma API de alto nível que preenche automaticamente os campos dinâmicos no campo JSON oculto da coleção, permitindo que os utilizadores se concentrem apenas nos seus campos de negócio.</p>
