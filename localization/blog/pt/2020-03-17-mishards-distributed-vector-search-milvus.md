...
<p>Para mais informações sobre os metadados do Milvus, consulte Como visualizar os metadados. Num sistema distribuído, os nós graváveis Milvus são os únicos produtores de metadados. Os nós Mishards, os nós graváveis Milvus e os nós apenas de leitura Milvus são todos consumidores de metadados. Atualmente, o Milvus apenas suporta MySQL e SQLite como backend de armazenamento de metadados. Num sistema distribuído, o serviço só pode ser implementado como MySQL altamente disponível.</p>
