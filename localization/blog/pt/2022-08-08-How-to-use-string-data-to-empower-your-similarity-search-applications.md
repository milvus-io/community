...
<h2 id="Insert-data" class="common-anchor-header">Inserir dados<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Agora que a coleção foi criada, podemos inserir dados na mesma. No exemplo a seguir, inserimos 2.000 linhas de dados de cadeia de caracteres gerados aleatoriamente.</p>
...
<p>Lembre-se que o Milvus apenas suporta a eliminação de entidades com chaves primárias claramente especificadas, por isso, antes de executar o seguinte código, certifique-se de que definiu o campo <code translate="no">book_name</code> como o campo de chave primária.</p>
...
<p>Pode especificar o nome do índice quando o constrói. Se não for especificado, o valor predefinido de <code translate="no">index_name</code> é <code translate="no">&quot;_default_idx_&quot;</code>. No exemplo abaixo, chamámos ao índice <code translate="no">scalar_index</code>.</p>
