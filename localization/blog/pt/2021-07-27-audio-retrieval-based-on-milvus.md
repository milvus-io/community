...
<p>Este artigo centra-se na utilização de um sistema de recuperação de áudio para processar dados de áudio que não sejam de fala. O reconhecimento de voz não é abordado neste artigo</p>
