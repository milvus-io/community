...
<tr><td>Taxa de transferência da pesquisa (QPS)</td><td>236</td><td>648 (2,7× mais rápido)</td><td>946 (4× mais rápido)</td></tr>
</tbody>
</table>
...
<p>O resultado é uma redução de até 50% nos custos de armazenamento, mantendo o desempenho da consulta para dados activos.</p>
...
<p>Ao isolar o streaming do processamento em lote, o Streaming Node ajuda o Milvus a manter um desempenho estável e a atualização da pesquisa, mesmo durante a ingestão de grandes volumes de dados. Ele foi projetado com a escalabilidade horizontal em mente, dimensionando dinamicamente a capacidade do nó com base na taxa de transferência de dados.</p>
...
<p>Esta melhoria é possível graças a inúmeras optimizações de engenharia na gestão de metadados, atribuição de recursos e planeamento de consultas. Os utilizadores do Milvus podem agora desfrutar de um desempenho estável mesmo com dezenas de milhares de colecções.</p>
