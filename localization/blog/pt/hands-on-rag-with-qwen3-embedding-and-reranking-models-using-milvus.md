...
<button class="copy-code-btn"></button></code></pre>
<p>Carregar e dividir os ficheiros markdown. Estamos usando uma estratégia de divisão simples baseada em cabeçalho aqui - para sistemas de produção, considere abordagens de divisão mais sofisticadas:</p>
...
<p>A reclassificação mostra normalmente pontuações discriminativas muito mais elevadas (mais próximas de 1,0 para documentos relevantes) em comparação com as pontuações de semelhança de incorporação.</p>
