...
<h2 id="Conclusion" class="common-anchor-header">Conclusão<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Bases de dados vectoriais como o Milvus fornecem implementações altamente optimizadas e afinadas do HNSW, e é frequentemente o melhor índice de pesquisa por defeito para conjuntos de dados que cabem na memória.</p>
