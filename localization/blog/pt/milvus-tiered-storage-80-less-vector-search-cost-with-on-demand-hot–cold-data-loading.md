...
<li><p>Os segmentos frios vivem de forma barata no armazenamento remoto de objectos</p></li>
...
<h2 id="Why-Full-Loading-Breaks-Down-at-Scale" class="common-anchor-header">Por que o carregamento total falha em escala<button data-href="#Why-Full-Loading-Breaks-Down-at-Scale" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
