...
<h3 id="Change-Data-Capture-CDC" class="common-anchor-header">Captura de dados de alteração (CDC)</h3><p>O CDC é uma técnica que permite capturar e acompanhar as alterações efectuadas na sua instância Milvus em tempo real.</p>
