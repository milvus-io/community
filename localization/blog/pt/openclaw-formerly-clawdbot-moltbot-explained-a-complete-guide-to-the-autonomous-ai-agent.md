...
<button class="copy-code-btn"></button></code></pre>
<p>Isso o orienta através da autenticação, configuração do gateway e, opcionalmente, conectando um canal de mensagens (WhatsApp, Telegram, etc.). O sinalizador <code translate="no">--install-daemon</code> registra o gateway como um serviço em segundo plano para que ele seja iniciado automaticamente.</p>
...
<h2 id="Conclusion" class="common-anchor-header">Conclusão<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>OpenClaw cruzou <a href="https://github.com/openclaw/openclaw"> <span class="img-wrapper"> <img translate="no" src="https://img.shields.io/github/stars/openclaw/openclaw?label=⭐%20GitHub%20Stars" alt="GitHub Stars" class="doc-image" id="github-stars" /><span>GitHub Stars</span>GitHub </span></a> stars em menos de duas semanas, tornando-se um dos repositórios de código aberto de crescimento mais rápido na história do GitHub. A adoção é real e a arquitetura por trás dela merece atenção.</p>
