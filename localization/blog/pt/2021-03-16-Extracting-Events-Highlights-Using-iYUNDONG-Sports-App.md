...
<li><a href="#what-is-milvus">O que é o Milvus</a>- <a href="#an-overview-of-milvus"><em>Uma visão geral do Milvus.</em></a></li>
...
<p><br/></p>
<h3 id="Why-Milvus" class="common-anchor-header">Porquê Milvus</h3><p>Desde o final de 2019, a iYUNDONG realizou uma série de testes sobre a utilização do Milvus para alimentar o seu sistema de recuperação de imagens. Os resultados dos testes revelaram que o Milvus supera outros bancos de dados vetoriais convencionais, pois suporta vários índices e pode reduzir eficientemente o uso de RAM, comprimindo significativamente a linha do tempo para a pesquisa de similaridade vetorial.</p>
