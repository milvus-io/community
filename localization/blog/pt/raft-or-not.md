...
<p>Note que este artigo foca principalmente a sincronização de dados/logs incrementais. Por conseguinte, quando se fala de replicação de dados/log, refere-se apenas a replicação de dados incrementais e não de dados históricos.</p>
