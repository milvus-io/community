...
<ul>
<li><strong>Transformações vectoriais:</strong> Inclui a adição de transformações adicionais aos vectores, como a redução da dimensão (por exemplo, PCA \ t-SNE), rotação, etc.</li>
...
<li><strong>Gerenciamento simplificado de dados não estruturados:</strong> O Milvus possui APIs avançadas projetadas para fluxos de trabalho de ciência de dados.</li>
