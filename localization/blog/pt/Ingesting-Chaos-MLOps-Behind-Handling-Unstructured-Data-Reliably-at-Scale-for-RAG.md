...
<li>Crie um sistema de avaliação automatizado que classifique o desempenho da recuperação em cada pergunta. Uma forma de o fazer é pegar na resposta do sistema RAG e voltar a passá-la pelo LLM com uma pergunta que indique se este resultado do RAG responde à pergunta dada a resposta correta. A resposta deve ser "sim" ou "não". Por exemplo, se tiver 25 perguntas nos seus documentos e o sistema obtiver 20 corretas, pode utilizar este resultado para comparar com outras abordagens.</li>
