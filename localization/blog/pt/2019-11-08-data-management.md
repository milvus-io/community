...
<ul>
<li>Tabela: A tabela é um conjunto de dados de vectores, em que cada vetor tem um ID único. Cada vetor e o seu ID representam uma linha da tabela. Todos os vectores de uma tabela devem ter as mesmas dimensões. Abaixo está um exemplo de uma tabela com vectores de 10 dimensões:</li>
</ul>
<p>
