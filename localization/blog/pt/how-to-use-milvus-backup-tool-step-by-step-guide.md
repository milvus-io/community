...
<p><strong>3. Extraia o ficheiro tar</strong> para o seu diretório preferido e coloque o <code translate="no">backup.yaml</code> no diretório <code translate="no">configs/</code> dentro da mesma pasta extraída. Certifique-se de que a estrutura de diretórios seja exibida da seguinte forma:</p>
...
<h2 id="BackupRestore-Use-Cases" class="common-anchor-header">Casos de uso de backup/restauração<button data-href="#BackupRestore-Use-Cases" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Existem vários casos de utilização em que a ferramenta milvus-backup pode ser aplicada de forma eficaz, dependendo das suas necessidades e configurações específicas:</p>
<ol>
