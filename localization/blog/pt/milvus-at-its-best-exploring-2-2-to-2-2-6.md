...
<li><strong>Paginação de resultados de pesquisa</strong>: Para evitar o retorno massivo de resultados de pesquisas e consultas numa única chamada de procedimento remoto (RPC), o Milvus v2.2 permite-lhe configurar a paginação e filtrar resultados com palavras-chave em pesquisas e consultas.</li>
...
<li>Corrige o problema em que a informação carregada não é limpa para colecções/partições libertadas</li>
