...
<li>O Pushgateway garante que os dados de métrica efémeros e de curta duração sejam enviados com segurança para o Prometheus.</li>
...
<p><br/></p>
<h3 id="System-Performance" class="common-anchor-header">Desempenho do sistema</h3><p>Passaram alguns meses desde que o serviço ThashSearch construído sobre o Milvus foi lançado pela primeira vez. O gráfico abaixo mostra que a latência da consulta de ponta a ponta é inferior a 95 milissegundos.</p>
<p>
