...
<h3 id="Custom-Styling" class="common-anchor-header">Estilo personalizado</h3><p>O frontend usa o Gradio (main.py). Adicionámos CSS personalizado (modern_css) para tornar a interface mais limpa e fácil de utilizar.</p>
<ul>
