...
<p>Execute <code translate="no">query</code> e introduza <code translate="no">car</code> como o nome da coleção e <code translate="no">id&gt;0</code> como a expressão de consulta quando solicitado. Os IDs das entidades que atendem aos critérios são retornados como mostrado na figura a seguir.</p>
<p>
