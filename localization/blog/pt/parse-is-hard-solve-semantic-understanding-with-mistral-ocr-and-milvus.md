...
<h2 id="Meet-Your-Dream-Team" class="common-anchor-header">Conheça o seu time dos sonhos<button data-href="#Meet-Your-Dream-Team" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Mistral-OCR-More-than-just-text-extraction" class="common-anchor-header">Mistral OCR: Mais do que apenas extração de texto</h3><p>O Mistral OCR não é uma ferramenta comum de OCR. Foi projetado para lidar com uma ampla gama de documentos.</p>
<ul>
...
<p>E obtemos o seguinte resultado. Ele pode reconhecer bem o texto manuscrito. Podemos ver que até mantém o formato em maiúsculas das palavras &quot;FORCED AND UNNATURAL&quot;!</p>
