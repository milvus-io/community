...
<li><p>Extração do vetor de caraterísticas. É utilizado um modelo de aprendizagem profunda especialmente treinado para extrair os vectores de caraterísticas da imagem. A conversão de imagens em vectores para posterior pesquisa de semelhanças é uma operação de rotina.</p></li>
