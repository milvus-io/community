...
<button class="copy-code-btn"></button></code></pre>
<p>O parâmetro de pesquisa <code translate="no">drop_ratio_search</code> refere-se à proporção de documentos com menor pontuação a eliminar durante o algoritmo de pesquisa.</p>
