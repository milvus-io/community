...
<p>Em quase todos os pipelines RAG, o processo padrão é o mesmo: pegar nos documentos, dividi-los em partes e, em seguida, incorporar essas partes para recuperação por semelhança numa base de dados vetorial como o <a href="https://milvus.io/">Milvus</a>. Uma vez que <strong>a divisão em blocos</strong> é feita antecipadamente, a qualidade desses blocos afecta diretamente a eficácia do sistema na recuperação de informações e a precisão das respostas finais.</p>
...
<h3 id="2-Measure-how-consistent-the-current-chunk-is" class="common-anchor-header">2. Medir a consistência do pedaço atual</h3><p>Dentro do pedaço C, calcular a semelhança mínima de cosseno entre todos os encaixes de frases. Este valor reflecte a proximidade entre as frases do bloco. Uma semelhança mínima mais baixa indica que as frases estão menos relacionadas, sugerindo que o bloco pode precisar de ser dividido.</p>
...
<p>Isto garante que cada pedaço mantém a sua consistência semântica interna.</p>
