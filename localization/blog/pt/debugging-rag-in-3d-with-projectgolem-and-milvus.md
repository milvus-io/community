...
<p>Com esta configuração, é possível distinguir entre uma falha de recuperação causada por uma má incorporação, uma falha causada por uma má fragmentação e uma falha causada por um limiar ligeiramente demasiado apertado. Esse tipo de diagnóstico costumava exigir adivinhação e iteração. Agora é possível vê-lo.</p>
...
<p>Veja o <a href="https://github.com/CyberMagician/Project_Golem">Project_Golem</a> no GitHub, experimente-o com o seu próprio conjunto de dados e veja como é o seu espaço vetorial.</p>
