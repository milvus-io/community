...
<p>Depois de analisar o grande número de posts de 2024, fiquei a pensar: porque é que um humano deveria fazer isto? A IA generativa não prometeu resolver esta tarefa de analisar grandes quantidades de texto e extrair informações? Junte-se a mim na segunda parte desta publicação do blogue (em breve), onde investigarei a conceção e a implementação de <em>um sistema multiagente para extrair informações de fóruns de discussão.</em></p>
