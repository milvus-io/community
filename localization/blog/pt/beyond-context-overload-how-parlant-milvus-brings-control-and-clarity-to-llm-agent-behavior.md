...
<p>Quando emparelhado com o <a href="https://milvus.io/"><strong>Milvus</strong></a>, uma base de dados vetorial de código aberto, o Parlant torna-se ainda mais capaz. O Milvus adiciona inteligência semântica, permitindo que os agentes recuperem dinamicamente as regras e o contexto mais relevantes em tempo real - mantendo-os precisos, eficientes e prontos para a produção.</p>
...
<p><strong>2. Recuperação híbrida</strong> - Executar uma pesquisa de semelhança de vectores em Milvus com filtragem de metadados (por exemplo, <code translate="no">business_domain=&quot;transfer&quot;</code>).</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Quando o mesmo utilizador regressa, o agente pode recuperar as interações históricas mais relevantes do Milvus e utilizá-las para gerar uma experiência mais conectada e semelhante à humana. Por exemplo, se um utilizador fez uma pergunta sobre um fundo de investimento na semana passada, o agente pode recordar esse contexto e responder proactivamente: "Bem-vindo de volta! Ainda tem dúvidas sobre o fundo de que falámos da última vez?"</p>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Escrever o código completo</li>
</ul>
