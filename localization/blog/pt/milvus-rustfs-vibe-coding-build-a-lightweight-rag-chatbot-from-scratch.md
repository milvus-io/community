...
<li><strong>A interface de utilizador do chatbot.</strong> A FastAPI envolve o pipeline num único ponto de extremidade POST; o Next.js coloca uma janela de chat à sua frente. Não é mais necessário entrar num terminal para fazer uma pergunta.</li>
</ul>
