...
<li><strong>A interface de utilizador do chatbot.</strong> A FastAPI envolve o pipeline num único ponto final POST; o Next.js coloca uma janela de chat à frente. Chega de entrar num terminal para fazer uma pergunta.</li>
</ul>
