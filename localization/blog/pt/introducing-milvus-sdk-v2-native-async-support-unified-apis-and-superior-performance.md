...
<ul>
<li><p>Redução do tráfego de rede entre cliente e servidor</p></li>
...
<p>Agora, uma vez familiarizado com o Milvus numa língua, pode facilmente mudar para outra sem ter de reaprender como funciona o SDK. Este alinhamento não só simplifica a integração, mas também torna o desenvolvimento em várias línguas muito mais fácil e intuitivo.</p>
