...
title: >-
  Snapshots do Milvus: visualizações de coleções em um ponto no tempo sem copiar
  dados
author: Leo Liu
date: 2026-7-30
...
desc: >-
  Os snapshots do Milvus congelam uma coleção registrando referências de
  arquivos em vez de copiar dados — pontos de recuperação baratos, restauração
  sem reconstrução de índices e entradas estáveis para o Spark.
