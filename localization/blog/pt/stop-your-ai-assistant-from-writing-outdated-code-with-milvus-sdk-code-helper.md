...
<p>Navegue para: Configurações → Configurações do Cursor → Ferramentas e integrações → Adicionar novo servidor MCP global</p>
<p>
  <span class="img-wrapper">
...
<p>Após salvar a configuração, reinicie o Claude Desktop para ativar o novo servidor MCP.</p>
