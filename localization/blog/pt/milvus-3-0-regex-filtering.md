...
title: >-
  Além do =~: Como o Milvus 3.0 transforma regex em um filtro nativo de banco de
  dados
author: Buqian Zheng
date: 2026-8-5
...
desc: >-
  O Milvus 3.0 transfere regex do pós-processamento no lado da aplicação para o
  caminho de consulta do banco de dados, onde pode ser combinado com busca
  vetorial, busca de texto completo, filtros escalares e execução indexada.
