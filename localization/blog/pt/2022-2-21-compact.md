...
<p>A compactação refere-se ao processo de juntar pequenos segmentos em grandes segmentos e limpar dados logicamente eliminados. Por outras palavras, a compactação reduz a utilização de espaço em disco, eliminando as entidades eliminadas ou expiradas nos registos. Trata-se de uma tarefa em segundo plano que é acionada pela <a href="https://milvus.io/docs/v2.0.x/four_layers.md#Data-coordinator-data-coord">coordenação de dados</a> e executada pelo <a href="https://milvus.io/docs/v2.0.x/four_layers.md#Data-node">nó de dados</a> no Milvus.</p>
...
<ul>
<li>Quando os dados inseridos estão a ser anexados, o segmento atinge o limite superior de tamanho e é automaticamente descarregado para o disco.</li>
