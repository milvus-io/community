...
<p>Com esta gama, pode personalizar a sua implementação - desde configurações leves e preparadas para o edge até implementações poderosas à escala da nuvem - sem ficar preso a um único tipo de modelo.</p>
...
<ul>
<li><p>Definir o URI para um arquivo local (por exemplo, <code translate="no">./milvus.db</code>) é o método mais conveniente, pois usa automaticamente o Milvus Lite para armazenar todos os dados nesse arquivo.</p></li>
