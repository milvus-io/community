...
<p>É aqui que entra a <strong>engenharia de contexto</strong>. Em vez de dar ao modelo tudo de uma vez, moldamos o que ele vê: recuperando apenas as partes que interessam, comprimindo o que já não precisa de ser detalhado e mantendo os avisos e as ferramentas suficientemente limpos para que o modelo possa raciocinar. O objetivo é simples: disponibilizar a informação importante no momento certo e ignorar o resto.</p>
...
<li><p>Armazene-os na base de dados Milvus Vetor com metadados como a área do produto, a versão e o tempo de atualização.</p></li>
<li><p>Quando um utilizador fizer uma pergunta, execute uma pesquisa semântica para obter os K segmentos mais relevantes.</p></li>
</ul>
...
<p>Estas chamadas demoram normalmente <strong>3-5 segundos</strong>, mas asseguram que o modelo funciona sempre com dados actualizados, precisos e relevantes - mesmo para questões que o sistema não conseguiu antecipar.</p>
