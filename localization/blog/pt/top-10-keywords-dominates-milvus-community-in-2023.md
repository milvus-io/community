...
<h2 id="2-Search--beyond-Vector-Search" class="common-anchor-header">#2 Pesquisa - para além da Pesquisa Vetorial<button data-href="#2-Search--beyond-Vector-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
