...
<p>A<a href="https://zilliz.com/customers/read-ai"><strong>Read AI</strong></a>, uma das empresas de IA de produtividade de crescimento mais rápido que serve milhões de utilizadores activos mensais, utiliza a Milvus para obter uma latência de recuperação inferior a 20-50 ms em milhares de milhões de registos e uma aceleração de 5 vezes na pesquisa agêntica. O seu CTO afirma: "A Milvus serve como repositório central e potencia a nossa recuperação de informações entre milhares de milhões de registos."</p>
