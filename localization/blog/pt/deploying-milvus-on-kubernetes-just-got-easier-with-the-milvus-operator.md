...
<li><p><strong>Lógica do Controlador:</strong> O controlador do Operador procura por CRs novos ou atualizados. Assim que detecta uma mudança, ele orquestra a criação dos componentes necessários - serviços Milvus e dependências como etcd, Pulsar e MinIO.</p></li>
