...
<button class="copy-code-btn"></button></code></pre>
<ol start="5">
<li>Pesquise com a escala de dados e os parâmetros idênticos, exceto que <code translate="no">consistency_level</code> está definido como <code translate="no">CONSISTENCY_STRONG</code>.</li>
</ol>
...
<button class="copy-code-btn"></button></code></pre>
<ol start="11">
<li>Verificará que todos os segmentos selados carregados para o nó de consulta são indexados.</li>
</ol>
...
<h2 id="Whats-more" class="common-anchor-header">E mais<button data-href="#Whats-more" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para além das funcionalidades acima referidas, foram introduzidas no Milvus 2.0 novas caraterísticas como a Compactação de Dados, o Balanceamento Dinâmico de Carga, entre outras. Por favor, aproveite a sua viagem exploratória com Milvus!</p>
