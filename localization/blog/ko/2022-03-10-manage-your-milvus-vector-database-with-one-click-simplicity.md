...
<p>비정형 데이터 처리에 대한 수요가 급증하는 가운데 Milvus 2.0이 눈에 띕니다. 대규모 생산 시나리오를 위해 설계된 AI 지향 벡터 데이터베이스 시스템입니다. 이 모든 Milvus SDK와 Milvus의 명령줄 인터페이스인 Milvus CLI 외에도 사용자가 Milvus를 보다 직관적으로 조작할 수 있는 도구가 있나요? 정답은 '예'입니다. 질리즈는 Milvus 전용 그래픽 사용자 인터페이스인 Attu를 발표했습니다. 이 글에서는 Attu로 벡터 유사도 검색을 수행하는 방법을 단계별로 보여드리고자 합니다.</p>
<p>
...
<p>노드를 클릭하면 각 노드의 상세 정보도 확인할 수 있습니다.</p>
<p>
...
<p>각 노드를 클릭하면 <strong>노드 목록 보기로</strong> 들어갑니다. 좌표 노드의 모든 하위 노드를 확인할 수 있습니다. 정렬을 통해 CPU 또는 메모리 사용량이 많은 노드를 빠르게 식별하고 시스템의 문제점을 찾을 수 있습니다.</p>
<p>
