...
<h4 id="How-it-works" class="common-anchor-header">작동 방식</h4><p>Google의 BERT 모델을 사용하여 질문을 특징 벡터로 변환한 다음 Milvus를 사용하여 데이터셋을 관리하고 쿼리합니다.</p>
