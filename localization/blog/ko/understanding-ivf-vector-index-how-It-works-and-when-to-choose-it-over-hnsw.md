...
<p>애플리케이션이 지연 시간에 매우 민감하지 않은 경우, 예를 들어 1에서 16 사이의 값을 테스트하여 리콜과 지연 시간이 어떻게 변하는지 관찰하는 등 동적으로 nprobe를 실험해 보는 것이 좋습니다. 목표는 리콜이 허용 가능한 수준이고 지연 시간이 목표 범위 내에서 유지되는 최적의 지점을 찾는 것입니다.</p>
