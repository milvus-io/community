...
<p>수십억 개의 임베딩을 색인 및 서비스하고, 대규모 멀티테넌시를 지원하며, 분산 클라우드 환경에서 성능 및 가용성 목표를 유지할 수 있는 스토리지 엔진이 필요했습니다. 이 글에서는 벡터 검색 플랫폼을 어떻게 설계하고, 강화하고, 발전시켜 Airtable 인프라 스택의 핵심 기둥이 되게 했는지에 대한 이야기를 들려드립니다.</p>
