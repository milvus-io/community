...
<li><p><a href="https://milvus.io/blog/we-replaced-kafka-pulsar-with-a-woodpecker-for-milvus.md">Milvus를 위해 Kafka/Pulsar를 딱따구리로 대체한 우드펙커 </a></p></li>
...
<p><a href="https://zilliz.com/cloud"> Zilliz Cloud에서</a> 완전 관리형 Milvus를 사용하는 기업 사용자를 위해 특정 워크로드 특성과 정밀도 요구 사항에 따라 RaBitQ 매개변수를 동적으로 조정하는 자동화된 구성 프로필을 개발 중입니다.</p>
