...
<h2 id="Next-Generation-Search-From-Basic-Vector-Similarity-to-Production-Grade-Retrieval" class="common-anchor-header">차세대 검색: 기본 벡터 유사성에서 프로덕션급 검색까지<button data-href="#Next-Generation-Search-From-Basic-Vector-Similarity-to-Production-Grade-Retrieval" class="anchor-icon" translate="no">
    ...
    </button></h2><p>최신 AI 애플리케이션에는 벡터 검색만으로는 충분하지 않습니다. 사용자들은 벡터 임베딩의 의미론적 이해와 함께 전통적인 정보 검색의 정밀성을 요구합니다. Milvus 2.6은 이러한 격차를 해소하는 몇 가지 고급 검색 기능을 도입할 예정입니다.</p>
<h3 id="Better-Full-text-Search-with-Multi-language-Analyzer" class="common-anchor-header">다국어 분석기를 통한 더 나은 전체 텍스트 검색</h3><p>전체 텍스트 검색은 언어에 따라 크게 달라집니다... Milvus 2.6에서는 다국어 지원을 통해 완전히 개선된 텍스트 분석 파이프라인이 도입될 예정입니다:</p>
<ul>
...
<h3 id="Phrase-Match-Capturing-Semantic-Nuance-in-Word-Order" class="common-anchor-header">구문 일치: 어순에서 의미적 뉘앙스 포착하기</h3><p>어순은 키워드 검색이 종종 놓치는 중요한 의미 구분을 전달합니다. &quot;기계 학습 기술&quot;과 &quot;학습 기계 기술&quot;을 같은 단어지만 완전히 다른 의미로 비교해 보세요.</p>
