...
<h2 id="Context-Retrieval-Approaches-to-Solving-Context-Rot" class="common-anchor-header">컨텍스트 로트 해결을 위한 컨텍스트 검색 접근 방식<button data-href="#Context-Retrieval-Approaches-to-Solving-Context-Rot" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Conclusion" class="common-anchor-header">결론<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>AI 에이전트가 다양한 산업 분야의 프로덕션 환경으로 이동함에 따라 이전보다 더 긴 워크플로우와 더 복잡한 작업을 수행하게 되었습니다. 이러한 환경에서는 컨텍스트 관리가 현실적으로 필수적입니다.</p>
