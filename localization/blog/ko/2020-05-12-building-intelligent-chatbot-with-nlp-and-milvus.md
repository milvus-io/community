...
<h3 id="3-Import-to-Milvus-and-PostgreSQL" class="common-anchor-header">3. Milvus 및 PostgreSQL로 가져오기</h3><p>생성된 특징 벡터를 정규화하여 Milvus로 가져온 다음, Milvus에서 반환한 ID와 해당 답변을 PostgreSQL로 가져옵니다. 다음은 PostgreSQL의 테이블 구조를 보여줍니다:</p>
<p>
