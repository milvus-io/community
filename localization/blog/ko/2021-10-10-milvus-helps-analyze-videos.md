...
<p>지난 주말에 영화 ' <em>프리 가이</em> '를 보다가 경비원 버디 역을 맡은 배우를 어디선가 본 것 같았지만 그의 작품이 생각나지 않았습니다. "이 사람이 누구지?"라는 생각이 머릿속을 가득 채웠습니다. 그 얼굴을 본 적이 있다는 확신이 들었고 이름을 기억하려고 애를 썼습니다. 비슷한 경우로 평소 좋아하던 음료수를 마시는 영상 속 주연 배우를 본 적이 있는데 결국 브랜드 이름을 기억하지 못한 적도 있습니다.</p>
...
<p>이 주제에서 설명하는 동영상 분석 시스템은 동영상 콘텐츠를 빠르게 분석할 수 있는 Milvus로 구축되었습니다.</p>
