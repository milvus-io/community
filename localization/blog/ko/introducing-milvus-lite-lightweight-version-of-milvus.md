...
<li><p><em>Milvus Lite 문서: <a href="https://milvus.io/docs/quickstart.md">https://milvus.io/docs/quickstart.md</a></em></p></li>
...
<p>그러나 일부 사용자들은 Milvus 정식 버전이 너무 무겁거나 복잡하다고 느낄 수 있습니다. 이 문제를 해결하기 위해 Milvus 커뮤니티에서 가장 활발하게 활동하는 기여자 중 한 명인 <a href="https://github.com/matrixji">Bin Ji가</a> Milvus의 경량 버전인 Milvus <a href="https://github.com/milvus-io/milvus-lite">Lite를</a> 만들었습니다.</p>
