...
origin: null
---
<custom-h1>Milvus V1.0 출시</custom-h1><p>오늘 저희는 Milvus v1.0의 출시를 자랑스럽게 발표합니다. 8개월 동안 수백 명의 Milvus 커뮤니티 사용자들의 고된 테스트와 시험 끝에 Milvus v0.10.x가 마침내 안정화되었고, 이제 Milvus v0.10.6을 기반으로 하는 Milvus v1.0을 출시하게 되었습니다.</p>
