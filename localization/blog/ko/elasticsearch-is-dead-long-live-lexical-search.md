...
<p>특히 긴 쿼리 최적화가 두드러집니다. 기존의 WAND 알고리즘이 긴 쿼리에서 어려움을 겪었던 반면, Milvus는 스파스 임베딩과 그래프 인덱스를 결합하여 고차원 스파스 벡터 검색 시나리오에서 10배의 성능 향상을 제공함으로써 탁월한 성능을 발휘합니다.</p>
<p>
  <span class="img-wrapper">
...
<p>시스템의 다양한 검색 기능은 그룹화, 범위, 하이브리드 검색 방법론을 포함합니다. LangChain, LlamaIndex, Dify와 같은 도구와의 긴밀한 통합은 물론 수많은 AI 제품을 지원함으로써 Milvus는 최신 AI 인프라 생태계의 중심에 서게 되었습니다.</p>
...
<h2 id="Zilliz-Cloud-The-Managed-Solution" class="common-anchor-header">바로 질리즈 클라우드입니다: 관리형 솔루션<button data-href="#Zilliz-Cloud-The-Managed-Solution" class="anchor-icon" translate="no">
    ...
    </button></h2><p>저희는 지난 3년 동안 Milvus를 기반으로 하는 완전 관리형 벡터 데이터베이스 서비스인 <a href="https://zilliz.com/cloud">Zilliz Cloud를</a> 구축했습니다. Milvus 프로토콜을 클라우드 네이티브로 재구현하여 사용성, 비용 효율성 및 보안을 강화했습니다.</p>
