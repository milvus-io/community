...
<ul>
<li><p>진정한 이웃의 상대적 순서를 더 잘 보존하는<strong>점수 인식 정량화 목표를</strong> 통해 압축이 심한 상황에서도 순위 품질을 개선합니다.</p></li>
...
<p>이 포스팅에서는 IVFPQ를 기준선으로 다시 살펴보고, 이를 기반으로 ScaNN이 도입한 주요 최적화를 살펴본 후, 측정된 성능에 대한 논의의 근거가 되는 실험 결과로 마무리하겠습니다.</p>
...
<p>여기서 흥미로운 점은 ScaNN 논문이 전적으로 첫 번째 최적화에 초점을 맞추고 있다는 점인데, 이는 수학적 추론을 강조하는 알고리즘 논문으로 볼 수 있기 때문에 당연한 결과입니다. 그러나 이 논문에서 제시된 실험 결과는 놀랍도록 인상적입니다.</p>
<p>
