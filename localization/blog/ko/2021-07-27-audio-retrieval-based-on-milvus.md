...
<h2 id="Conclusion" class="common-anchor-header">결론<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>빅데이터 시대에 살고 있는 사람들은 온갖 종류의 정보로 가득한 삶을 살고 있습니다. 이를 더 잘 이해하기 위해서는 기존의 텍스트 검색으로는 더 이상 충분하지 않습니다. 오늘날의 정보 검색 기술은 동영상, 이미지, 오디오 등 다양한 비정형 데이터 유형의 검색이 절실히 요구되고 있습니다.</p>
