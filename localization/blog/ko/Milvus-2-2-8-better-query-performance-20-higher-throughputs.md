...
<p>Milvus 2.2.8의 최신 릴리스를 발표하게 되어 기쁘게 생각합니다. 이번 릴리스에는 이전 버전의 수많은 개선 사항과 버그 수정이 포함되어 있어 쿼리 성능이 향상되고 리소스가 절약되며 처리량이 증가합니다. 이번 릴리스의 새로운 기능을 함께 살펴보겠습니다.</p>
...
<p><strong>참고</strong>: 이 업그레이드는 이 릴리스 이전에 생성된 컬렉션에는 영향을 미치지 않습니다.</p>
