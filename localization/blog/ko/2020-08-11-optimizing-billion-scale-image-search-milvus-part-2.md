...
<p>CNN은 무엇을 할 수 있나요? 특징을 추출하고 물체를 인식할 수 있습니다. 여러 차원에서 특징을 추출하고 이미지의 특징이 고양이 또는 강아지의 특징에 얼마나 가까운지 측정합니다. 가장 가까운 것을 식별 결과로 선택하여 특정 이미지의 콘텐츠가 고양이에 관한 것인지, 개에 관한 것인지, 아니면 다른 것인지를 나타낼 수 있습니다.</p>
