...
<button class="copy-code-btn"></button></code></pre>
<p>성공하면 <code translate="no">windows_package</code> 의 하위 디렉토리에 zip 파일이 생성됩니다. zip 파일에는 <code translate="no">minio.exe</code> 과 <code translate="no">etcd.exe</code> 을 포함하여 <code translate="no">milvus.exe</code> 을 실행하기 위한 모든 파일이 포함되어 있습니다.</p>
