...
---
<p>현실을 직시하세요: 문서 구문 분석은 정말 어렵습니다. PDF, 이미지, 보고서, 표, 지저분한 손글씨 등 사용자가 검색하고자 하는 중요한 정보가 가득하지만, 그 정보를 추출하여 검색 색인에 정확하게 표현하는 것은 마치 퍼즐 조각이 계속 바뀌는 퍼즐을 푸는 것과 같습니다. 코드 한 줄 더 넣어서 해결했다고 생각했는데 내일 새로운 문서가 들어와서 처리해야 할 다른 구석이 생기는 경우가 있습니다.</p>
