...
<p>2021년 3월, Milvus의 개발사인 Zilliz는 플랫폼의 첫 번째 장기 지원 버전인 Milvus v1.0을 출시했습니다. 수개월간의 광범위한 테스트 끝에 세계에서 가장 인기 있는 벡터 데이터베이스의 안정적이고 프로덕션에 사용할 수 있는 버전이 출시되었습니다. 이 블로그 글에서는 Milvus의 기본 사항과 v1.0의 주요 기능에 대해 설명합니다.</p>
<p><br/></p>
