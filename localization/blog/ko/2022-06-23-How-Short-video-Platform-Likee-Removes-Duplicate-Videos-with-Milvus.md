...
<p>비고<a href="https://www.bigo.sg/">테크놀로지</a> (BIGO)는 싱가포르에서 가장 빠르게 성장하는 기술 기업 중 하나입니다. 인공지능 기술을 기반으로 하는 BIGO의 동영상 기반 제품과 서비스는 150여 개국에서 4억 명 이상의 사용자를 확보하며 전 세계적으로 큰 인기를 얻고 있습니다. 여기에는 <a href="https://www.bigo.tv/bigo_intro/en.html?hk=true">Bigo Live</a> (라이브 스트리밍)와 <a href="https://likee.video/">Likee</a> (숏폼 동영상)가 포함됩니다.</p>
<p>Likee는 사용자가 자신의 순간을 공유하고, 자신을 표현하고, 전 세계와 소통할 수 있는 글로벌 쇼트 비디오 제작 플랫폼입니다. 사용자 경험을 향상시키고 사용자에게 더 높은 품질의 콘텐츠를 추천하기 위해 Likee는 매일 생성되는 엄청난 양의 동영상에서 중복 동영상을 걸러내야 하는데, 이는 결코 쉬운 일이 아닙니다.</p>
