...
<p>Milvus 2.2.12의 최신 버전을 발표하게 되어 기쁘게 생각합니다. 이번 업데이트에는 사용자 피드백을 반영하여 RESTful API 지원, <code translate="no">json_contains</code> 기능, ANN 검색 중 벡터 검색 등 여러 가지 새로운 기능이 포함되어 있습니다. 또한 사용자 환경을 간소화하고 벡터 검색 속도를 향상시켰으며 여러 문제를 해결했습니다. Milvus 2.2.12에서 기대할 수 있는 기능에 대해 자세히 알아보세요.</p>
