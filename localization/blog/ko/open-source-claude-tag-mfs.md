...
title: 'Open Tag: Claude Code와 Codex를 위한 오픈 소스 Claude Tag'
author: Cheney Zhang
...
desc: >-
  MFS를 기반으로 구축된 Claude Code 및 Codex용 오픈 소스 Slack 네이티브 Claude Tag: 코드, 문서, 티켓,
  데이터베이스를 아우르는 검색 및 탐색 가능한 단일 인터페이스.
